...
__name(isCallException, "isCallException");
...
__name(assertArgument, "assertArgument");
...
__name(assertArgumentCount, "assertArgumentCount");
...
__name(assertNormalize, "assertNormalize");
...
__name(getBytesCopy, "getBytesCopy");
...
__name(stripZerosLeft, "stripZerosLeft");
...
__name(zeroPadValue, "zeroPadValue");
...
var _listener;
var _EventPayload = class _EventPayload {
  /**
...
__name(_EventPayload, "EventPayload");
var EventPayload = _EventPayload;
...
__name(createGetUrl, "createGetUrl");
...
__name(dataGatewayFunc, "dataGatewayFunc");
function getIpfsGatewayFunc(baseUrl) {
  ...
  __name(gatewayIpfs, "gatewayIpfs");
  return gatewayIpfs;
}
__name(getIpfsGatewayFunc, "getIpfsGatewayFunc");
var Gateways = {
...
var _FetchCancelSignal = class _FetchCancelSignal {
  constructor(request) {
...
__name(_FetchCancelSignal, "FetchCancelSignal");
var FetchCancelSignal = _FetchCancelSignal;
...
__name(checkSignal, "checkSignal");
...
send_fn = /* @__PURE__ */ __name(function(attempt, expires, delay, _request3, _response) {
  return __async(this, null, function* () {
    var _a2, _b, _c;
...
__name(_FetchRequest, "FetchRequest");
...
_error = new WeakMap();
__name(_FetchResponse, "FetchResponse");
...
function getFormat(value) {
  ...
  if (typeof value === "string") {
    ...
    const v = value;
    const check = /* @__PURE__ */ __name((key, type, defaultValue) => {
      if (v[key] == null) {
        return defaultValue;
      }
...
checkFormat_fn = /* @__PURE__ */ __name(function(other) {
  assertArgument(this.format === other.format, "incompatible format; use fixedNumber.toFormat", "other", other);
}, "#checkFormat");
checkValue_fn = /* @__PURE__ */ __name(function(val, safeOp) {
  val = checkValue(val, __privateGet(this, _format), safeOp);
  return new _FixedNumber(_guard, val, __privateGet(this, _format));
}, "#checkValue");
add_fn = /* @__PURE__ */ __name(function(o, safeOp) {
...
sub_fn = /* @__PURE__ */ __name(function(o, safeOp) {
  __privateMethod(this, _FixedNumber_instances, checkFormat_fn).call(this, o);
  return __privateMethod(this, _FixedNumber_instances, checkValue_fn).call(this, __privateGet(this, _val) - __privateGet(o, _val), safeOp);
}, "#sub");
mul_fn = /* @__PURE__ */ __name(function(o, safeOp) {
  __privateMethod(this, _FixedNumber_instances, checkFormat_fn).call(this, o);
...
div_fn = /* @__PURE__ */ __name(function(o, safeOp) {
...
__name(_FixedNumber, "FixedNumber");
...
__name(hexlifyByte, "hexlifyByte");
...
function _decode(data, offset) {
  ...
  const checkOffset = /* @__PURE__ */ __name((offset2) => {
...
function checkResultErrors(result) {
  const errors = [];
  const checkErrors = /* @__PURE__ */ __name(function(path, object2) {
    if (!Array.isArray(object2)) {
      return;
    }
...
writeData_fn = /* @__PURE__ */ __name(function(data) {
...
incrementBytesRead_fn = /* @__PURE__ */ __name(function(count) {
  var _a2;
...
peekBytes_fn = /* @__PURE__ */ __name(function(offset, length, loose) {
...
var nextTick = /* @__PURE__ */ __name(() => __async(null, null, function* () {
}), "nextTick");
...
var _SHA2 = class _SHA2 extends Hash {
...
var Chi = /* @__PURE__ */ __name((a, b2, c) => a & b2 ^ ~a & c, "Chi");
var Maj = /* @__PURE__ */ __name((a, b2, c) => a & b2 ^ a & c ^ b2 & c, "Maj");
...
var _SHA256 = class _SHA256 extends SHA2 {
  constructor() {
    super(64, 32, 8, false);
    this.A = IV[0] | 0;
    this.B = IV[1] | 0;
...
var SHA256 = _SHA256;
var _SHA224 = class _SHA224 extends SHA256 {
  constructor() {
    super();
    this.A = 3238371032 | 0;
    this.B = 914150663 | 0;
...
var _SHA512 = class _SHA512 extends SHA2 {
  constructor() {
...
__name(_SHA512, "SHA512");
var SHA512 = _SHA512;
var _SHA512_224 = class _SHA512_224 extends SHA512 {
  constructor() {
    super();
...
__name(_SHA512_224, "SHA512_224");
var SHA512_224 = _SHA512_224;
var _SHA512_256 = class _SHA512_256 extends SHA512 {
  constructor() {
    super();
    this.Ah = 573645204 | 0;
...
__name(_SHA512_256, "SHA512_256");
var SHA512_256 = _SHA512_256;
var _SHA384 = class _SHA384 extends SHA512 {
  constructor() {
    super();
...
var locked2 = false;
var _computeHmac = /* @__PURE__ */ __name(function(algorithm, key, data) {
...
var rotl = /* @__PURE__ */ __name((word, shift) => word << shift | word >>> 32 - shift, "rotl");
...
var _RIPEMD160 = class _RIPEMD160 extends SHA2 {
  constructor() {
    super(64, 20, 8, true);
...
__name(_RIPEMD160, "RIPEMD160");
var RIPEMD160 = _RIPEMD160;
var ripemd160 = wrapConstructor(() => new RIPEMD160());

// node_modules/ethers/lib.esm/crypto/ripemd160.js
var locked4 = false;
var _ripemd160 = /* @__PURE__ */ __name(function(data) {
...
var locked5 = false;
var _pbkdf2 = /* @__PURE__ */ __name(function(password, salt, iterations, keylen, algo) {
...
var locked6 = false;
var _randomBytes = /* @__PURE__ */ __name(function(length) {
...
var rotl2 = /* @__PURE__ */ __name((a, b2) => a << b2 | a >>> 32 - b2, "rotl");
...
var _scryptAsync = /* @__PURE__ */ __name(function(passwd, salt, N3, r, p, dkLen, onProgress) {
  return __async(this, null, function* () {
    return yield scryptAsync(passwd, salt, { N: N3, r, p, dkLen, onProgress });
  });
}, "_scryptAsync");
var _scryptSync = /* @__PURE__ */ __name(function(passwd, salt, N3, r, p, dkLen) {
...
var _sha256 = /* @__PURE__ */ __name(function(data) {
  return createHash("sha256").update(data).digest();
}, "_sha256");
var _sha512 = /* @__PURE__ */ __name(function(data) {
...
var bitSet = /* @__PURE__ */ __name((n2, pos, value) => {
  return n2 | (value ? _1n2 : _0n2) << BigInt(pos);
}, "bitSet");
var bitMask = /* @__PURE__ */ __name((n2) => (_2n2 << BigInt(n2 - 1)) - _1n2, "bitMask");
...
function createHmacDrbg(hashLen, qByteLen, hmacFn) {
  ...
  const h = /* @__PURE__ */ __name((...b2) => hmacFn(k, v, ...b2), "h");
...
var validatorFns = {
  ...
  field: /* @__PURE__ */ __name((val, object2) => object2.Fp.isValid(val), "field"),
...
function tonelliShanks(P) {
  ...
  if (S2 === 1) {
    ...
    return /* @__PURE__ */ __name(function tonelliFast(Fp2, n2) {
  ...
  return /* @__PURE__ */ __name(function tonelliSlow(Fp2, n2) {
...
function FpSqrt(P) {
  if (P % _4n === _3n) {
    const p1div4 = (P + _1n3) / _4n;
    return /* @__PURE__ */ __name(function sqrt3mod4(Fp2, n2) {
      const root = Fp2.pow(n2, p1div4);
      if (!Fp2.eql(Fp2.sqr(root), n2))
        throw new Error("Cannot find square root");
      return root;
  ...
  if (P % _8n === _5n) {
    const c1 = (P - _5n) / _8n;
    return /* @__PURE__ */ __name(function sqrt5mod8(Fp2, n2) {
...
function Field(ORDER, bitLen2, isLE2 = false, redef = {}) {
  ...
  const f2 = Object.freeze({
    ...
    cmov: /* @__PURE__ */ __name((a, b2, c) => c ? b2 : a, "cmov"),
...
function weierstrass(curveDef) {
  ...
  const slcNum = /* @__PURE__ */ __name((b2, from, to) => bytesToNumberBE(b2.slice(from, to)), "slcNum");
  const _Signature2 = class _Signature2 {
    ...
    static fromCompact(hex) {
      ...
      return new _Signature2(slcNum(hex, 0, l), slcNum(hex, l, 2 * l));
    }
    ...
    normalizeS() {
      return this.hasHighS() ? new _Signature2(this.r, modN2(-this.s), this.recovery) : this;
    }
    // DER-encoded
    toDERRawBytes() {
  ...
  __name(_Signature2, "Signature");
  let Signature2 = _Signature2;
  const utils = {
...
__name(validateDST, "validateDST");
...
function createCurve(curveDef, defHash) {
  const create = /* @__PURE__ */ __name((hash2) => weierstrass(__spreadValues(__spreadValues({}, curveDef), getHash(hash2))), "create");
...
var _1n6 = BigInt(1);
var _2n5 = BigInt(2);
var divNearest = /* @__PURE__ */ __name((a, b2) => (a + b2 / _2n5) / b2, "divNearest");
function sqrtMod(y) {
  const P = secp256k1P;
...
var _0n6 = BigInt(0);
var fe = /* @__PURE__ */ __name((x) => typeof x === "bigint" && _0n6 < x && x < secp256k1P, "fe");
var ge = /* @__PURE__ */ __name((x) => typeof x === "bigint" && _0n6 < x && x < secp256k1N, "ge");
...
var numTo32b = /* @__PURE__ */ __name((n2) => numberToBytesBE(n2, 32), "numTo32b");
var modP = /* @__PURE__ */ __name((x) => mod(x, secp256k1P), "modP");
var modN = /* @__PURE__ */ __name((x) => mod(x, secp256k1N), "modN");
var Point = secp256k1.ProjectivePoint;
var GmulAdd = /* @__PURE__ */ __name((Q, a, b2) => Point.BASE.multiplyAndAddUnsafe(Q, a, b2), "GmulAdd");
...
__name(isAddressable, "isAddressable");
...
var _AddressCoder = class _AddressCoder extends Coder {
...
var AddressCoder = _AddressCoder;

// node_modules/ethers/lib.esm/abi/coders/anonymous.js
var _AnonymousCoder = class _AnonymousCoder extends Coder {
  coder;
  constructor(coder) {
...
var AnonymousCoder = _AnonymousCoder;
...
var _ArrayCoder = class _ArrayCoder extends Coder {
  coder;
  length;
...
var ArrayCoder = _ArrayCoder;

// node_modules/ethers/lib.esm/abi/coders/boolean.js
var _BooleanCoder = class _BooleanCoder extends Coder {
  constructor(localName) {
...
var BooleanCoder = _BooleanCoder;

// node_modules/ethers/lib.esm/abi/coders/bytes.js
var _DynamicBytesCoder = class _DynamicBytesCoder extends Coder {
...
var DynamicBytesCoder = _DynamicBytesCoder;
var _BytesCoder = class _BytesCoder extends DynamicBytesCoder {
  constructor(localName) {
...
var BytesCoder = _BytesCoder;

// node_modules/ethers/lib.esm/abi/coders/fixed-bytes.js
var _FixedBytesCoder = class _FixedBytesCoder extends Coder {
  size;
...
var FixedBytesCoder = _FixedBytesCoder;

// node_modules/ethers/lib.esm/abi/coders/null.js
var Empty = new Uint8Array([]);
var _NullCoder = class _NullCoder extends Coder {
  constructor(localName) {
...
var NullCoder = _NullCoder;

// node_modules/ethers/lib.esm/abi/coders/number.js
var BN_06 = BigInt(0);
var BN_14 = BigInt(1);
var BN_MAX_UINT256 = BigInt("0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
var _NumberCoder = class _NumberCoder extends Coder {
  size;
  signed;
...
var NumberCoder = _NumberCoder;

// node_modules/ethers/lib.esm/abi/coders/string.js
var _StringCoder = class _StringCoder extends DynamicBytesCoder {
  constructor(localName) {
...
var StringCoder = _StringCoder;

// node_modules/ethers/lib.esm/abi/coders/tuple.js
var _TupleCoder = class _TupleCoder extends Coder {
  coders;
...
__name(authorizationify, "authorizationify");
...
function getKzgLibrary(kzg) {
  const blobToKzgCommitment = /* @__PURE__ */ __name((blob) => {
  ...
  const computeBlobKzgProof = /* @__PURE__ */ __name((blob, commitment) => {
...
__name(getKzgLibrary, "getKzgLibrary");
...
__name(getVersionedHash, "getVersionedHash");
...
__name(handleAccessList, "handleAccessList");
...
__name(handleAuthorizationList, "handleAuthorizationList");
...
__name(formatHashes, "formatHashes");
...
__name(_parseLegacy, "_parseLegacy");
...
__name(_serializeLegacy, "_serializeLegacy");
...
__name(_parseEip4844, "_parseEip4844");
...
__name(_serializeEip4844, "_serializeEip4844");
...
__name(_parseEip7702, "_parseEip7702");
...
__name(_serializeEip7702, "_serializeEip7702");
...
getSerialized_fn = /* @__PURE__ */ __name(function(signed2, sidecar) {
...
var FE0F = 65039;
var UNIQUE_PH = 1;
var Array_from = /* @__PURE__ */ __name((x) => Array.from(x), "Array_from");
function group_has_cp(g, cp) {
  return g.P.has(cp) || g.Q.has(cp);
}
__name(group_has_cp, "group_has_cp");
var _Emoji = class _Emoji extends Array {
  get is_emoji() {
    return true;
  }
  // free tagging system
...
function init() {
  ...
  const read_sorted_array = /* @__PURE__ */ __name(() => read_sorted(r), "read_sorted_array");
  const read_sorted_set = /* @__PURE__ */ __name(() => new Set(read_sorted_array()), "read_sorted_set");
  const set_add_many = /* @__PURE__ */ __name((set, v) => v.forEach((x) => set.add(x)), "set_add_many");
  ...
  let unrestricted = r();
  const read_chunked = /* @__PURE__ */ __name(() => {
  ...
  const add_to_union = /* @__PURE__ */ __name((cp) => VALID.has(cp) ? multi.add(cp) : VALID.add(cp), "add_to_union");
  for (let g of GROUPS) {
...
__name(ensNormalize, "ensNormalize");
...
__name(solidityPacked, "solidityPacked");
function solidityPackedKeccak256(types, values) {
  return keccak256(solidityPacked(types, values));
}
__name(solidityPackedKeccak256, "solidityPackedKeccak256");
function solidityPackedSha256(types, values) {
  return sha2562(solidityPacked(types, values));
}
__name(solidityPackedSha256, "solidityPackedSha256");
...
var domainChecks = {
  ...
  chainId: /* @__PURE__ */ __name(function(_value2) {
  ...
  verifyingContract: /* @__PURE__ */ __name(function(value) {
    try {
  ...
  salt: /* @__PURE__ */ __name(function(value) {
...
getEncoder_fn = /* @__PURE__ */ __name(function(type) {
  {
    const encoder = getBaseEncoder(type);
    if (encoder) {
      return encoder;
...
__name(_TypedDataEncoder, "TypedDataEncoder");
...
subTokenString_fn = /* @__PURE__ */ __name(function(from = 0, to = 0) {
...
__name(_TokenString, "TokenString");
var TokenString = _TokenString;
function lex(text) {
  const tokens = [];
  const throwError2 = /* @__PURE__ */ __name((message) => {
...
__name(allowSingle, "allowSingle");
...
__name(consumeKeywords, "consumeKeywords");
...
__name(consumeMutability, "consumeMutability");
function consumeParams(tokens, allowIndexed) {
  return tokens.popParams().map((t) => ParamType.from(t, allowIndexed));
}
__name(consumeParams, "consumeParams");
...
__name(verifyBasicType, "verifyBasicType");
var _guard4 = {};
...
walkAsync_fn = /* @__PURE__ */ __name(function(promises, value, process, setValue) {
  if (this.isArray()) {
    if (!Array.isArray(value)) {
      throw new Error("invalid array value");
    }
...
var _NamedFragment = class _NamedFragment extends Fragment {
  /**
...
__name(_NamedFragment, "NamedFragment");
var NamedFragment = _NamedFragment;
function joinParams(format, params) {
  return "(" + params.map((p) => p.format(format)).join(format === "full" ? ", " : ",") + ")";
}
__name(joinParams, "joinParams");
var _ErrorFragment = class _ErrorFragment extends NamedFragment {
  /**
   *  @private
   */
...
var ErrorFragment = _ErrorFragment;
var _EventFragment = class _EventFragment extends NamedFragment {
  /**
...
var EventFragment = _EventFragment;
var _ConstructorFragment = class _ConstructorFragment extends Fragment {
  /**
...
var ConstructorFragment = _ConstructorFragment;
var _FallbackFragment = class _FallbackFragment extends Fragment {
  /**
...
__name(_FallbackFragment, "FallbackFragment");
var FallbackFragment = _FallbackFragment;
var _FunctionFragment = class _FunctionFragment extends NamedFragment {
  /**
...
var FunctionFragment = _FunctionFragment;
var _StructFragment = class _StructFragment extends NamedFragment {
  /**
   *  @private
   */
  constructor(guard, name, inputs) {
...
__name(_StructFragment, "StructFragment");
var StructFragment = _StructFragment;
...
__name(getBuiltinCallException, "getBuiltinCallException");
...
getCoder_fn = /* @__PURE__ */ __name(function(param) {
  if (param.isArray()) {
...
__name(encodeBytes32String, "encodeBytes32String");
...
var _LogDescription = class _LogDescription {
  /**
...
var LogDescription = _LogDescription;
var _TransactionDescription = class _TransactionDescription {
  /**
...
var TransactionDescription = _TransactionDescription;
var _ErrorDescription = class _ErrorDescription {
  /**
...
var ErrorDescription = _ErrorDescription;
var _Indexed = class _Indexed {
  /**
...
var BuiltinErrors = {
  "0x08c379a0": {
    ...
    name: "Error",
    inputs: ["string"],
    reason: /* @__PURE__ */ __name((message) => {
...
getFunction_fn = /* @__PURE__ */ __name(function(key, values, forceUnique) {
  if (isHexString(key)) {
    const selector = key.toLowerCase();
...
getEvent_fn = /* @__PURE__ */ __name(function(key, values, forceUnique) {
  if (isHexString(key)) {
...
__name(_FeeData, "FeeData");
var FeeData = _FeeData;
...
var Log = _Log;
var _logs;
var _TransactionReceipt = class _TransactionReceipt {
  /**
   *  @_ignore:
   */
...
_logs = new WeakMap();
__name(_TransactionReceipt, "TransactionReceipt");
...
var _TransactionResponse = class _TransactionResponse {
  ...
  wait(_confirms, _timeout2) {
    return __async(this, null, function* () {
      ...
      const checkReplacement = /* @__PURE__ */ __name(() => __async(this, null, function* () {
        if (stopScanning) {
          return null;
        }
      ...
      const checkReceipt = /* @__PURE__ */ __name((receipt2) => {
      ...
      if (receipt) {
        if (confirms === 1 || (yield receipt.confirmations()) >= confirms) {
          return checkReceipt(receipt);
        }
      } else {
      ...
      const waiter = new Promise((resolve, reject) => {
        ...
        const txListener = /* @__PURE__ */ __name((receipt2) => __async(this, null, function* () {
        ...
        if (startBlock >= 0) {
          const replaceListener = /* @__PURE__ */ __name(() => __async(this, null, function* () {
            try {
              yield checkReplacement();
            } catch (error) {
...
__name(_TransactionResponse, "TransactionResponse");
var TransactionResponse = _TransactionResponse;
function createOrphanedBlockFilter(block) {
  return { orphan: "drop-block", hash: block.hash, number: block.number };
}
__name(createOrphanedBlockFilter, "createOrphanedBlockFilter");
function createReorderedTransactionFilter(tx, other) {
  return { orphan: "reorder-transaction", tx, other };
}
__name(createReorderedTransactionFilter, "createReorderedTransactionFilter");
function createRemovedTransactionFilter(tx) {
  return { orphan: "drop-transaction", tx };
}
__name(createRemovedTransactionFilter, "createRemovedTransactionFilter");
...
var _EventLog = class _EventLog extends Log {
  /**
...
var _UndecodedEventLog = class _UndecodedEventLog extends Log {
  /**
...
__name(_UndecodedEventLog, "UndecodedEventLog");
var UndecodedEventLog = _UndecodedEventLog;
var _iface;
var _ContractTransactionReceipt = class _ContractTransactionReceipt extends TransactionReceipt {
  /**
   *  @_ignore:
   */
...
_iface = new WeakMap();
__name(_ContractTransactionReceipt, "ContractTransactionReceipt");
var ContractTransactionReceipt = _ContractTransactionReceipt;
var _iface2;
...
_iface2 = new WeakMap();
__name(_ContractTransactionResponse, "ContractTransactionResponse");
var ContractTransactionResponse = _ContractTransactionResponse;
var _ContractUnknownEventPayload = class _ContractUnknownEventPayload extends EventPayload {
  /**
...
__name(_ContractUnknownEventPayload, "ContractUnknownEventPayload");
var ContractUnknownEventPayload = _ContractUnknownEventPayload;
var _ContractEventPayload = class _ContractEventPayload extends ContractUnknownEventPayload {
  /**
   *  @_ignore:
   */
...
__name(_ContractEventPayload, "ContractEventPayload");
var ContractEventPayload = _ContractEventPayload;
...
__name(canCall, "canCall");
function canEstimate(value) {
  return value && typeof value.estimateGas === "function";
}
__name(canEstimate, "canEstimate");
function canResolve(value) {
  return value && typeof value.resolveName === "function";
}
__name(canResolve, "canResolve");
...
var _filter;
var _PreparedTopicFilter = class _PreparedTopicFilter {
...
_filter = new WeakMap();
__name(_PreparedTopicFilter, "PreparedTopicFilter");
var PreparedTopicFilter = _PreparedTopicFilter;
...
__name(copyOverrides, "copyOverrides");
...
function buildWrappedFallback(contract) {
  const populateTransaction = /* @__PURE__ */ __name(function(overrides) {
    return __async(this, null, function* () {
  ...
  const staticCall = /* @__PURE__ */ __name(function(overrides) {
    return __async(this, null, function* () {
  ...
  const send = /* @__PURE__ */ __name(function(overrides) {
    return __async(this, null, function* () {
  ...
  const estimateGas = /* @__PURE__ */ __name(function(overrides) {
    return __async(this, null, function* () {
  ...
  const method = /* @__PURE__ */ __name((overrides) => __async(null, null, function* () {
...
__name(buildWrappedFallback, "buildWrappedFallback");
function buildWrappedMethod(contract, key) {
  const getFragment = /* @__PURE__ */ __name(function(...args) {
  ...
  const populateTransaction = /* @__PURE__ */ __name(function(...args) {
    return __async(this, null, function* () {
  ...
  const staticCall = /* @__PURE__ */ __name(function(...args) {
    return __async(this, null, function* () {
  ...
  const send = /* @__PURE__ */ __name(function(...args) {
    return __async(this, null, function* () {
      const runner = contract.runner;
      assert(canSend(runner), "contract runner does not support sending transactions", "UNSUPPORTED_OPERATION", { operation: "sendTransaction" });
  ...
  const estimateGas = /* @__PURE__ */ __name(function(...args) {
    return __async(this, null, function* () {
      const runner = getRunner(contract.runner, "estimateGas");
      assert(canEstimate(runner), "contract runner does not support gas estimation", "UNSUPPORTED_OPERATION", { operation: "estimateGas" });
  ...
  const staticCallResult = /* @__PURE__ */ __name(function(...args) {
    return __async(this, null, function* () {
      const runner = getRunner(contract.runner, "call");
      assert(canCall(runner), "contract runner does not support calling", "UNSUPPORTED_OPERATION", { operation: "call" });
  ...
  const method = /* @__PURE__ */ __name((...args) => __async(null, null, function* () {
    const fragment = getFragment(...args);
...
__name(buildWrappedMethod, "buildWrappedMethod");
function buildWrappedEvent(contract, key) {
  ...
  const method = /* @__PURE__ */ __name(function(...args) {
...
function getSub(contract, operation, event) {
  return __async(this, null, function* () {
    ...
    if (!sub) {
      ...
      const listener = /* @__PURE__ */ __name((log) => {
      ...
      const stop = /* @__PURE__ */ __name(() => __async(null, null, function* () {
...
var _BaseContract = class _BaseContract {
  ...
  constructor(target, abi, runner, _deployTx) {
    ...
    const filters = new Proxy({}, {
      ...
      has: /* @__PURE__ */ __name((target2, prop) => {
  ...
  waitForDeployment() {
    return __async(this, null, function* () {
      ...
      return new Promise((resolve, reject) => {
        const checkCode = /* @__PURE__ */ __name(() => __async(this, null, function* () {
          try {
  ...
  static buildClass(abi) {
    const _CustomContract = class _CustomContract extends _BaseContract {
      constructor(address, runner = null) {
        super(address, abi, runner);
      }
    };
    __name(_CustomContract, "CustomContract");
    let CustomContract = _CustomContract;
...
__name(_BaseContract, "BaseContract");
var BaseContract = _BaseContract;
function _ContractBase() {
  return BaseContract;
}
__name(_ContractBase, "_ContractBase");
var _Contract = class _Contract extends _ContractBase() {
};
__name(_Contract, "Contract");
var Contract = _Contract;

// node_modules/ethers/lib.esm/contract/factory.js
var _ContractFactory = class _ContractFactory {
  /**
   *  The Contract Interface.
   */
  interface;
...
__name(_ContractFactory, "ContractFactory");
var ContractFactory = _ContractFactory;
...
var _MulticoinProviderPlugin = class _MulticoinProviderPlugin {
  /**
   *  The name.
   */
  name;
...
__name(_MulticoinProviderPlugin, "MulticoinProviderPlugin");
var MulticoinProviderPlugin = _MulticoinProviderPlugin;
...
var _EnsResolver = class _EnsResolver {
  ...
  supportsWildcard() {
    return __async(this, null, function* () {
      if (__privateGet(this, _supports2544) == null) {
        __privateSet(this, _supports2544, (() => __async(this, null, function* () {
          try {
            return yield __privateGet(this, _resolver).supportsInterface("0x9061b923");
          } catch (error) {
      ...
      return yield __privateGet(this, _supports2544);
    });
  }
  /**
  ...
  getAddress(coinType) {
    return __async(this, null, function* () {
      ...
      if (coinType === 60) {
        try {
          const result = yield __privateMethod(this, _EnsResolver_instances, fetch_fn).call(this, "addr(bytes32)");
      ...
      if (coinType >= 0 && coinType < 2147483648) {
        ...
        const data2 = yield __privateMethod(this, _EnsResolver_instances, fetch_fn).call(this, "addr(bytes32,uint)", [ethCoinType]);
      ...
      const data = yield __privateMethod(this, _EnsResolver_instances, fetch_fn).call(this, "addr(bytes32,uint)", [coinType]);
  ...
  getText(key) {
    return __async(this, null, function* () {
      const data = yield __privateMethod(this, _EnsResolver_instances, fetch_fn).call(this, "text(bytes32,string)", [key]);
      if (data == null || data === "0x") {
        return null;
      }
      return data;
  ...
  getContentHash() {
    return __async(this, null, function* () {
      const data = yield __privateMethod(this, _EnsResolver_instances, fetch_fn).call(this, "contenthash(bytes32)");
      if (data == null || data === "0x") {
        return null;
      }
  ...
  static fromName(provider, name) {
    return __async(this, null, function* () {
      ...
      while (true) {
        ...
        const addr = yield __privateMethod(_a2 = _EnsResolver, _EnsResolver_static, getResolver_fn).call(_a2, provider, currentName);
        if (addr != null) {
...
fetch_fn = /* @__PURE__ */ __name(function(funcName, params) {
  return __async(this, null, function* () {
    params = (params || []).slice();
    ...
    try {
      const result = yield __privateGet(this, _resolver)[funcName](...params);
      if (fragment) {
...
getResolver_fn = /* @__PURE__ */ __name(function(provider, name) {
  return __async(this, null, function* () {
...
__name(_EnsResolver, "EnsResolver");
...
__name(formatReceiptLog, "formatReceiptLog");
...
__name(formatTransactionResponse, "formatTransactionResponse");
...
var _GasCostPlugin = class _GasCostPlugin extends NetworkPlugin {
  /**
...
__name(_GasCostPlugin, "GasCostPlugin");
var GasCostPlugin = _GasCostPlugin;
var _EnsPlugin = class _EnsPlugin extends NetworkPlugin {
  /**
...
__name(_EnsPlugin, "EnsPlugin");
var EnsPlugin = _EnsPlugin;
var _feeDataFunc;
var _FeeDataNetworkPlugin = class _FeeDataNetworkPlugin extends NetworkPlugin {
  ...
  getFeeData(provider) {
    return __async(this, null, function* () {
      return yield __privateGet(this, _feeDataFunc).call(this, provider);
    });
  }
  clone() {
...
__name(_FeeDataNetworkPlugin, "FeeDataNetworkPlugin");
var FeeDataNetworkPlugin = _FeeDataNetworkPlugin;
var _url2, _processFunc;
var _FetchUrlFeeDataNetworkPlugin = class _FetchUrlFeeDataNetworkPlugin extends NetworkPlugin {
  /**
...
__name(_FetchUrlFeeDataNetworkPlugin, "FetchUrlFeeDataNetworkPlugin");
var FetchUrlFeeDataNetworkPlugin = _FetchUrlFeeDataNetworkPlugin;
...
__name(parseUnits2, "parseUnits");
function getGasStationPlugin(url) {
  return new FetchUrlFeeDataNetworkPlugin(url, (fetchFeeData, provider, request) => __async(null, null, function* () {
...
__name(getGasStationPlugin, "getGasStationPlugin");
var injected = false;
function injectCommonNetworks() {
  ...
  function registerEth(name, chainId, options) {
    const func = /* @__PURE__ */ __name(function() {
  ...
  __name(registerEth, "registerEth");
...
__name(injectCommonNetworks, "injectCommonNetworks");
...
var _PollingBlockSubscriber = class _PollingBlockSubscriber {
  /**
...
poll_fn = /* @__PURE__ */ __name(function() {
  return __async(this, null, function* () {
    try {
      const blockNumber = yield __privateGet(this, _provider).getBlockNumber();
      ...
      if (blockNumber !== __privateGet(this, _blockNumber)) {
        for (let b2 = __privateGet(this, _blockNumber) + 1; b2 <= blockNumber; b2++) {
          ...
          yield __privateGet(this, _provider).emit("block", b2);
        }
        __privateSet(this, _blockNumber, blockNumber);
      }
    } catch (error) {
...
__name(_PollingBlockSubscriber, "PollingBlockSubscriber");
var PollingBlockSubscriber = _PollingBlockSubscriber;
var _provider2, _poll, _running;
var _OnBlockSubscriber = class _OnBlockSubscriber {
  /**
...
__name(_OnBlockSubscriber, "OnBlockSubscriber");
var OnBlockSubscriber = _OnBlockSubscriber;
var _tag, _lastBlock;
var _PollingBlockTagSubscriber = class _PollingBlockTagSubscriber extends OnBlockSubscriber {
  ...
  _poll(blockNumber, provider) {
    return __async(this, null, function* () {
      const block = yield provider.getBlock(__privateGet(this, _tag));
      if (block == null) {
        return;
      }
...
__name(_PollingBlockTagSubscriber, "PollingBlockTagSubscriber");
var PollingBlockTagSubscriber = _PollingBlockTagSubscriber;
var _filter2;
var _PollingOrphanSubscriber = class _PollingOrphanSubscriber extends OnBlockSubscriber {
...
__name(_PollingOrphanSubscriber, "PollingOrphanSubscriber");
var PollingOrphanSubscriber = _PollingOrphanSubscriber;
var _hash;
var _PollingTransactionSubscriber = class _PollingTransactionSubscriber extends OnBlockSubscriber {
  /**
  ...
  _poll(blockNumber, provider) {
    return __async(this, null, function* () {
      const tx = yield provider.getTransactionReceipt(__privateGet(this, _hash));
      if (tx) {
...
_hash = new WeakMap();
__name(_PollingTransactionSubscriber, "PollingTransactionSubscriber");
var PollingTransactionSubscriber = _PollingTransactionSubscriber;
var _provider3, _filter3, _poller2, _running2, _blockNumber2, _PollingEventSubscriber_instances, poll_fn2;
var _PollingEventSubscriber = class _PollingEventSubscriber {
  /**
   *  Create a new **PollingTransactionSubscriber** attached to
...
poll_fn2 = /* @__PURE__ */ __name(function(blockNumber) {
  return __async(this, null, function* () {
    if (__privateGet(this, _blockNumber2) === -2) {
      return;
    }
    ...
    const logs = yield __privateGet(this, _provider3).getLogs(filter);
    if (logs.length === 0) {
...
__name(_PollingEventSubscriber, "PollingEventSubscriber");
var PollingEventSubscriber = _PollingEventSubscriber;
...
var _UnmanagedSubscriber = class _UnmanagedSubscriber {
  /**
...
__name(_UnmanagedSubscriber, "UnmanagedSubscriber");
var UnmanagedSubscriber = _UnmanagedSubscriber;
...
__name(concisify, "concisify");
function getSubscription(_event2, provider) {
  return __async(this, null, function* () {
    if (_event2 == null) {
    ...
    if (_event2.address || _event2.topics) {
      ...
      if (event.address) {
        const addresses = [];
        const promises = [];
        const addAddress = /* @__PURE__ */ __name((addr) => {
          if (isHexString(addr)) {
            addresses.push(addr);
          } else {
...
var _AbstractProvider = class _AbstractProvider {
  /**
  ...
  getBlockNumber() {
    return __async(this, null, function* () {
      const blockNumber = getNumber(yield __privateMethod(this, _AbstractProvider_instances, perform_fn).call(this, { method: "getBlockNumber" }), "%response");
  ...
  _getFilter(filter) {
    ...
    const resolve = /* @__PURE__ */ __name((_address, fromBlock2, toBlock2) => {
      let address2 = void 0;
  ...
  getFeeData() {
    return __async(this, null, function* () {
      ...
      const getFeeDataFunc = /* @__PURE__ */ __name(() => __async(this, null, function* () {
        const { _block, gasPrice, priorityFee } = yield resolveProperties({
          ...
          gasPrice: (() => __async(this, null, function* () {
            try {
              const value = yield __privateMethod(this, _AbstractProvider_instances, perform_fn).call(this, { method: "getGasPrice" });
          ...
          priorityFee: (() => __async(this, null, function* () {
            try {
              const value = yield __privateMethod(this, _AbstractProvider_instances, perform_fn).call(this, { method: "getPriorityFee" });
              return getBigInt(value, "%response");
            } catch (error) {
            }
            return null;
  ...
  estimateGas(_tx) {
    return __async(this, null, function* () {
      ...
      return getBigInt(yield __privateMethod(this, _AbstractProvider_instances, perform_fn).call(this, {
        method: "estimateGas",
        transaction: tx
      }), "%response");
    });
  ...
  call(_tx) {
    return __async(this, null, function* () {
      ...
      return yield __privateMethod(this, _AbstractProvider_instances, checkNetwork_fn).call(this, __privateMethod(this, _AbstractProvider_instances, call_fn).call(this, tx, blockTag, _tx.enableCcipRead ? 0 : -1));
    });
  }
  getBalance(address, blockTag) {
    return __async(this, null, function* () {
      return getBigInt(yield __privateMethod(this, _AbstractProvider_instances, getAccountValue_fn).call(this, { method: "getBalance" }, address, blockTag), "%response");
    });
  }
  getTransactionCount(address, blockTag) {
    return __async(this, null, function* () {
      return getNumber(yield __privateMethod(this, _AbstractProvider_instances, getAccountValue_fn).call(this, { method: "getTransactionCount" }, address, blockTag), "%response");
    });
  }
  getCode(address, blockTag) {
    return __async(this, null, function* () {
      return hexlify(yield __privateMethod(this, _AbstractProvider_instances, getAccountValue_fn).call(this, { method: "getCode" }, address, blockTag));
    });
  }
  getStorage(address, _position, blockTag) {
    return __async(this, null, function* () {
      const position = getBigInt(_position, "position");
      return hexlify(yield __privateMethod(this, _AbstractProvider_instances, getAccountValue_fn).call(this, { method: "getStorage", position }, address, blockTag));
    });
  }
  // Write
  ...
  getTransactionReceipt(hash2) {
    return __async(this, null, function* () {
      ...
      if (params.gasPrice == null && params.effectiveGasPrice == null) {
        const tx = yield __privateMethod(this, _AbstractProvider_instances, perform_fn).call(this, { method: "getTransaction", hash: hash2 });
        if (tx == null) {
  ...
  waitForTransaction(hash2, _confirms, timeout) {
    return __async(this, null, function* () {
      ...
      return new Promise((resolve, reject) => __async(this, null, function* () {
        let timer = null;
        const listener = /* @__PURE__ */ __name(((blockNumber) => __async(this, null, function* () {
          try {
  ...
  on(event, listener) {
    return __async(this, null, function* () {
      const sub = yield __privateMethod(this, _AbstractProvider_instances, getSub_fn).call(this, event);
      sub.listeners.push({ listener, once: false });
      if (!sub.started) {
  ...
  emit(event, ...args) {
    return __async(this, null, function* () {
      const sub = yield __privateMethod(this, _AbstractProvider_instances, hasSub_fn).call(this, event, args);
  ...
  listenerCount(event) {
    return __async(this, null, function* () {
      if (event) {
        const sub = yield __privateMethod(this, _AbstractProvider_instances, hasSub_fn).call(this, event);
        if (!sub) {
          return 0;
        }
        return sub.listeners.length;
  ...
  removeAllListeners(event) {
    return __async(this, null, function* () {
      if (event) {
        const { tag, started, subscriber } = yield __privateMethod(this, _AbstractProvider_instances, getSub_fn).call(this, event);
        if (started) {
          subscriber.stop();
        }
...
perform_fn = /* @__PURE__ */ __name(function(req) {
  return __async(this, null, function* () {
...
call_fn = /* @__PURE__ */ __name(function(tx, blockTag, attempt) {
  return __async(this, null, function* () {
    ...
    try {
      ...
      if (!this.disableCcipRead && isCallException(error) && error.data && attempt >= 0 && blockTag === "latest" && transaction.to != null && dataSlice(error.data, 0, 4) === "0x556f1830") {
        ...
        try {
          const result = yield __privateMethod(this, _AbstractProvider_instances, call_fn).call(this, tx2, blockTag, attempt + 1);
...
checkNetwork_fn = /* @__PURE__ */ __name(function(promise) {
  return __async(this, null, function* () {
...
getAccountValue_fn = /* @__PURE__ */ __name(function(request, _address, _blockTag) {
  return __async(this, null, function* () {
    ...
    return yield __privateMethod(this, _AbstractProvider_instances, checkNetwork_fn).call(this, __privateMethod(this, _AbstractProvider_instances, perform_fn).call(this, Object.assign(request, { address, blockTag })));
  });
}, "#getAccountValue");
getBlock_fn = /* @__PURE__ */ __name(function(block, includeTransactions) {
  return __async(this, null, function* () {
    if (isHexString(block, 32)) {
      return yield __privateMethod(this, _AbstractProvider_instances, perform_fn).call(this, {
        method: "getBlock",
        blockHash: block,
        includeTransactions
      });
...
hasSub_fn = /* @__PURE__ */ __name(function(event, emitArgs) {
  return __async(this, null, function* () {
...
getSub_fn = /* @__PURE__ */ __name(function(event) {
  return __async(this, null, function* () {
...
__name(_AbstractProvider, "AbstractProvider");
var AbstractProvider = _AbstractProvider;
...
__name(parseOffchainLookup, "parseOffchainLookup");
...
__name(checkProvider, "checkProvider");
...
var _AbstractSigner = class _AbstractSigner {
  /**
...
__name(_AbstractSigner, "AbstractSigner");
var AbstractSigner = _AbstractSigner;
...
throwUnsupported_fn = /* @__PURE__ */ __name(function(suffix, operation) {
  assert(false, `VoidSigner cannot sign ${suffix}`, "UNSUPPORTED_OPERATION", { operation });
}, "#throwUnsupported");
__name(_VoidSigner, "VoidSigner");
...
var _FilterIdSubscriber = class _FilterIdSubscriber {
  /**
...
poll_fn3 = /* @__PURE__ */ __name(function(blockNumber) {
  return __async(this, null, function* () {
    try {
      ...
      let filterId = null;
      try {
        filterId = yield __privateGet(this, _filterIdPromise);
      } catch (error) {
      ...
      const network = yield __privateGet(this, _provider4).getNetwork();
      ...
      const result = yield __privateGet(this, _provider4).send("eth_getFilterChanges", [filterId]);
      yield this._emitResults(__privateGet(this, _provider4), result);
    } catch (error) {
...
__name(_FilterIdSubscriber, "FilterIdSubscriber");
var FilterIdSubscriber = _FilterIdSubscriber;
var _event;
var _FilterIdEventSubscriber = class _FilterIdEventSubscriber extends FilterIdSubscriber {
  /**
  ...
  _subscribe(provider) {
    return __async(this, null, function* () {
      const filterId = yield provider.send("eth_newFilter", [__privateGet(this, _event)]);
      return filterId;
    });
  }
...
_event = new WeakMap();
__name(_FilterIdEventSubscriber, "FilterIdEventSubscriber");
var FilterIdEventSubscriber = _FilterIdEventSubscriber;
var _FilterIdPendingSubscriber = class _FilterIdPendingSubscriber extends FilterIdSubscriber {
  _subscribe(provider) {
    return __async(this, null, function* () {
...
__name(_FilterIdPendingSubscriber, "FilterIdPendingSubscriber");
var FilterIdPendingSubscriber = _FilterIdPendingSubscriber;
...
var _JsonRpcSigner = class _JsonRpcSigner extends AbstractSigner {
  address;
  ...
  sendUncheckedTransaction(_tx) {
    return __async(this, null, function* () {
      ...
      if (tx.to != null) {
        const _to2 = tx.to;
        promises.push((() => __async(this, null, function* () {
          tx.to = yield resolveAddress(_to2, this.provider);
        }))());
      }
      if (promises.length) {
        yield Promise.all(promises);
  ...
  sendTransaction(tx) {
    return __async(this, null, function* () {
      ...
      return yield new Promise((resolve, reject) => {
        ...
        let invalids = 0;
        const checkTx = /* @__PURE__ */ __name(() => __async(this, null, function* () {
          try {
  ...
  signTypedData(domain, types, _value2) {
    return __async(this, null, function* () {
      const value = deepCopy(_value2);
      const populated = yield TypedDataEncoder.resolveNames(domain, types, value, (value2) => __async(null, null, function* () {
...
__name(_JsonRpcSigner, "JsonRpcSigner");
var JsonRpcSigner = _JsonRpcSigner;
...
var _JsonRpcApiProvider = class _JsonRpcApiProvider extends AbstractProvider {
  ...
  _detectNetwork() {
    return __async(this, null, function* () {
      ...
      if (__privateGet(this, _pendingDetectNetwork)) {
        return yield __privateGet(this, _pendingDetectNetwork);
      }
      if (this.ready) {
        __privateSet(this, _pendingDetectNetwork, (() => __async(this, null, function* () {
          try {
  ...
  _start() {
    ...
    (() => __async(this, null, function* () {
      while (__privateGet(this, _network2) == null && !this.destroyed) {
        try {
          __privateSet(this, _network2, yield this._detectNetwork());
        } catch (error) {
          if (this.destroyed) {
            break;
          }
  ...
  _waitUntilReady() {
    return __async(this, null, function* () {
      ...
      return yield __privateGet(this, _notReady).promise;
    });
  }
  /**
...
scheduleDrain_fn = /* @__PURE__ */ __name(function() {
  if (__privateGet(this, _drainTimer)) {
    return;
  }
...
__name(_JsonRpcApiProvider, "JsonRpcApiProvider");
var JsonRpcApiProvider = _JsonRpcApiProvider;
var _pollingInterval;
var _JsonRpcApiPollingProvider = class _JsonRpcApiPollingProvider extends JsonRpcApiProvider {
  constructor(network, options) {
    super(network, options);
...
__name(_JsonRpcApiPollingProvider, "JsonRpcApiPollingProvider");
var JsonRpcApiPollingProvider = _JsonRpcApiPollingProvider;
var _connect;
var _JsonRpcProvider = class _JsonRpcProvider extends JsonRpcApiPollingProvider {
...
var JsonRpcProvider = _JsonRpcProvider;
...
__name(spelunkData, "spelunkData");
...
__name(_spelunkMessage, "_spelunkMessage");
function spelunkMessage(value) {
  const result = [];
  _spelunkMessage(value, result);
  return result;
}
__name(spelunkMessage, "spelunkMessage");
...
var _AnkrProvider = class _AnkrProvider extends JsonRpcProvider {
  /**
  ...
  static getRequest(network, apiKey) {
    ...
    if (apiKey === defaultApiKey) {
      request.retryFunc = (request2, response, attempt) => __async(null, null, function* () {
...
__name(_AnkrProvider, "AnkrProvider");
var AnkrProvider = _AnkrProvider;
...
__name(getHost2, "getHost");
var _AlchemyProvider = class _AlchemyProvider extends JsonRpcProvider {
  apiKey;
  constructor(_network3, apiKey) {
    if (_network3 == null) {
      _network3 = "mainnet";
...
__name(_AlchemyProvider, "AlchemyProvider");
var AlchemyProvider = _AlchemyProvider;
...
__name(getHost3, "getHost");
var _ChainstackProvider = class _ChainstackProvider extends JsonRpcProvider {
  /**
...
__name(_ChainstackProvider, "ChainstackProvider");
var ChainstackProvider = _ChainstackProvider;

// node_modules/ethers/lib.esm/providers/provider-cloudflare.js
var _CloudflareProvider = class _CloudflareProvider extends JsonRpcProvider {
...
__name(_CloudflareProvider, "CloudflareProvider");
var CloudflareProvider = _CloudflareProvider;
...
var _EtherscanPlugin = class _EtherscanPlugin extends NetworkPlugin {
  /**
...
__name(_EtherscanPlugin, "EtherscanPlugin");
var EtherscanPlugin = _EtherscanPlugin;
var skipKeys = ["enableCcipRead"];
var nextId = 1;
var _plugin;
var _EtherscanProvider = class _EtherscanProvider extends AbstractProvider {
  /**
...
_plugin = new WeakMap();
__name(_EtherscanProvider, "EtherscanProvider");
var EtherscanProvider = _EtherscanProvider;
...
var _SocketSubscriber = class _SocketSubscriber {
  /**
    ...
    if (__privateGet(this, _paused) === null) {
      ...
      if (emitPromise == null) {
        ...
        emitPromise = emitPromise.then(() => __async(this, null, function* () {
          yield this._emit(__privateGet(this, _provider5), message);
        }));
      }
...
__name(_SocketSubscriber, "SocketSubscriber");
var SocketSubscriber = _SocketSubscriber;
var _SocketBlockSubscriber = class _SocketBlockSubscriber extends SocketSubscriber {
  /**
   *  @_ignore:
   */
  constructor(provider) {
...
__name(_SocketBlockSubscriber, "SocketBlockSubscriber");
var SocketBlockSubscriber = _SocketBlockSubscriber;
var _SocketPendingSubscriber = class _SocketPendingSubscriber extends SocketSubscriber {
  /**
   *  @_ignore:
   */
  constructor(provider) {
...
__name(_SocketPendingSubscriber, "SocketPendingSubscriber");
var SocketPendingSubscriber = _SocketPendingSubscriber;
var _logFilter;
var _SocketEventSubscriber = class _SocketEventSubscriber extends SocketSubscriber {
  /**
   *  @_ignore:
   */
  constructor(provider, filter) {
...
__name(_SocketEventSubscriber, "SocketEventSubscriber");
var SocketEventSubscriber = _SocketEventSubscriber;
var _callbacks, _subs2, _pending;
var _SocketProvider = class _SocketProvider extends JsonRpcApiProvider {
  /**
...
__name(_SocketProvider, "SocketProvider");
var SocketProvider = _SocketProvider;

// node_modules/ethers/lib.esm/providers/provider-websocket.js
var _connect2, _websocket;
var _WebSocketProvider = class _WebSocketProvider extends SocketProvider {
  constructor(url, network, options) {
    super(network, options);
...
__name(_WebSocketProvider, "WebSocketProvider");
var WebSocketProvider = _WebSocketProvider;
...
__name(getHost4, "getHost");
var _InfuraWebSocketProvider = class _InfuraWebSocketProvider extends WebSocketProvider {
  /**
...
__name(_InfuraWebSocketProvider, "InfuraWebSocketProvider");
var InfuraWebSocketProvider = _InfuraWebSocketProvider;
var _InfuraProvider = class _InfuraProvider extends JsonRpcProvider {
  /**
   *  The Project ID for the INFURA connection.
   */
  projectId;
...
__name(_InfuraProvider, "InfuraProvider");
var InfuraProvider = _InfuraProvider;
...
__name(getHost5, "getHost");
var _QuickNodeProvider = class _QuickNodeProvider extends JsonRpcProvider {
  /**
   *  The API token.
   */
  token;
...
__name(_QuickNodeProvider, "QuickNodeProvider");
var QuickNodeProvider = _QuickNodeProvider;
  ...
  return __async(this, null, function* () {
    while (config.blockNumber < 0 || config.blockNumber < blockNumber) {
      if (!config._updateNumber) {
        config._updateNumber = (() => __async(null, null, function* () {
          try {
...
__name(checkQuorum, "checkQuorum");
...
__name(getAnyResult, "getAnyResult");
function getFuzzyMode(quorum, results) {
  if (quorum === 1) {
    return getNumber(getMedian(quorum, results), "%internal");
  }
  const tally = /* @__PURE__ */ new Map();
  const add2 = /* @__PURE__ */ __name((result, weight) => {
...
__name(getFuzzyMode, "getFuzzyMode");
...
var _FallbackProvider = class _FallbackProvider extends AbstractProvider {
  /**
  ...
  _perform(req) {
    return __async(this, null, function* () {
      if (req.method === "broadcastTransaction") {
        ...
        const broadcasts = __privateGet(this, _configs).map((_0, _1) => __async(this, [_0, _1], function* ({ provider, weight }, index) {
          try {
      ...
      yield __privateMethod(this, _FallbackProvider_instances, initialSync_fn).call(this);
      ...
      const result = yield __privateMethod(this, _FallbackProvider_instances, waitForQuorum_fn).call(this, running, req);
...
// the running set
getNextConfig_fn = /* @__PURE__ */ __name(function(running) {
...
addRunner_fn = /* @__PURE__ */ __name(function(running, req) {
...
initialSync_fn = /* @__PURE__ */ __name(function() {
  return __async(this, null, function* () {
    ...
    if (!initialSync) {
      ...
      __privateSet(this, _initialSyncPromise, initialSync = (() => __async(this, null, function* () {
        yield Promise.all(promises);
        let chainId = null;
...
checkQuorum_fn = /* @__PURE__ */ __name(function(running, req) {
  return __async(this, null, function* () {
    const results = [];
    for (const runner of running) {
...
waitForQuorum_fn = /* @__PURE__ */ __name(function(running, req) {
  return __async(this, null, function* () {
    if (running.size === 0) {
    ...
    const value = yield __privateMethod(this, _FallbackProvider_instances, checkQuorum_fn).call(this, running, req);
    if (value !== void 0) {
      if (value instanceof Error) {
        throw value;
      }
    ...
    return yield __privateMethod(this, _FallbackProvider_instances, waitForQuorum_fn).call(this, running, req);
  });
}, "#waitForQuorum");
__name(_FallbackProvider, "FallbackProvider");
    ...
    return __async(this, null, function* () {
      if (blockTag === "pending") {
        if (__privateGet(this, _noncePromise) == null) {
          __privateSet(this, _noncePromise, __superGet(_NonceManager.prototype, this, "getNonce").call(this, "pending"));
        }
        const delta = __privateGet(this, _delta);
        return (yield __privateGet(this, _noncePromise)) + delta;
      }
...
_delta = new WeakMap();
__name(_NonceManager, "NonceManager");
...
var _BrowserProvider = class _BrowserProvider extends JsonRpcApiPollingProvider {
  ...
  constructor(ethereum, network, _options4) {
    ...
    __privateSet(this, _request2, (method, params) => __async(this, null, function* () {
  ...
  _send(payload) {
    return __async(this, null, function* () {
      ...
      try {
        const result = yield __privateGet(this, _request2).call(this, payload.method, payload.params || []);
  ...
  getSigner(address) {
    return __async(this, null, function* () {
      ...
      if (!(yield this.hasSigner(address))) {
        try {
          yield __privateGet(this, _request2).call(this, "eth_requestAccounts", []);
        } catch (error) {
  ...
  static discover(options) {
    return __async(this, null, function* () {
      ...
      return yield new Promise((resolve, reject) => {
        let found = [];
        const addProvider = /* @__PURE__ */ __name((event) => {
...
__name(_BrowserProvider, "BrowserProvider");
...
var _BlockscoutProvider = class _BlockscoutProvider extends JsonRpcProvider {
  /**
   *  The API key.
   */
  apiKey;
...
__name(_BlockscoutProvider, "BlockscoutProvider");
var BlockscoutProvider = _BlockscoutProvider;
...
__name(getHost6, "getHost");
var _PocketProvider = class _PocketProvider extends JsonRpcProvider {
  /**
...
__name(_PocketProvider, "PocketProvider");
var PocketProvider = _PocketProvider;
...
__name(decodeOwl, "decodeOwl");

// node_modules/ethers/lib.esm/wordlists/wordlist.js
var _Wordlist = class _Wordlist {
  locale;
  /**
...
var _WordlistOwl = class _WordlistOwl extends Wordlist {
  /**
...
loadWords_fn = /* @__PURE__ */ __name(function() {
...
__name(_WordlistOwl, "WordlistOwl");
var WordlistOwl = _WordlistOwl;
...
var wordlist = null;
var _LangEn = class _LangEn extends WordlistOwl {
  /**
...
var _ModeOfOperation = class _ModeOfOperation {
...
__name(_ModeOfOperation, "ModeOfOperation");
var ModeOfOperation = _ModeOfOperation;
...
var _CBC_iv;
var _CBC_lastBlock;
var _CBC = class _CBC extends ModeOfOperation {
  constructor(key, iv) {
    super("ECC", key, _CBC);
...
var _CFB_shift;
_CFB_iv = /* @__PURE__ */ new WeakMap(), _CFB_shiftRegister = /* @__PURE__ */ new WeakMap(), _CFB_instances = /* @__PURE__ */ new WeakSet(), _CFB_shift = /* @__PURE__ */ __name(function _CFB_shift2(data) {
...
var _CTR_counter;
var _CTR = class _CTR extends ModeOfOperation {
...
__name(isKeystoreJson, "isKeystoreJson");
...
__name(getDecryptKdfParams, "getDecryptKdfParams");
...
__name(decryptKeystoreJsonSync, "decryptKeystoreJsonSync");
...
__name(decryptKeystoreJson, "decryptKeystoreJson");
...
__name(getEncryptKdfParams, "getEncryptKdfParams");
...
__name(_encryptKeystore, "_encryptKeystore");
...
__name(encryptKeystoreJsonSync, "encryptKeystoreJsonSync");
...
__name(encryptKeystoreJson, "encryptKeystoreJson");
...
__name(encodeBase58Check, "encodeBase58Check");
var _guard6 = {};
...
var _HDNodeWallet = class _HDNodeWallet extends BaseWallet {
  ...
  encrypt(password, progressCallback) {
    return __async(this, null, function* () {
      return yield encryptKeystoreJson(__privateMethod(this, _HDNodeWallet_instances, account_fn).call(this), password, { progressCallback });
    });
  }
  /**
...
account_fn = /* @__PURE__ */ __name(function() {
...
fromSeed_fn = /* @__PURE__ */ __name(function(_seed, mnemonic) {
...
__name(_HDNodeWallet, "HDNodeWallet");
var HDNodeWallet = _HDNodeWallet;
var _HDNodeVoidWallet = class _HDNodeVoidWallet extends VoidSigner {
  /**
   *  The compressed public key.
   */
  publicKey;
...
__name(_HDNodeVoidWallet, "HDNodeVoidWallet");
var HDNodeVoidWallet = _HDNodeVoidWallet;
...
__name(getIndexedAccountPath, "getIndexedAccountPath");
...
__name(isCrowdsaleJson, "isCrowdsaleJson");
...
__name(decryptCrowdsaleJson, "decryptCrowdsaleJson");
...
fromAccount_fn = /* @__PURE__ */ __name(function(account) {
...
__name(decodeOwlA, "decodeOwlA");

// node_modules/ethers/lib.esm/wordlists/wordlist-owla.js
var _accent;
var _WordlistOwlA = class _WordlistOwlA extends WordlistOwl {
  /**
...
_accent = new WeakMap();
__name(_WordlistOwlA, "WordlistOwlA");
var WordlistOwlA = _WordlistOwlA;
