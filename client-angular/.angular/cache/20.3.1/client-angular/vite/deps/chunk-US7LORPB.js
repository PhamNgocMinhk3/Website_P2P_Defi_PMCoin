...
__publicField(_InputModalityDetector, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_FocusMonitor, "ɵprov", ɵɵdefineInjectable({
  token: _FocusMonitor,
...
__publicField(_CdkMonitorFocus, "ɵdir", ɵɵdefineDirective({
...
__publicField(_MediaMatcher, "ɵprov", ɵɵdefineInjectable({
  token: _MediaMatcher,
...
__publicField(_BreakpointObserver, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_MutationObserverFactory, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_ContentObserver, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_CdkObserveContent, "ɵdir", ɵɵdefineDirective({
...
__publicField(_ObserversModule, "ɵmod", ɵɵdefineNgModule({
  type: _ObserversModule,
  imports: [CdkObserveContent],
  exports: [CdkObserveContent]
}));
__publicField(_ObserversModule, "ɵinj", ɵɵdefineInjector({
...
__publicField(_InteractivityChecker, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_FocusTrapFactory, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_CdkTrapFocus, "ɵdir", ɵɵdefineDirective({
  type: _CdkTrapFocus,
...
__publicField(_LiveAnnouncer, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_CdkAriaLive, "ɵdir", ɵɵdefineDirective({
  type: _CdkAriaLive,
...
__publicField(_HighContrastModeDetector, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_A11yModule, "ɵmod", ɵɵdefineNgModule({
  type: _A11yModule,
  imports: [ObserversModule, CdkAriaLive, CdkTrapFocus, CdkMonitorFocus],
  exports: [CdkAriaLive, CdkTrapFocus, CdkMonitorFocus]
}));
__publicField(_A11yModule, "ɵinj", ɵɵdefineInjector({
...
var _TreeKeyManager = class _TreeKeyManager {
   ...
   */
  _skipPredicateFn = /* @__PURE__ */ __name((_item) => false, "_skipPredicateFn");
  /** Function to determine equivalent items. */
  _trackByFn = /* @__PURE__ */ __name((item) => item, "_trackByFn");
...
__name(_TreeKeyManager, "TreeKeyManager");
var TreeKeyManager = _TreeKeyManager;
function TREE_KEY_MANAGER_FACTORY() {
  return (items, options) => new TreeKeyManager(items, options);
}
__name(TREE_KEY_MANAGER_FACTORY, "TREE_KEY_MANAGER_FACTORY");
...
__publicField(_AriaDescriber, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_FocusTrapManager, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_ConfigurableFocusTrapFactory, "ɵprov", ɵɵdefineInjectable({
...
__publicField(_MatCommonModule, "ɵmod", ɵɵdefineNgModule({
  type: _MatCommonModule,
  imports: [BidiModule],
  exports: [BidiModule]
}));
__publicField(_MatCommonModule, "ɵinj", ɵɵdefineInjector({
...
//# sourceMappingURL=chunk-US7LORPB.js.map
