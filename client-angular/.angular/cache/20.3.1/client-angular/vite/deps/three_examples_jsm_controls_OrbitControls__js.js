...
var _OrbitControls = class _OrbitControls extends EventDispatcher {
  constructor(object, domElement) {
    ...
    this.update = (function() {
      ...
      return /* @__PURE__ */ __name(function update(deltaTime = null) {
    ...
    __name(updateZoomParameters, "updateZoomParameters");
    function clampDistance(dist) {
      return Math.max(scope.minDistance, Math.min(scope.maxDistance, dist));
    }
    __name(clampDistance, "clampDistance");
    ...
    __name(customWheelEvent, "customWheelEvent");
    ...
    __name(interceptControlDown, "interceptControlDown");
    ...
    __name(removePointer, "removePointer");
    ...
    __name(isTrackingPointer, "isTrackingPointer");
    ...
    __name(trackPointer, "trackPointer");
    function getSecondPointerPosition(event) {
      const pointerId = event.pointerId === pointers[0] ? pointers[1] : pointers[0];
      return pointerPositions[pointerId];
    }
    __name(getSecondPointerPosition, "getSecondPointerPosition");
...
__name(_OrbitControls, "OrbitControls");
var OrbitControls = _OrbitControls;
export {
  OrbitControls
};
