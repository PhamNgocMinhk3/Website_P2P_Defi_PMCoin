...
__name(MatSortHeader_Conditional_3_Template, "MatSortHeader_Conditional_3_Template");
function getSortDuplicateSortableIdError(id) {
  return Error(`Cannot have two MatSortables with the same id (${id}).`);
}
__name(getSortDuplicateSortableIdError, "getSortDuplicateSortableIdError");
function getSortHeaderNotContainedWithinSortError() {
  return Error(`MatSortHeader must be placed within a parent element with the MatSort directive.`);
}
__name(getSortHeaderNotContainedWithinSortError, "getSortHeaderNotContainedWithinSortError");
function getSortHeaderMissingIdError() {
  return Error(`MatSortHeader must be provided with a unique id.`);
}
__name(getSortHeaderMissingIdError, "getSortHeaderMissingIdError");
function getSortInvalidDirectionError(direction) {
  return Error(`${direction} is not a valid sort direction ('asc' or 'desc').`);
}
__name(getSortInvalidDirectionError, "getSortInvalidDirectionError");
...
__name(_MatSort, "MatSort");
__publicField(_MatSort, "ɵfac", /* @__PURE__ */ __name(function MatSort_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatSort)(ɵɵdirectiveInject(MAT_SORT_DEFAULT_OPTIONS, 8));
}, "MatSort_Factory"));
__publicField(_MatSort, "ɵdir", ɵɵdefineDirective({
  type: _MatSort,
  selectors: [["", "matSort", ""]],
...
__name(getSortDirectionCycle, "getSortDirectionCycle");
...
__name(_MatSortHeaderIntl, "MatSortHeaderIntl");
__publicField(_MatSortHeaderIntl, "ɵfac", /* @__PURE__ */ __name(function MatSortHeaderIntl_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatSortHeaderIntl)();
}, "MatSortHeaderIntl_Factory"));
__publicField(_MatSortHeaderIntl, "ɵprov", ɵɵdefineInjectable({
...
__name(MAT_SORT_HEADER_INTL_PROVIDER_FACTORY, "MAT_SORT_HEADER_INTL_PROVIDER_FACTORY");
...
__name(_MatSortHeader, "MatSortHeader");
__publicField(_MatSortHeader, "ɵfac", /* @__PURE__ */ __name(function MatSortHeader_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatSortHeader)();
}, "MatSortHeader_Factory"));
__publicField(_MatSortHeader, "ɵcmp", ɵɵdefineComponent({
  type: _MatSortHeader,
  selectors: [["", "mat-sort-header", ""]],
  hostAttrs: [1, "mat-sort-header"],
  hostVars: 3,
  hostBindings: /* @__PURE__ */ __name(function MatSortHeader_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("click", /* @__PURE__ */ __name(function MatSortHeader_click_HostBindingHandler() {
        return ctx._toggleOnInteraction();
      }, "MatSortHeader_click_HostBindingHandler"))("keydown", /* @__PURE__ */ __name(function MatSortHeader_keydown_HostBindingHandler($event) {
        return ctx._handleKeydown($event);
      }, "MatSortHeader_keydown_HostBindingHandler"))("mouseleave", /* @__PURE__ */ __name(function MatSortHeader_mouseleave_HostBindingHandler() {
  ...
  template: /* @__PURE__ */ __name(function MatSortHeader_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef();
...
__name(_MatSortModule, "MatSortModule");
__publicField(_MatSortModule, "ɵfac", /* @__PURE__ */ __name(function MatSortModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatSortModule)();
}, "MatSortModule_Factory"));
__publicField(_MatSortModule, "ɵmod", ɵɵdefineNgModule({
  type: _MatSortModule,
  imports: [MatCommonModule, MatSort, MatSortHeader],
  exports: [MatSort, MatSortHeader]
}));
__publicField(_MatSortModule, "ɵinj", ɵɵdefineInjector({
