...
__publicField(_MatPseudoCheckbox, "ɵcmp", ɵɵdefineComponent({
...
__publicField(_MatPseudoCheckboxModule, "ɵmod", ɵɵdefineNgModule({
  type: _MatPseudoCheckboxModule,
  imports: [MatCommonModule, MatPseudoCheckbox],
  exports: [MatPseudoCheckbox]
}));
__publicField(_MatPseudoCheckboxModule, "ɵinj", ɵɵdefineInjector({
...
__name(MatOption_Conditional_0_Template, "MatOption_Conditional_0_Template");
...
__name(MatOption_Conditional_5_Template, "MatOption_Conditional_5_Template");
...
__name(MatOption_Conditional_6_Template, "MatOption_Conditional_6_Template");
...
__name(_MatOptgroup, "MatOptgroup");
__publicField(_MatOptgroup, "ɵfac", /* @__PURE__ */ __name(function MatOptgroup_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatOptgroup)();
}, "MatOptgroup_Factory"));
__publicField(_MatOptgroup, "ɵcmp", ɵɵdefineComponent({
  type: _MatOptgroup,
  selectors: [["mat-optgroup"]],
  hostAttrs: [1, "mat-mdc-optgroup"],
  hostVars: 3,
  hostBindings: /* @__PURE__ */ __name(function MatOptgroup_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵattribute("role", ctx._inert ? null : "group")("aria-disabled", ctx._inert ? null : ctx.disabled.toString())("aria-labelledby", ctx._inert ? null : ctx._labelId);
    }
  }, "MatOptgroup_HostBindings"),
  inputs: {
    label: "label",
  ...
  template: /* @__PURE__ */ __name(function MatOptgroup_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef(_c0);
...
var _MatOptionSelectionChange = class _MatOptionSelectionChange {
  source;
  isUserInput;
...
__name(_MatOptionSelectionChange, "MatOptionSelectionChange");
var MatOptionSelectionChange = _MatOptionSelectionChange;
...
__name(_MatOption, "MatOption");
__publicField(_MatOption, "ɵfac", /* @__PURE__ */ __name(function MatOption_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatOption)();
}, "MatOption_Factory"));
__publicField(_MatOption, "ɵcmp", ɵɵdefineComponent({
  type: _MatOption,
  selectors: [["mat-option"]],
  viewQuery: /* @__PURE__ */ __name(function MatOption_Query(rf, ctx) {
    if (rf & 1) {
      ɵɵviewQuery(_c2, 7);
    }
    if (rf & 2) {
  ...
  hostVars: 11,
  hostBindings: /* @__PURE__ */ __name(function MatOption_HostBindings(rf, ctx) {
    if (rf & 1) {
      ɵɵlistener("click", /* @__PURE__ */ __name(function MatOption_click_HostBindingHandler() {
        return ctx._selectViaInteraction();
      }, "MatOption_click_HostBindingHandler"))("keydown", /* @__PURE__ */ __name(function MatOption_keydown_HostBindingHandler($event) {
        return ctx._handleKeydown($event);
      }, "MatOption_keydown_HostBindingHandler"));
    }
    if (rf & 2) {
  ...
  template: /* @__PURE__ */ __name(function MatOption_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef(_c3);
...
__name(_countGroupLabelsBeforeOption, "_countGroupLabelsBeforeOption");
...
__name(_getOptionScrollPosition, "_getOptionScrollPosition");

// node_modules/@angular/material/fesm2022/option-module.mjs
var _MatOptionModule = class _MatOptionModule {
};
__name(_MatOptionModule, "MatOptionModule");
__publicField(_MatOptionModule, "ɵfac", /* @__PURE__ */ __name(function MatOptionModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatOptionModule)();
}, "MatOptionModule_Factory"));
__publicField(_MatOptionModule, "ɵmod", ɵɵdefineNgModule({
  type: _MatOptionModule,
  imports: [MatRippleModule, MatCommonModule, MatPseudoCheckboxModule, MatOption, MatOptgroup],
  exports: [MatOption, MatOptgroup]
}));
__publicField(_MatOptionModule, "ɵinj", ɵɵdefineInjector({
...
//# sourceMappingURL=chunk-MZSOY5PH.js.map
