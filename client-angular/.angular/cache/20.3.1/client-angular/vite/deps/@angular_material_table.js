...
__name(CdkTable_Conditional_2_Template, "CdkTable_Conditional_2_Template");
...
__name(CdkTable_Conditional_3_Template, "CdkTable_Conditional_3_Template");
function CdkTable_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0, 1)(1, 2)(2, 3)(3, 4);
  }
}
__name(CdkTable_Conditional_4_Template, "CdkTable_Conditional_4_Template");
...
__name(CdkTextColumn_th_1_Template, "CdkTextColumn_th_1_Template");
...
__name(CdkTextColumn_td_2_Template, "CdkTextColumn_td_2_Template");
...
__name(_CdkCellDef, "CdkCellDef");
__publicField(_CdkCellDef, "ɵfac", /* @__PURE__ */ __name(function CdkCellDef_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkCellDef)();
}, "CdkCellDef_Factory"));
__publicField(_CdkCellDef, "ɵdir", ɵɵdefineDirective({
  type: _CdkCellDef,
...
__name(_CdkHeaderCellDef, "CdkHeaderCellDef");
__publicField(_CdkHeaderCellDef, "ɵfac", /* @__PURE__ */ __name(function CdkHeaderCellDef_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkHeaderCellDef)();
}, "CdkHeaderCellDef_Factory"));
__publicField(_CdkHeaderCellDef, "ɵdir", ɵɵdefineDirective({
...
__name(_CdkFooterCellDef, "CdkFooterCellDef");
__publicField(_CdkFooterCellDef, "ɵfac", /* @__PURE__ */ __name(function CdkFooterCellDef_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkFooterCellDef)();
}, "CdkFooterCellDef_Factory"));
__publicField(_CdkFooterCellDef, "ɵdir", ɵɵdefineDirective({
...
__name(_CdkColumnDef, "CdkColumnDef");
__publicField(_CdkColumnDef, "ɵfac", /* @__PURE__ */ __name(function CdkColumnDef_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkColumnDef)();
}, "CdkColumnDef_Factory"));
__publicField(_CdkColumnDef, "ɵdir", ɵɵdefineDirective({
  type: _CdkColumnDef,
  selectors: [["", "cdkColumnDef", ""]],
  contentQueries: /* @__PURE__ */ __name(function CdkColumnDef_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
...
var _BaseCdkCell = class _BaseCdkCell {
  constructor(columnDef, elementRef) {
    elementRef.nativeElement.classList.add(...columnDef._columnCssClassName);
  }
};
__name(_BaseCdkCell, "BaseCdkCell");
var BaseCdkCell = _BaseCdkCell;
var _CdkHeaderCell = class _CdkHeaderCell extends BaseCdkCell {
  constructor() {
    super(inject(CdkColumnDef), inject(ElementRef));
  }
};
__name(_CdkHeaderCell, "CdkHeaderCell");
__publicField(_CdkHeaderCell, "ɵfac", /* @__PURE__ */ __name(function CdkHeaderCell_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkHeaderCell)();
}, "CdkHeaderCell_Factory"));
__publicField(_CdkHeaderCell, "ɵdir", ɵɵdefineDirective({
  type: _CdkHeaderCell,
...
__name(_CdkFooterCell, "CdkFooterCell");
__publicField(_CdkFooterCell, "ɵfac", /* @__PURE__ */ __name(function CdkFooterCell_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkFooterCell)();
}, "CdkFooterCell_Factory"));
__publicField(_CdkFooterCell, "ɵdir", ɵɵdefineDirective({
  type: _CdkFooterCell,
...
__name(_CdkCell, "CdkCell");
__publicField(_CdkCell, "ɵfac", /* @__PURE__ */ __name(function CdkCell_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkCell)();
}, "CdkCell_Factory"));
__publicField(_CdkCell, "ɵdir", ɵɵdefineDirective({
  type: _CdkCell,
...
__name(_BaseRowDef, "BaseRowDef");
__publicField(_BaseRowDef, "ɵfac", /* @__PURE__ */ __name(function BaseRowDef_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _BaseRowDef)();
}, "BaseRowDef_Factory"));
__publicField(_BaseRowDef, "ɵdir", ɵɵdefineDirective({
  type: _BaseRowDef,
...
__name(_CdkHeaderRowDef, "CdkHeaderRowDef");
__publicField(_CdkHeaderRowDef, "ɵfac", /* @__PURE__ */ __name(function CdkHeaderRowDef_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkHeaderRowDef)();
}, "CdkHeaderRowDef_Factory"));
__publicField(_CdkHeaderRowDef, "ɵdir", ɵɵdefineDirective({
...
__name(_CdkFooterRowDef, "CdkFooterRowDef");
__publicField(_CdkFooterRowDef, "ɵfac", /* @__PURE__ */ __name(function CdkFooterRowDef_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkFooterRowDef)();
}, "CdkFooterRowDef_Factory"));
__publicField(_CdkFooterRowDef, "ɵdir", ɵɵdefineDirective({
...
__name(_CdkRowDef, "CdkRowDef");
__publicField(_CdkRowDef, "ɵfac", /* @__PURE__ */ __name(function CdkRowDef_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkRowDef)();
}, "CdkRowDef_Factory"));
__publicField(_CdkRowDef, "ɵdir", ɵɵdefineDirective({
  type: _CdkRowDef,
  selectors: [["", "cdkRowDef", ""]],
  inputs: {
...
__name(_CdkCellOutlet, "CdkCellOutlet");
/**
 ...
 */
__publicField(_CdkCellOutlet, "mostRecentCellOutlet", null);
__publicField(_CdkCellOutlet, "ɵfac", /* @__PURE__ */ __name(function CdkCellOutlet_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkCellOutlet)();
}, "CdkCellOutlet_Factory"));
__publicField(_CdkCellOutlet, "ɵdir", ɵɵdefineDirective({
  type: _CdkCellOutlet,
...
__name(_CdkHeaderRow, "CdkHeaderRow");
__publicField(_CdkHeaderRow, "ɵfac", /* @__PURE__ */ __name(function CdkHeaderRow_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkHeaderRow)();
}, "CdkHeaderRow_Factory"));
__publicField(_CdkHeaderRow, "ɵcmp", ɵɵdefineComponent({
  type: _CdkHeaderRow,
  ...
  template: /* @__PURE__ */ __name(function CdkHeaderRow_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵelementContainer(0, 0);
    }
  }, "CdkHeaderRow_Template"),
...
__name(_CdkFooterRow, "CdkFooterRow");
__publicField(_CdkFooterRow, "ɵfac", /* @__PURE__ */ __name(function CdkFooterRow_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkFooterRow)();
}, "CdkFooterRow_Factory"));
__publicField(_CdkFooterRow, "ɵcmp", ɵɵdefineComponent({
  type: _CdkFooterRow,
  ...
  vars: 0,
  consts: [["cdkCellOutlet", ""]],
  template: /* @__PURE__ */ __name(function CdkFooterRow_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵelementContainer(0, 0);
    }
...
__name(_CdkRow, "CdkRow");
__publicField(_CdkRow, "ɵfac", /* @__PURE__ */ __name(function CdkRow_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkRow)();
}, "CdkRow_Factory"));
__publicField(_CdkRow, "ɵcmp", ɵɵdefineComponent({
  type: _CdkRow,
  ...
  vars: 0,
  consts: [["cdkCellOutlet", ""]],
  template: /* @__PURE__ */ __name(function CdkRow_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵelementContainer(0, 0);
    }
  }, "CdkRow_Template"),
...
__name(_CdkNoDataRow, "CdkNoDataRow");
__publicField(_CdkNoDataRow, "ɵfac", /* @__PURE__ */ __name(function CdkNoDataRow_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkNoDataRow)();
}, "CdkNoDataRow_Factory"));
__publicField(_CdkNoDataRow, "ɵdir", ɵɵdefineDirective({
  type: _CdkNoDataRow,
...
var _StickyStyler = class _StickyStyler {
  _isNativeHtmlTable;
  _stickCellCss;
  _isBrowser;
...
__name(_StickyStyler, "StickyStyler");
var StickyStyler = _StickyStyler;
function isCell(element) {
  return ["cdk-cell", "cdk-header-cell", "cdk-footer-cell"].some((klass) => element.classList.contains(klass));
}
__name(isCell, "isCell");
function getTableUnknownColumnError(id) {
  return Error(`Could not find column with id "${id}".`);
}
__name(getTableUnknownColumnError, "getTableUnknownColumnError");
function getTableDuplicateColumnNameError(name) {
  return Error(`Duplicate column definition name provided: "${name}".`);
}
__name(getTableDuplicateColumnNameError, "getTableDuplicateColumnNameError");
function getTableMultipleDefaultRowDefsError() {
  return Error(`There can only be one default row without a when predicate function. Or set \`multiTemplateDataRows\`.`);
}
__name(getTableMultipleDefaultRowDefsError, "getTableMultipleDefaultRowDefsError");
function getTableMissingMatchingRowDefError(data) {
  return Error(`Could not find a matching row definition for the provided row data: ${JSON.stringify(data)}`);
}
__name(getTableMissingMatchingRowDefError, "getTableMissingMatchingRowDefError");
function getTableMissingRowDefsError() {
  return Error("Missing definitions for header, footer, and row; cannot determine which columns should be rendered.");
}
__name(getTableMissingRowDefsError, "getTableMissingRowDefsError");
function getTableUnknownDataSourceError() {
  return Error(`Provided data source did not match an array, Observable, or DataSource`);
}
__name(getTableUnknownDataSourceError, "getTableUnknownDataSourceError");
function getTableTextColumnMissingParentTableError() {
  return Error(`Text column could not find a parent table for registration.`);
}
__name(getTableTextColumnMissingParentTableError, "getTableTextColumnMissingParentTableError");
function getTableTextColumnMissingNameError() {
  return Error(`Table text column must have a name.`);
}
__name(getTableTextColumnMissingNameError, "getTableTextColumnMissingNameError");
var STICKY_POSITIONING_LISTENER = new InjectionToken("CDK_SPL");
var _CdkRecycleRows = class _CdkRecycleRows {
};
__name(_CdkRecycleRows, "CdkRecycleRows");
__publicField(_CdkRecycleRows, "ɵfac", /* @__PURE__ */ __name(function CdkRecycleRows_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkRecycleRows)();
}, "CdkRecycleRows_Factory"));
__publicField(_CdkRecycleRows, "ɵdir", ɵɵdefineDirective({
...
__name(_DataRowOutlet, "DataRowOutlet");
__publicField(_DataRowOutlet, "ɵfac", /* @__PURE__ */ __name(function DataRowOutlet_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _DataRowOutlet)();
}, "DataRowOutlet_Factory"));
__publicField(_DataRowOutlet, "ɵdir", ɵɵdefineDirective({
  type: _DataRowOutlet,
  selectors: [["", "rowOutlet", ""]]
}));
...
__name(_HeaderRowOutlet, "HeaderRowOutlet");
__publicField(_HeaderRowOutlet, "ɵfac", /* @__PURE__ */ __name(function HeaderRowOutlet_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _HeaderRowOutlet)();
}, "HeaderRowOutlet_Factory"));
__publicField(_HeaderRowOutlet, "ɵdir", ɵɵdefineDirective({
...
__name(_FooterRowOutlet, "FooterRowOutlet");
__publicField(_FooterRowOutlet, "ɵfac", /* @__PURE__ */ __name(function FooterRowOutlet_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _FooterRowOutlet)();
}, "FooterRowOutlet_Factory"));
__publicField(_FooterRowOutlet, "ɵdir", ɵɵdefineDirective({
...
__name(_NoDataRowOutlet, "NoDataRowOutlet");
__publicField(_NoDataRowOutlet, "ɵfac", /* @__PURE__ */ __name(function NoDataRowOutlet_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NoDataRowOutlet)();
}, "NoDataRowOutlet_Factory"));
__publicField(_NoDataRowOutlet, "ɵdir", ɵɵdefineDirective({
...
var _CdkTable = class _CdkTable {
  ...
  _renderUpdatedColumns() {
    const columnsDiffReducer = /* @__PURE__ */ __name((acc, def) => {
   ...
   */
  _checkStickyStates() {
    const stickyCheckReducer = /* @__PURE__ */ __name((acc, d) => {
...
__name(_CdkTable, "CdkTable");
__publicField(_CdkTable, "ɵfac", /* @__PURE__ */ __name(function CdkTable_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkTable)();
}, "CdkTable_Factory"));
__publicField(_CdkTable, "ɵcmp", ɵɵdefineComponent({
  type: _CdkTable,
  selectors: [["cdk-table"], ["table", "cdk-table", ""]],
  contentQueries: /* @__PURE__ */ __name(function CdkTable_ContentQueries(rf, ctx, dirIndex) {
    if (rf & 1) {
  ...
  }, "CdkTable_ContentQueries"),
  hostAttrs: [1, "cdk-table"],
  hostVars: 2,
  hostBindings: /* @__PURE__ */ __name(function CdkTable_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵclassProp("cdk-table-fixed-layout", ctx.fixedLayout);
    }
  }, "CdkTable_HostBindings"),
  inputs: {
    trackBy: "trackBy",
  ...
  template: /* @__PURE__ */ __name(function CdkTable_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵprojectionDef(_c0);
      ɵɵprojection(0);
      ɵɵprojection(1, 1);
...
__name(mergeArrayAndSet, "mergeArrayAndSet");
...
__name(closestTableSection, "closestTableSection");
...
__name(_CdkTextColumn, "CdkTextColumn");
__publicField(_CdkTextColumn, "ɵfac", /* @__PURE__ */ __name(function CdkTextColumn_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkTextColumn)();
}, "CdkTextColumn_Factory"));
__publicField(_CdkTextColumn, "ɵcmp", ɵɵdefineComponent({
  type: _CdkTextColumn,
  selectors: [["cdk-text-column"]],
  viewQuery: /* @__PURE__ */ __name(function CdkTextColumn_Query(rf, ctx) {
    if (rf & 1) {
...
__name(_CdkTableModule, "CdkTableModule");
__publicField(_CdkTableModule, "ɵfac", /* @__PURE__ */ __name(function CdkTableModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _CdkTableModule)();
}, "CdkTableModule_Factory"));
__publicField(_CdkTableModule, "ɵmod", ɵɵdefineNgModule({
...
__publicField(_CdkTableModule, "ɵinj", ɵɵdefineInjector({
...
__name(MatTable_Conditional_2_Template, "MatTable_Conditional_2_Template");
...
__name(MatTable_Conditional_3_Template, "MatTable_Conditional_3_Template");
function MatTable_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    ɵɵelementContainer(0, 1)(1, 3)(2, 4)(3, 5);
  }
}
__name(MatTable_Conditional_4_Template, "MatTable_Conditional_4_Template");
...
__name(MatTextColumn_th_1_Template, "MatTextColumn_th_1_Template");
...
__name(MatTextColumn_td_2_Template, "MatTextColumn_td_2_Template");
var _MatRecycleRows = class _MatRecycleRows {
};
__name(_MatRecycleRows, "MatRecycleRows");
__publicField(_MatRecycleRows, "ɵfac", /* @__PURE__ */ __name(function MatRecycleRows_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatRecycleRows)();
}, "MatRecycleRows_Factory"));
__publicField(_MatRecycleRows, "ɵdir", ɵɵdefineDirective({
...
__name(_MatTable, "MatTable");
__publicField(_MatTable, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatTable_BaseFactory;
  return /* @__PURE__ */ __name(function MatTable_Factory(__ngFactoryType__) {
    return (ɵMatTable_BaseFactory || (ɵMatTable_BaseFactory = ɵɵgetInheritedFactory(_MatTable)))(__ngFactoryType__ || _MatTable);
  }, "MatTable_Factory");
})());
__publicField(_MatTable, "ɵcmp", ɵɵdefineComponent({
  type: _MatTable,
  selectors: [["mat-table"], ["table", "mat-table", ""]],
  hostAttrs: [1, "mat-mdc-table", "mdc-data-table__table"],
  hostVars: 2,
  hostBindings: /* @__PURE__ */ __name(function MatTable_HostBindings(rf, ctx) {
    if (rf & 2) {
      ɵɵclassProp("mdc-table-fixed-layout", ctx.fixedLayout);
    }
  }, "MatTable_HostBindings"),
  exportAs: ["matTable"],
  features: [ɵɵProvidersFeature([
    {
      provide: CdkTable,
  ...
  template: /* @__PURE__ */ __name(function MatTable_Template(rf, ctx) {
    if (rf & 1) {
...
__name(_MatCellDef, "MatCellDef");
__publicField(_MatCellDef, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatCellDef_BaseFactory;
  return /* @__PURE__ */ __name(function MatCellDef_Factory(__ngFactoryType__) {
    return (ɵMatCellDef_BaseFactory || (ɵMatCellDef_BaseFactory = ɵɵgetInheritedFactory(_MatCellDef)))(__ngFactoryType__ || _MatCellDef);
  }, "MatCellDef_Factory");
})());
__publicField(_MatCellDef, "ɵdir", ɵɵdefineDirective({
  type: _MatCellDef,
...
__name(_MatHeaderCellDef, "MatHeaderCellDef");
__publicField(_MatHeaderCellDef, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatHeaderCellDef_BaseFactory;
  return /* @__PURE__ */ __name(function MatHeaderCellDef_Factory(__ngFactoryType__) {
  ...
  }, "MatHeaderCellDef_Factory");
})());
__publicField(_MatHeaderCellDef, "ɵdir", ɵɵdefineDirective({
...
__name(_MatFooterCellDef, "MatFooterCellDef");
__publicField(_MatFooterCellDef, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatFooterCellDef_BaseFactory;
  return /* @__PURE__ */ __name(function MatFooterCellDef_Factory(__ngFactoryType__) {
  ...
  }, "MatFooterCellDef_Factory");
})());
__publicField(_MatFooterCellDef, "ɵdir", ɵɵdefineDirective({
...
__name(_MatColumnDef, "MatColumnDef");
__publicField(_MatColumnDef, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatColumnDef_BaseFactory;
  return /* @__PURE__ */ __name(function MatColumnDef_Factory(__ngFactoryType__) {
  ...
  }, "MatColumnDef_Factory");
})());
__publicField(_MatColumnDef, "ɵdir", ɵɵdefineDirective({
  type: _MatColumnDef,
...
__name(_MatHeaderCell, "MatHeaderCell");
__publicField(_MatHeaderCell, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatHeaderCell_BaseFactory;
  return /* @__PURE__ */ __name(function MatHeaderCell_Factory(__ngFactoryType__) {
  ...
  }, "MatHeaderCell_Factory");
})());
__publicField(_MatHeaderCell, "ɵdir", ɵɵdefineDirective({
  type: _MatHeaderCell,
...
__name(_MatFooterCell, "MatFooterCell");
__publicField(_MatFooterCell, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatFooterCell_BaseFactory;
  return /* @__PURE__ */ __name(function MatFooterCell_Factory(__ngFactoryType__) {
  ...
  }, "MatFooterCell_Factory");
})());
__publicField(_MatFooterCell, "ɵdir", ɵɵdefineDirective({
  type: _MatFooterCell,
...
__name(_MatCell, "MatCell");
__publicField(_MatCell, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatCell_BaseFactory;
  return /* @__PURE__ */ __name(function MatCell_Factory(__ngFactoryType__) {
    return (ɵMatCell_BaseFactory || (ɵMatCell_BaseFactory = ɵɵgetInheritedFactory(_MatCell)))(__ngFactoryType__ || _MatCell);
  }, "MatCell_Factory");
})());
__publicField(_MatCell, "ɵdir", ɵɵdefineDirective({
  type: _MatCell,
...
__name(_MatHeaderRowDef, "MatHeaderRowDef");
__publicField(_MatHeaderRowDef, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatHeaderRowDef_BaseFactory;
  return /* @__PURE__ */ __name(function MatHeaderRowDef_Factory(__ngFactoryType__) {
  ...
  }, "MatHeaderRowDef_Factory");
})());
__publicField(_MatHeaderRowDef, "ɵdir", ɵɵdefineDirective({
...
__name(_MatFooterRowDef, "MatFooterRowDef");
__publicField(_MatFooterRowDef, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatFooterRowDef_BaseFactory;
  return /* @__PURE__ */ __name(function MatFooterRowDef_Factory(__ngFactoryType__) {
  ...
  }, "MatFooterRowDef_Factory");
})());
__publicField(_MatFooterRowDef, "ɵdir", ɵɵdefineDirective({
...
__name(_MatRowDef, "MatRowDef");
__publicField(_MatRowDef, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatRowDef_BaseFactory;
  return /* @__PURE__ */ __name(function MatRowDef_Factory(__ngFactoryType__) {
    return (ɵMatRowDef_BaseFactory || (ɵMatRowDef_BaseFactory = ɵɵgetInheritedFactory(_MatRowDef)))(__ngFactoryType__ || _MatRowDef);
  }, "MatRowDef_Factory");
})());
__publicField(_MatRowDef, "ɵdir", ɵɵdefineDirective({
  type: _MatRowDef,
  selectors: [["", "matRowDef", ""]],
  inputs: {
...
__name(_MatHeaderRow, "MatHeaderRow");
__publicField(_MatHeaderRow, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatHeaderRow_BaseFactory;
  return /* @__PURE__ */ __name(function MatHeaderRow_Factory(__ngFactoryType__) {
  ...
  }, "MatHeaderRow_Factory");
})());
__publicField(_MatHeaderRow, "ɵcmp", ɵɵdefineComponent({
  type: _MatHeaderRow,
  ...
  vars: 0,
  consts: [["cdkCellOutlet", ""]],
  template: /* @__PURE__ */ __name(function MatHeaderRow_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵelementContainer(0, 0);
    }
  }, "MatHeaderRow_Template"),
  dependencies: [CdkCellOutlet],
  encapsulation: 2
}));
...
__name(_MatFooterRow, "MatFooterRow");
__publicField(_MatFooterRow, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatFooterRow_BaseFactory;
  return /* @__PURE__ */ __name(function MatFooterRow_Factory(__ngFactoryType__) {
...
__publicField(_MatFooterRow, "ɵcmp", ɵɵdefineComponent({
  type: _MatFooterRow,
  ...
  vars: 0,
  consts: [["cdkCellOutlet", ""]],
  template: /* @__PURE__ */ __name(function MatFooterRow_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵelementContainer(0, 0);
    }
  }, "MatFooterRow_Template"),
  dependencies: [CdkCellOutlet],
  encapsulation: 2
}));
...
__name(_MatRow, "MatRow");
__publicField(_MatRow, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatRow_BaseFactory;
  return /* @__PURE__ */ __name(function MatRow_Factory(__ngFactoryType__) {
    return (ɵMatRow_BaseFactory || (ɵMatRow_BaseFactory = ɵɵgetInheritedFactory(_MatRow)))(__ngFactoryType__ || _MatRow);
  }, "MatRow_Factory");
})());
__publicField(_MatRow, "ɵcmp", ɵɵdefineComponent({
  type: _MatRow,
  ...
  vars: 0,
  consts: [["cdkCellOutlet", ""]],
  template: /* @__PURE__ */ __name(function MatRow_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵelementContainer(0, 0);
    }
  }, "MatRow_Template"),
...
__name(_MatNoDataRow, "MatNoDataRow");
__publicField(_MatNoDataRow, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatNoDataRow_BaseFactory;
  return /* @__PURE__ */ __name(function MatNoDataRow_Factory(__ngFactoryType__) {
  ...
  }, "MatNoDataRow_Factory");
})());
__publicField(_MatNoDataRow, "ɵdir", ɵɵdefineDirective({
  type: _MatNoDataRow,
...
__name(_MatTextColumn, "MatTextColumn");
__publicField(_MatTextColumn, "ɵfac", /* @__PURE__ */ (() => {
  let ɵMatTextColumn_BaseFactory;
  return /* @__PURE__ */ __name(function MatTextColumn_Factory(__ngFactoryType__) {
  ...
  }, "MatTextColumn_Factory");
})());
__publicField(_MatTextColumn, "ɵcmp", ɵɵdefineComponent({
  type: _MatTextColumn,
...
__name(_MatTableModule, "MatTableModule");
__publicField(_MatTableModule, "ɵfac", /* @__PURE__ */ __name(function MatTableModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _MatTableModule)();
}, "MatTableModule_Factory"));
__publicField(_MatTableModule, "ɵmod", ɵɵdefineNgModule({
...
__publicField(_MatTableModule, "ɵinj", ɵɵdefineInjector({
...
var _MatTableDataSource = class _MatTableDataSource extends DataSource {
   ...
   */
  sortingDataAccessor = /* @__PURE__ */ __name((data, sortHeaderId) => {
   ...
   */
  sortData = /* @__PURE__ */ __name((data, sort) => {
   ...
   */
  filterPredicate = /* @__PURE__ */ __name((data, filter) => {
...
__name(_MatTableDataSource, "MatTableDataSource");
var MatTableDataSource = _MatTableDataSource;
export {
  MatCell,
  MatCellDef,
  MatColumnDef,
