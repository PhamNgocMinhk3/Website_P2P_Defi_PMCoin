...
var DevicePixelContentBoxBinding = (
  ...
  (function() {
    ...
    __name(DevicePixelContentBoxBinding2, "DevicePixelContentBoxBinding");
...
var CanvasRenderingTarget2D = (
  ...
  (function() {
    ...
    __name(CanvasRenderingTarget2D2, "CanvasRenderingTarget2D");
...
__name(setLineStyle, "setLineStyle");
...
__name(drawHorizontalLine, "drawHorizontalLine");
...
__name(strokeInPixel, "strokeInPixel");
...
__name(ensureNotNull, "ensureNotNull");
...
__name(notNull, "notNull");
function undefinedIfNull(t) {
  return t === null ? void 0 : t;
}
__name(undefinedIfNull, "undefinedIfNull");
...
var _PriceAxisRendererOptionsProvider = class _PriceAxisRendererOptionsProvider {
...
__name(_PriceAxisRendererOptionsProvider, "PriceAxisRendererOptionsProvider");
var PriceAxisRendererOptionsProvider = _PriceAxisRendererOptionsProvider;
...
__name(normalizeRgbComponent, "normalizeRgbComponent");
...
__name(normalizeAlphaComponent, "normalizeAlphaComponent");
...
__name(rgbaToGrayscale, "rgbaToGrayscale");
...
__name(getRgbStringViaBrowser, "getRgbStringViaBrowser");
var _ColorParser = class _ColorParser {
...
__name(_ColorParser, "ColorParser");
var ColorParser = _ColorParser;
var _CompositeRenderer = class _CompositeRenderer {
  constructor() {
...
__name(_CompositeRenderer, "CompositeRenderer");
var CompositeRenderer = _CompositeRenderer;
var _BitmapCoordinatesPaneRenderer = class _BitmapCoordinatesPaneRenderer {
  _internal_draw(target, isHovered, hitTestData) {
    target.useBitmapCoordinateSpace((scope) => this._internal__drawImpl(scope, isHovered, hitTestData));
  }
};
__name(_BitmapCoordinatesPaneRenderer, "BitmapCoordinatesPaneRenderer");
var BitmapCoordinatesPaneRenderer = _BitmapCoordinatesPaneRenderer;
var _PaneRendererMarks = class _PaneRendererMarks extends BitmapCoordinatesPaneRenderer {
  constructor() {
    super(...arguments);
  ...
  _internal__drawImpl({ context: ctx, horizontalPixelRatio, verticalPixelRatio }) {
    ...
    const draw = /* @__PURE__ */ __name((radiusMedia) => {
      ctx.beginPath();
...
__name(_PaneRendererMarks, "PaneRendererMarks");
var PaneRendererMarks = _PaneRendererMarks;
...
__name(createEmptyMarkerData, "createEmptyMarkerData");
var rangeForSinglePoint = { from: 0, to: 1 };
var _CrosshairMarksPaneView = class _CrosshairMarksPaneView {
...
__name(_CrosshairMarksPaneView, "CrosshairMarksPaneView");
var CrosshairMarksPaneView = _CrosshairMarksPaneView;
var _CrosshairRenderer = class _CrosshairRenderer extends BitmapCoordinatesPaneRenderer {
  constructor(data) {
    super();
...
__name(_CrosshairRenderer, "CrosshairRenderer");
var CrosshairRenderer = _CrosshairRenderer;
var _CrosshairPaneView = class _CrosshairPaneView {
...
__name(_CrosshairPaneView, "CrosshairPaneView");
var CrosshairPaneView = _CrosshairPaneView;
...
__name(fillRectInnerBorder, "fillRectInnerBorder");
...
__name(changeBorderRadius, "changeBorderRadius");
...
__name(drawRoundRectWithBorder, "drawRoundRectWithBorder");
...
__name(clearRectWithGradient, "clearRectWithGradient");
var _PriceAxisViewRenderer = class _PriceAxisViewRenderer {
...
__name(_PriceAxisViewRenderer, "PriceAxisViewRenderer");
var PriceAxisViewRenderer = _PriceAxisViewRenderer;
var _PriceAxisView = class _PriceAxisView {
  constructor(ctor) {
...
__name(_PriceAxisView, "PriceAxisView");
var PriceAxisView = _PriceAxisView;
var _CrosshairPriceAxisView = class _CrosshairPriceAxisView extends PriceAxisView {
...
__name(_CrosshairPriceAxisView, "CrosshairPriceAxisView");
var CrosshairPriceAxisView = _CrosshairPriceAxisView;
var optimizationReplacementRe = /[1-9]/g;
var radius$1 = 2;
var _TimeAxisViewRenderer = class _TimeAxisViewRenderer {
  constructor() {
...
__name(_TimeAxisViewRenderer, "TimeAxisViewRenderer");
var TimeAxisViewRenderer = _TimeAxisViewRenderer;
var _CrosshairTimeAxisView = class _CrosshairTimeAxisView {
...
__name(_CrosshairTimeAxisView, "CrosshairTimeAxisView");
var CrosshairTimeAxisView = _CrosshairTimeAxisView;
...
var _Crosshair = class _Crosshair extends DataSource {
  constructor(model, options) {
    ...
    const valuePriceProvider = /* @__PURE__ */ __name((rawPriceProvider, rawCoordinateProvider) => {
      return (priceScale) => {
    ...
    const valueTimeProvider = /* @__PURE__ */ __name((rawIndexProvider, rawCoordinateProvider) => {
      return () => {
...
__name(mergePaneInvalidation, "mergePaneInvalidation");
var _InvalidateMask = class _InvalidateMask {
...
__name(_InvalidateMask, "InvalidateMask");
var InvalidateMask = _InvalidateMask;
var _FormatterBase = class _FormatterBase {
  formatTickmarks(prices) {
    return prices.map((price) => this.format(price));
  }
};
__name(_FormatterBase, "FormatterBase");
var FormatterBase = _FormatterBase;
...
__name(numberToStringWithLeadingZero, "numberToStringWithLeadingZero");
var _PriceFormatter = class _PriceFormatter extends FormatterBase {
...
__name(_PriceFormatter, "PriceFormatter");
var PriceFormatter = _PriceFormatter;
var _PercentageFormatter = class _PercentageFormatter extends PriceFormatter {
...
__name(_PercentageFormatter, "PercentageFormatter");
var PercentageFormatter = _PercentageFormatter;
var _VolumeFormatter = class _VolumeFormatter extends FormatterBase {
...
__name(_VolumeFormatter, "VolumeFormatter");
var VolumeFormatter = _VolumeFormatter;
var defaultReplacementRe = /[2-9]/g;
var _TextWidthCache = class _TextWidthCache {
...
__name(_TextWidthCache, "TextWidthCache");
var TextWidthCache = _TextWidthCache;
var _PanePriceAxisViewRenderer = class _PanePriceAxisViewRenderer {
...
__name(_PanePriceAxisViewRenderer, "PanePriceAxisViewRenderer");
var PanePriceAxisViewRenderer = _PanePriceAxisViewRenderer;
var _PanePriceAxisView = class _PanePriceAxisView {
...
__name(_PanePriceAxisView, "PanePriceAxisView");
var PanePriceAxisView = _PanePriceAxisView;
var _HorizontalLineRenderer = class _HorizontalLineRenderer extends BitmapCoordinatesPaneRenderer {
  constructor() {
    super(...arguments);
    this._private__data = null;
  }
...
__name(_HorizontalLineRenderer, "HorizontalLineRenderer");
var HorizontalLineRenderer = _HorizontalLineRenderer;
var _SeriesHorizontalLinePaneView = class _SeriesHorizontalLinePaneView {
  constructor(series) {
...
__name(_SeriesHorizontalLinePaneView, "SeriesHorizontalLinePaneView");
var SeriesHorizontalLinePaneView = _SeriesHorizontalLinePaneView;
var _SeriesHorizontalBaseLinePaneView = class _SeriesHorizontalBaseLinePaneView extends SeriesHorizontalLinePaneView {
...
__name(_SeriesHorizontalBaseLinePaneView, "SeriesHorizontalBaseLinePaneView");
var SeriesHorizontalBaseLinePaneView = _SeriesHorizontalBaseLinePaneView;
var _SeriesLastPriceAnimationRenderer = class _SeriesLastPriceAnimationRenderer extends BitmapCoordinatesPaneRenderer {
  constructor() {
    super(...arguments);
    this._private__data = null;
  }
...
__name(_SeriesLastPriceAnimationRenderer, "SeriesLastPriceAnimationRenderer");
var SeriesLastPriceAnimationRenderer = _SeriesLastPriceAnimationRenderer;
...
__name(radius, "radius");
var _SeriesLastPriceAnimationPaneView = class _SeriesLastPriceAnimationPaneView {
  constructor(series) {
...
__name(_SeriesLastPriceAnimationPaneView, "SeriesLastPriceAnimationPaneView");
var SeriesLastPriceAnimationPaneView = _SeriesLastPriceAnimationPaneView;
var _SeriesPriceLinePaneView = class _SeriesPriceLinePaneView extends SeriesHorizontalLinePaneView {
  // eslint-disable-next-line no-useless-constructor
  constructor(series) {
    super(series);
  }
...
__name(_SeriesPriceLinePaneView, "SeriesPriceLinePaneView");
var SeriesPriceLinePaneView = _SeriesPriceLinePaneView;
var _SeriesPriceAxisView = class _SeriesPriceAxisView extends PriceAxisView {
  constructor(source) {
    super();
    this._private__source = source;
  }
...
__name(_SeriesPriceAxisView, "SeriesPriceAxisView");
var SeriesPriceAxisView = _SeriesPriceAxisView;
...
__name(computeFiniteResult, "computeFiniteResult");
var _PriceRangeImpl = class _PriceRangeImpl {
...
__name(_PriceRangeImpl, "PriceRangeImpl");
var PriceRangeImpl = _PriceRangeImpl;
var _AutoscaleInfoImpl = class _AutoscaleInfoImpl {
...
__name(_AutoscaleInfoImpl, "AutoscaleInfoImpl");
var AutoscaleInfoImpl = _AutoscaleInfoImpl;
var _CustomPriceLinePaneView = class _CustomPriceLinePaneView extends SeriesHorizontalLinePaneView {
...
__name(_CustomPriceLinePaneView, "CustomPriceLinePaneView");
var CustomPriceLinePaneView = _CustomPriceLinePaneView;
var _CustomPriceLinePriceAxisView = class _CustomPriceLinePriceAxisView extends PriceAxisView {
  constructor(series, priceLine) {
    super();
    this._private__series = series;
    this._private__priceLine = priceLine;
...
__name(_CustomPriceLinePriceAxisView, "CustomPriceLinePriceAxisView");
var CustomPriceLinePriceAxisView = _CustomPriceLinePriceAxisView;
var _CustomPriceLine = class _CustomPriceLine {
...
__name(_CustomPriceLine, "CustomPriceLine");
var CustomPriceLine = _CustomPriceLine;
var _PriceDataSource = class _PriceDataSource extends DataSource {
  constructor(model) {
    super();
    this._private__model = model;
  }
...
__name(_PriceDataSource, "PriceDataSource");
var PriceDataSource = _PriceDataSource;
var barStyleFnMap = {
  // eslint-disable-next-line @typescript-eslint/naming-convention
  Bar: /* @__PURE__ */ __name((findBar, barStyle, barIndex, precomputedBars) => {
  ...
  // eslint-disable-next-line @typescript-eslint/naming-convention
  Candlestick: /* @__PURE__ */ __name((findBar, candlestickStyle, barIndex, precomputedBars) => {
  ...
  // eslint-disable-next-line @typescript-eslint/naming-convention
  Custom: /* @__PURE__ */ __name((findBar, customStyle, barIndex, precomputedBars) => {
    const currentBar = ensureNotNull(findBar(barIndex, precomputedBars));
    return {
  ...
  // eslint-disable-next-line @typescript-eslint/naming-convention
  Area: /* @__PURE__ */ __name((findBar, areaStyle, barIndex, precomputedBars) => {
    const currentBar = ensureNotNull(findBar(barIndex, precomputedBars));
    return {
  ...
  // eslint-disable-next-line @typescript-eslint/naming-convention
  Baseline: /* @__PURE__ */ __name((findBar, baselineStyle, barIndex, precomputedBars) => {
    const currentBar = ensureNotNull(findBar(barIndex, precomputedBars));
  ...
  // eslint-disable-next-line @typescript-eslint/naming-convention
  Line: /* @__PURE__ */ __name((findBar, lineStyle, barIndex, precomputedBars) => {
    const currentBar = ensureNotNull(findBar(barIndex, precomputedBars));
    return {
  ...
  // eslint-disable-next-line @typescript-eslint/naming-convention
  Histogram: /* @__PURE__ */ __name((findBar, histogramStyle, barIndex, precomputedBars) => {
    const currentBar = ensureNotNull(findBar(barIndex, precomputedBars));
    return {
...
var _SeriesBarColorer = class _SeriesBarColorer {
  constructor(series) {
...
__name(_SeriesBarColorer, "SeriesBarColorer");
var SeriesBarColorer = _SeriesBarColorer;
...
__name(boundCompare, "boundCompare");
...
var _PlotList = class _PlotList {
  ...
  _internal_search(index, searchMode = 0) {
    ...
    return __spreadProps(__spreadValues({}, this._private__valueAt(pos)), {
...
__name(_PlotList, "PlotList");
var PlotList = _PlotList;
...
__name(mergeMinMax, "mergeMinMax");
function createSeriesPlotList() {
  return new PlotList();
}
__name(createSeriesPlotList, "createSeriesPlotList");
var _PrimitiveRendererWrapper = class _PrimitiveRendererWrapper {
...
__name(_PrimitiveRendererWrapper, "PrimitiveRendererWrapper");
var PrimitiveRendererWrapper = _PrimitiveRendererWrapper;
var _PrimitivePaneViewWrapper = class _PrimitivePaneViewWrapper {
...
__name(_PrimitivePaneViewWrapper, "PrimitivePaneViewWrapper");
var PrimitivePaneViewWrapper = _PrimitivePaneViewWrapper;
var _PrimitiveWrapper = class _PrimitiveWrapper {
...
__name(_PrimitiveWrapper, "PrimitiveWrapper");
var PrimitiveWrapper = _PrimitiveWrapper;
var _a;
var PanePrimitiveWrapper$1 = (_a = class extends PrimitiveWrapper {
  _internal_labelPaneViews() {
    return [];
  }
}, __name(_a, "PanePrimitiveWrapper"), _a);
var _SeriesPrimitiveRendererWrapper = class _SeriesPrimitiveRendererWrapper {
  constructor(baseRenderer) {
    this._private__baseRenderer = baseRenderer;
  }
  _internal_draw(target, isHovered, hitTestData) {
...
__name(_SeriesPrimitiveRendererWrapper, "SeriesPrimitiveRendererWrapper");
var SeriesPrimitiveRendererWrapper = _SeriesPrimitiveRendererWrapper;
var _SeriesPrimitivePaneViewWrapper = class _SeriesPrimitivePaneViewWrapper {
  constructor(paneView) {
    this._private__cache = null;
    this._private__paneView = paneView;
  }
...
__name(_SeriesPrimitivePaneViewWrapper, "SeriesPrimitivePaneViewWrapper");
var SeriesPrimitivePaneViewWrapper = _SeriesPrimitivePaneViewWrapper;
...
__name(getAxisViewData, "getAxisViewData");
var _SeriesPrimitiveTimeAxisViewWrapper = class _SeriesPrimitiveTimeAxisViewWrapper {
  ...
  _internal_renderer() {
    this._private__renderer._internal_setData(__spreadValues({
      _internal_width: this._private__timeScale._internal_width()
    }, getAxisViewData(this._private__baseView)));
    return this._private__renderer;
  }
};
__name(_SeriesPrimitiveTimeAxisViewWrapper, "SeriesPrimitiveTimeAxisViewWrapper");
var SeriesPrimitiveTimeAxisViewWrapper = _SeriesPrimitiveTimeAxisViewWrapper;
var _SeriesPrimitivePriceAxisViewWrapper = class _SeriesPrimitivePriceAxisViewWrapper extends PriceAxisView {
...
__name(_SeriesPrimitivePriceAxisViewWrapper, "SeriesPrimitivePriceAxisViewWrapper");
var SeriesPrimitivePriceAxisViewWrapper = _SeriesPrimitivePriceAxisViewWrapper;
var _SeriesPrimitiveWrapper = class _SeriesPrimitiveWrapper extends PrimitiveWrapper {
...
__name(_SeriesPrimitiveWrapper, "SeriesPrimitiveWrapper");
var SeriesPrimitiveWrapper = _SeriesPrimitiveWrapper;
...
__name(extractPrimitivePaneViews, "extractPrimitivePaneViews");
function primitivePaneViewsExtractor(wrapper) {
  return wrapper._internal_paneViews();
}
__name(primitivePaneViewsExtractor, "primitivePaneViewsExtractor");
function primitivePricePaneViewsExtractor(wrapper) {
  return wrapper._internal_priceAxisPaneViews();
}
__name(primitivePricePaneViewsExtractor, "primitivePricePaneViewsExtractor");
function primitiveTimePaneViewsExtractor(wrapper) {
  return wrapper._internal_timeAxisPaneViews();
}
__name(primitiveTimePaneViewsExtractor, "primitiveTimePaneViewsExtractor");
var lineBasedSeries = ["Area", "Line", "Baseline"];
var _Series = class _Series extends PriceDataSource {
...
__name(isBaseDecimal, "isBaseDecimal");
function greaterOrEqual(x1, x2, epsilon) {
  return x2 - x1 <= epsilon;
}
__name(greaterOrEqual, "greaterOrEqual");
...
__name(ceiledEven, "ceiledEven");
function ceiledOdd(x) {
  const ceiled = Math.ceil(x);
  return ceiled % 2 === 0 ? ceiled - 1 : ceiled;
}
__name(ceiledOdd, "ceiledOdd");
var _GridRenderer = class _GridRenderer extends BitmapCoordinatesPaneRenderer {
  constructor() {
    super(...arguments);
    this._private__data = null;
  }
...
__name(_GridRenderer, "GridRenderer");
var GridRenderer = _GridRenderer;
var _GridPaneView = class _GridPaneView {
  constructor(pane) {
...
__name(_GridPaneView, "GridPaneView");
var GridPaneView = _GridPaneView;
...
__name(fromPercent, "fromPercent");
...
__name(toPercentRange, "toPercentRange");
...
__name(toIndexedTo100Range, "toIndexedTo100Range");
...
__name(convertPriceRangeToLog, "convertPriceRangeToLog");
...
__name(canConvertPriceRangeFromLog, "canConvertPriceRangeFromLog");
...
__name(convertPriceRangeFromLog, "convertPriceRangeFromLog");
...
__name(logFormulaForPriceRange, "logFormulaForPriceRange");
...
__name(logFormulasAreSame, "logFormulasAreSame");
var _PriceTickSpanCalculator = class _PriceTickSpanCalculator {
...
__name(_PriceTickSpanCalculator, "PriceTickSpanCalculator");
var PriceTickSpanCalculator = _PriceTickSpanCalculator;
var TICK_DENSITY = 2.5;
var _PriceTickMarkBuilder = class _PriceTickMarkBuilder {
...
__name(_PriceTickMarkBuilder, "PriceTickMarkBuilder");
var PriceTickMarkBuilder = _PriceTickMarkBuilder;
...
var _PriceScale = class _PriceScale {
...
__name(_PriceScale, "PriceScale");
var PriceScale = _PriceScale;
...
var _Pane = class _Pane {
  ...
  _private__createPriceScale(id, options) {
    const actualOptions = __spreadValues({ visible: true, autoScale: true }, clone(options));
...
__name(comparePrimitiveZOrder, "comparePrimitiveZOrder");
...
__name(findBestPrimitiveHitTest, "findBestPrimitiveHitTest");
...
__name(convertPrimitiveHitResult, "convertPrimitiveHitResult");
...
__name(hitTestPaneView, "hitTestPaneView");
...
__name(hitTestPane, "hitTestPane");
var _FormattedLabelsCache = class _FormattedLabelsCache {
...
__name(_FormattedLabelsCache, "FormattedLabelsCache");
var FormattedLabelsCache = _FormattedLabelsCache;
...
var _TickMarks = class _TickMarks {
  constructor() {
  ...
  _private__buildMarksImpl(maxIndexesPerMark, checkIndicesForData, indicesWithDataMap) {
    let marks = [];
    const canBeIncluded = /* @__PURE__ */ __name((mark) => !checkIndicesForData || indicesWithDataMap.has(mark.index), "canBeIncluded");
...
__name(_TickMarks, "TickMarks");
var TickMarks = _TickMarks;
var _TimeScaleVisibleRange = class _TimeScaleVisibleRange {
...
__name(_TimeScaleVisibleRange, "TimeScaleVisibleRange");
var TimeScaleVisibleRange = _TimeScaleVisibleRange;
var defaultTickMarkMaxCharacterLength = 8;
function markWithGreaterWeight$2(a, b) {
  return a.weight > b.weight ? a : b;
}
__name(markWithGreaterWeight$2, "markWithGreaterWeight$2");
var _TimeScale = class _TimeScale {
  ...
  _internal_scrollToOffsetAnimated(offset, animationDuration = 400) {
    ...
    this._private__model._internal_setTimeScaleAnimation({
      _internal_finished: /* @__PURE__ */ __name((time) => (time - animationStart) / animationDuration >= 1, "_internal_finished"),
      _internal_getPosition: /* @__PURE__ */ __name((time) => {
...
__name(testNearestIntegers, "testNearestIntegers");
...
__name(isPanePrimitive, "isPanePrimitive");
var _ChartModel = class _ChartModel {
...
__name(_ChartModel, "ChartModel");
var ChartModel = _ChartModel;
...
__name(fillUpDownCandlesticksColors, "fillUpDownCandlesticksColors");
...
__name(precisionByMinMove, "precisionByMinMove");
var PriceLineSource;
...
__name(isBusinessDay, "isBusinessDay");
function isUTCTimestamp(time) {
  return isNumber(time);
}
__name(isUTCTimestamp, "isUTCTimestamp");
var TickMarkType;
...
var getMonth = /* @__PURE__ */ __name((date) => date.getUTCMonth() + 1, "getMonth");
var getDay = /* @__PURE__ */ __name((date) => date.getUTCDate(), "getDay");
var getYear = /* @__PURE__ */ __name((date) => date.getUTCFullYear(), "getYear");
var dd = /* @__PURE__ */ __name((date) => numberToStringWithLeadingZero(getDay(date), 2), "dd");
var MMMM = /* @__PURE__ */ __name((date, locale) => new Date(date.getUTCFullYear(), date.getUTCMonth(), 1).toLocaleString(locale, { month: "long" }), "MMMM");
var MMM = /* @__PURE__ */ __name((date, locale) => new Date(date.getUTCFullYear(), date.getUTCMonth(), 1).toLocaleString(locale, { month: "short" }), "MMM");
var MM = /* @__PURE__ */ __name((date) => numberToStringWithLeadingZero(getMonth(date), 2), "MM");
var yy = /* @__PURE__ */ __name((date) => numberToStringWithLeadingZero(getYear(date) % 100, 2), "yy");
var yyyy = /* @__PURE__ */ __name((date) => numberToStringWithLeadingZero(getYear(date), 4), "yyyy");
...
__name(_DateFormatter, "DateFormatter");
...
var _DateTimeFormatter = class _DateTimeFormatter {
  constructor(params = {}) {
    const formatterParams = __spreadValues(__spreadValues({}, defaultParams), params);
...
__name(_DateTimeFormatter, "DateTimeFormatter");
var DateTimeFormatter = _DateTimeFormatter;
...
__name(defaultTickMarkFormatter, "defaultTickMarkFormatter");
...
__name(weightByTime, "weightByTime");
function cast(t) {
  return t;
}
__name(cast, "cast");
...
__name(fillWeightsForPoints, "fillWeightsForPoints");
...
__name(businessDayConverter, "businessDayConverter");
...
__name(timestampConverter, "timestampConverter");
...
__name(selectTimeConverter, "selectTimeConverter");
...
__name(stringToBusinessDay, "stringToBusinessDay");
function convertStringToBusinessDay(value) {
  if (isString(value.time)) {
    value.time = stringToBusinessDay(value.time);
  }
}
__name(convertStringToBusinessDay, "convertStringToBusinessDay");
function convertStringsToBusinessDays(data) {
  return data.forEach(convertStringToBusinessDay);
}
__name(convertStringsToBusinessDays, "convertStringsToBusinessDays");
...
__name(weightToTickMarkType, "weightToTickMarkType");
var _HorzScaleBehaviorTime = class _HorzScaleBehaviorTime {
  options() {
    return this._private__options;
  }
  setOptions(options) {
...
__name(_HorzScaleBehaviorTime, "HorzScaleBehaviorTime");
var HorzScaleBehaviorTime = _HorzScaleBehaviorTime;
...
__name(isChromiumBased, "isChromiumBased");
function warn(msg) {
  {
    console.warn(msg);
  }
...
__name(suggestChartSize, "suggestChartSize");
function suggestTimeScaleHeight(originalHeight) {
  return originalHeight + originalHeight % 2;
}
__name(suggestTimeScaleHeight, "suggestTimeScaleHeight");
function suggestPriceScaleWidth(originalWidth) {
  return originalWidth + originalWidth % 2;
}
__name(suggestPriceScaleWidth, "suggestPriceScaleWidth");
...
__name(preventScrollByWheelClick, "preventScrollByWheelClick");
var _MouseEventHandler = class _MouseEventHandler {
  ...
  _private__init() {
    ...
    this._private__target.addEventListener("touchcancel", this._private__clearLongTapTimeout.bind(this));
    {
      ...
      const outsideHandler = /* @__PURE__ */ __name((event) => {
  ...
  _private__makeCompatEvent(event, touch) {
    ...
    return {
      ...
      _internal_preventDefault: /* @__PURE__ */ __name(() => {
...
__name(_MouseEventHandler, "MouseEventHandler");
var MouseEventHandler = _MouseEventHandler;
...
__name(eventTimeStamp, "eventTimeStamp");
...
__name(touchWithId, "touchWithId");
var _PaneSeparator = class _PaneSeparator {
  ...
  _private__addResizableHandle() {
    ...
    this._private__mouseEventHandler = new MouseEventHandler(element, handlers, {
      _internal_treatVertTouchDragAsPageScroll: /* @__PURE__ */ __name(() => false, "_internal_treatVertTouchDragAsPageScroll"),
      _internal_treatHorzTouchDragAsPageScroll: /* @__PURE__ */ __name(() => true, "_internal_treatHorzTouchDragAsPageScroll")
    });
...
__name(_PaneSeparator, "PaneSeparator");
var PaneSeparator = _PaneSeparator;
...
__name(speedPxPerMSec, "speedPxPerMSec");
...
__name(durationMSec, "durationMSec");
var _KineticAnimation = class _KineticAnimation {
...
__name(_KineticAnimation, "KineticAnimation");
var KineticAnimation = _KineticAnimation;
...
var _AttributionLogoWidget = class _AttributionLogoWidget {
...
__name(_AttributionLogoWidget, "AttributionLogoWidget");
var AttributionLogoWidget = _AttributionLogoWidget;
function createBoundCanvas(parentElement, size3) {
  ...
  const binding = bindTo(canvas, {
    ...
    transform: /* @__PURE__ */ __name((bitmapSize, canvasElementClientSize) => ({
...
__name(createBoundCanvas, "createBoundCanvas");
...
__name(drawSourceViews, "drawSourceViews");
function hasPriceScale(source) {
  return source._internal_priceScale !== void 0;
}
__name(hasPriceScale, "hasPriceScale");
...
__name(buildPriceAxisViewsGetter, "buildPriceAxisViewsGetter");
...
__name(recalculateOverlapping, "recalculateOverlapping");
...
__name(priceScaleCrosshairLabelVisible, "priceScaleCrosshairLabelVisible");
var _PriceAxisWidget = class _PriceAxisWidget {
  constructor(pane, options, rendererOptionsProvider, side) {
    ...
    this._private__mouseEventHandler = new MouseEventHandler(this._private__topCanvasBinding.canvasElement, handler, {
      _internal_treatVertTouchDragAsPageScroll: /* @__PURE__ */ __name(() => !this._private__options["handleScroll"].vertTouchDrag, "_internal_treatVertTouchDragAsPageScroll"),
      _internal_treatHorzTouchDragAsPageScroll: /* @__PURE__ */ __name(() => true, "_internal_treatHorzTouchDragAsPageScroll")
    });
  }
  _internal_destroy() {
  ...
  _private__backLabels() {
    ...
    const addViewsForSources = /* @__PURE__ */ __name((sources) => {
  ...
  _private__alignLabels() {
    ...
    const priceScale = this._private__priceScale;
    const updateForSources = /* @__PURE__ */ __name((sources) => {
...
var _PaneWidget = class _PaneWidget {
  constructor(chart, state) {
    ...
    this._private__mouseEventHandler = new MouseEventHandler(this._private__topCanvasBinding.canvasElement, this, {
      _internal_treatVertTouchDragAsPageScroll: /* @__PURE__ */ __name(() => this._private__startTrackPoint === null && !this._private__chart._internal_options()["handleScroll"].vertTouchDrag, "_internal_treatVertTouchDragAsPageScroll"),
      _internal_treatHorzTouchDragAsPageScroll: /* @__PURE__ */ __name(() => this._private__startTrackPoint === null && !this._private__chart._internal_options()["handleScroll"].horzTouchDrag, "_internal_treatHorzTouchDragAsPageScroll")
    });
  }
  _internal_destroy() {
  ...
  _private__drawSourceImpl(target, paneViewsGetter, drawFn, source) {
    ...
    const drawRendererFn = /* @__PURE__ */ __name((renderer) => drawFn(renderer, target, isHovered, objecId), "drawRendererFn");
...
__name(_PaneWidget, "PaneWidget");
var PaneWidget = _PaneWidget;
var _PriceAxisStub = class _PriceAxisStub {
...
__name(_PriceAxisStub, "PriceAxisStub");
var PriceAxisStub = _PriceAxisStub;
function buildTimeAxisViewsGetter(zOrder) {
  return (source) => source._internal_timePaneViews?.(zOrder) ?? [];
}
__name(buildTimeAxisViewsGetter, "buildTimeAxisViewsGetter");
...
var _TimeAxisWidget = class _TimeAxisWidget {
  constructor(chartWidget, horzScaleBehavior) {
    ...
    this._private__mouseEventHandler = new MouseEventHandler(this._private__topCanvasBinding.canvasElement, this, {
      _internal_treatVertTouchDragAsPageScroll: /* @__PURE__ */ __name(() => true, "_internal_treatVertTouchDragAsPageScroll"),
      _internal_treatHorzTouchDragAsPageScroll: /* @__PURE__ */ __name(() => !this._private__chart._internal_options()["handleScroll"].horzTouchDrag, "_internal_treatHorzTouchDragAsPageScroll")
    });
  }
  _internal_destroy() {
    this._private__mouseEventHandler._internal_destroy();
  ...
  _private__recreateStubs() {
    ...
    const borderVisibleGetter = /* @__PURE__ */ __name(() => {
      return options.leftPriceScale.borderVisible && model._internal_timeScale()._internal_options().borderVisible;
    }, "borderVisibleGetter");
    const bottomColorGetter = /* @__PURE__ */ __name(() => model._internal_backgroundBottomColor(), "bottomColorGetter");
    if (options.leftPriceScale.visible && this._private__leftStub === null) {
...
__name(_TimeAxisWidget, "TimeAxisWidget");
var TimeAxisWidget = _TimeAxisWidget;
var windowsChrome = isChromiumBased() && isWindows();
var _ChartWidget = class _ChartWidget {
  ...
  _private__traverseLayout(ctx) {
    ...
    const drawPriceAxises = /* @__PURE__ */ __name((position, targetX) => {
      let targetY = 0;
    ...
    const drawStub = /* @__PURE__ */ __name((position, targetX, targetY) => {
...
__name(_ChartWidget, "ChartWidget");
var ChartWidget = _ChartWidget;
...
__name(getColoredLineBasedSeriesPlotRow, "getColoredLineBasedSeriesPlotRow");
...
__name(getAreaSeriesPlotRow, "getAreaSeriesPlotRow");
...
__name(getBaselineSeriesPlotRow, "getBaselineSeriesPlotRow");
...
__name(getBarSeriesPlotRow, "getBarSeriesPlotRow");
...
__name(getCandlestickSeriesPlotRow, "getCandlestickSeriesPlotRow");
function getCustomSeriesPlotRow(time, index, item, originalTime, dataToPlotRow) {
  ...
  const _a2 = item, { time: excludedTime, color } = _a2, data = __objRest(_a2, ["time", "color"]);
...
__name(getCustomSeriesPlotRow, "getCustomSeriesPlotRow");
function isSeriesPlotRow(row) {
  return row._internal_value !== void 0;
}
__name(isSeriesPlotRow, "isSeriesPlotRow");
...
__name(wrapCustomValues, "wrapCustomValues");
...
__name(isWhitespaceDataWithCustomCheck, "isWhitespaceDataWithCustomCheck");
...
__name(wrapWhitespaceData, "wrapWhitespaceData");
...
__name(getSeriesPlotRowCreator, "getSeriesPlotRowCreator");
...
__name(createEmptyTimePointData, "createEmptyTimePointData");
...
__name(seriesRowsFirstAndLastTime, "seriesRowsFirstAndLastTime");
...
__name(seriesUpdateInfo, "seriesUpdateInfo");
...
__name(timeScalePointTime, "timeScalePointTime");
function saveOriginalTime(data) {
  if (data._internal_originalTime === void 0) {
    data._internal_originalTime = data.time;
  }
}
__name(saveOriginalTime, "saveOriginalTime");
var _DataLayer = class _DataLayer {
...
__name(assignIndexToPointData, "assignIndexToPointData");
function lowerBoundItemsCompare(item, time) {
  return item._internal_time < time;
}
__name(lowerBoundItemsCompare, "lowerBoundItemsCompare");
function upperBoundItemsCompare(item, time) {
  return time < item._internal_time;
}
__name(upperBoundItemsCompare, "upperBoundItemsCompare");
...
__name(visibleTimedValues, "visibleTimedValues");
var _SeriesPaneViewBase = class _SeriesPaneViewBase {
  ...
  _internal__updateOptions() {
    this._internal__items = this._internal__items.map((item) => __spreadValues(__spreadValues({}, item), this._internal__series._internal_barColorer()._internal_barStyle(item._internal_time)));
  }
...
__name(_SeriesPaneViewBase, "SeriesPaneViewBase");
var SeriesPaneViewBase = _SeriesPaneViewBase;
var _CustomSeriesPaneRendererWrapper = class _CustomSeriesPaneRendererWrapper {
...
__name(_CustomSeriesPaneRendererWrapper, "CustomSeriesPaneRendererWrapper");
var CustomSeriesPaneRendererWrapper = _CustomSeriesPaneRendererWrapper;
var _SeriesCustomPaneView = class _SeriesCustomPaneView extends SeriesPaneViewBase {
...
__name(_SeriesCustomPaneView, "SeriesCustomPaneView");
var SeriesCustomPaneView = _SeriesCustomPaneView;
...
__name(unwrapItemData, "unwrapItemData");
var customStyleDefaults = {
  color: "#2196f3"
};
var createPaneView$6 = /* @__PURE__ */ __name((series, model, customPaneView) => {
  const paneView = ensure(customPaneView);
  return new SeriesCustomPaneView(series, model, paneView);
}, "createPaneView$6");
var createCustomSeriesDefinition = /* @__PURE__ */ __name((paneView) => {
  const definition = {
    type: "Custom",
    isBuiltIn: false,
    defaultOptions: __spreadValues(__spreadValues({}, customStyleDefaults), paneView.defaultOptions()),
    /**
     * @internal
     */
...
var isSeriesDefinition = /* @__PURE__ */ __name((value) => {
...
__name(singleValueData, "singleValueData");
...
__name(baselineData, "baselineData");
...
__name(candlestickData, "candlestickData");
...
__name(getSeriesDataCreator, "getSeriesDataCreator");
function customData(plotRow) {
  const time = plotRow._internal_originalTime;
  return __spreadProps(__spreadValues({}, plotRow._internal_data), {
    time
  });
}
__name(customData, "customData");
...
function chartOptionsDefaults() {
  return {
    ...
    overlayPriceScales: __spreadValues({}, priceScaleOptionsDefaults),
    leftPriceScale: __spreadProps(__spreadValues({}, priceScaleOptionsDefaults), {
      visible: false
    }),
    rightPriceScale: __spreadProps(__spreadValues({}, priceScaleOptionsDefaults), {
      visible: true
    }),
...
__name(chartOptionsDefaults, "chartOptionsDefaults");
var _PriceScaleApi = class _PriceScaleApi {
...
__name(_PriceScaleApi, "PriceScaleApi");
var PriceScaleApi = _PriceScaleApi;
var _PaneApi = class _PaneApi {
  ...
  attachPrimitive(primitive) {
    ...
    if (primitive.attached) {
      primitive.attached({
        ...
        requestUpdate: /* @__PURE__ */ __name(() => this._private__pane._internal_model()._internal_fullUpdate(), "requestUpdate")
      });
    }
  }
...
__name(_PaneApi, "PaneApi");
var PaneApi = _PaneApi;
function checkPriceLineOptions(options) {
  assert(typeof options.price === "number", `the type of 'price' price line's property must be a number, got '${typeof options.price}'`);
}
__name(checkPriceLineOptions, "checkPriceLineOptions");
...
__name(checkItemsAreOrdered, "checkItemsAreOrdered");
function checkSeriesValuesType(type, data) {
  data.forEach(getChecker(type));
}
__name(checkSeriesValuesType, "checkSeriesValuesType");
...
__name(checkBarItem, "checkBarItem");
...
__name(checkLineItem, "checkLineItem");
function checkCustomItem() {
  return;
}
__name(checkCustomItem, "checkCustomItem");
...
var _PriceLine = class _PriceLine {
...
__name(_PriceLine, "PriceLine");
var PriceLine = _PriceLine;
var _SeriesApi = class _SeriesApi {
  ...
  attachPrimitive(primitive) {
    ...
    if (primitive.attached) {
      primitive.attached({
        chart: this._internal__chartApi,
        series: this,
        requestUpdate: /* @__PURE__ */ __name(() => this._internal__series._internal_model()._internal_fullUpdate(), "requestUpdate"),
...
__name(_SeriesApi, "SeriesApi");
var SeriesApi = _SeriesApi;
var _TimeScaleApi = class _TimeScaleApi {
  ...
  options() {
    return __spreadProps(__spreadValues({}, clone(this._private__timeScale._internal_options())), {
...
__name(_TimeScaleApi, "TimeScaleApi");
var TimeScaleApi = _TimeScaleApi;
...
__name(patchPriceFormat, "patchPriceFormat");
...
__name(migrateHandleScaleScrollOptions, "migrateHandleScaleScrollOptions");
function toInternalOptions(options) {
  migrateHandleScaleScrollOptions(options);
  return options;
}
__name(toInternalOptions, "toInternalOptions");
var _ChartApi = class _ChartApi {
...
__name(_ChartApi, "ChartApi");
var ChartApi = _ChartApi;
...
__name(fetchHtmlElement, "fetchHtmlElement");
...
__name(createChartEx, "createChartEx");
...
__name(defaultHorzScaleBehavior, "defaultHorzScaleBehavior");
var _LinePaneViewBase = class _LinePaneViewBase extends SeriesPaneViewBase {
...
__name(_LinePaneViewBase, "LinePaneViewBase");
var LinePaneViewBase = _LinePaneViewBase;
...
__name(drawSeriesPointMarkers, "drawSeriesPointMarkers");
function walkLine(renderingScope, items, lineType, visibleRange, barWidth, styleGetter, finishStyledArea2) {
  ...
  if (visibleRange.to - visibleRange.from < 2) {
    ...
    const changeStyle = /* @__PURE__ */ __name((newStyle, currentItem2) => {
...
__name(getControlPoints, "getControlPoints");
function finishStyledArea$1(scope, style) {
  const ctx = scope.context;
  ctx.strokeStyle = style;
  ctx.stroke();
}
__name(finishStyledArea$1, "finishStyledArea$1");
var _PaneRendererLineBase = class _PaneRendererLineBase extends BitmapCoordinatesPaneRenderer {
  constructor() {
    super(...arguments);
    this._internal__data = null;
  }
...
__name(_PaneRendererLineBase, "PaneRendererLineBase");
var PaneRendererLineBase = _PaneRendererLineBase;
var _PaneRendererLine = class _PaneRendererLine extends PaneRendererLineBase {
  _internal__strokeStyle(renderingScope, item) {
    return item._internal_lineColor;
  }
};
__name(_PaneRendererLine, "PaneRendererLine");
var PaneRendererLine = _PaneRendererLine;
var _SeriesLinePaneView = class _SeriesLinePaneView extends LinePaneViewBase {
  constructor() {
    super(...arguments);
    this._internal__renderer = new PaneRendererLine();
  }
  _internal__createRawItem(time, price, colorer) {
    return __spreadValues(__spreadValues({}, this._internal__createRawItemBase(time, price)), colorer._internal_barStyle(time));
  }
  _internal__prepareRendererData() {
...
__name(_SeriesLinePaneView, "SeriesLinePaneView");
var SeriesLinePaneView = _SeriesLinePaneView;
...
var createPaneView$5 = /* @__PURE__ */ __name((series, model) => new SeriesLinePaneView(series, model), "createPaneView$5");
var createLineSeries = /* @__PURE__ */ __name(() => {
  const definition = {
    type: "Line",
    isBuiltIn: true,
...
__name(createDebouncedMicroTaskHandler, "createDebouncedMicroTaskHandler");
function markWithGreaterWeight$1(a, b) {
  return a.weight > b.weight ? a : b;
}
__name(markWithGreaterWeight$1, "markWithGreaterWeight$1");
function toInternalHorzScaleItem(item) {
  return item;
}
__name(toInternalHorzScaleItem, "toInternalHorzScaleItem");
function fromInternalHorzScaleItem(item) {
  return item;
}
__name(fromInternalHorzScaleItem, "fromInternalHorzScaleItem");
var _YieldCurveHorzScaleBehavior = class _YieldCurveHorzScaleBehavior {
  constructor() {
  ...
  fillWeightsForPoints(sortedTimePoints, startIndex) {
    const timeWeight = /* @__PURE__ */ __name((time) => {
      if (time % 120 === 0) {
        return 10;
      }
      if (time % 60 === 0) {
...
__name(_YieldCurveHorzScaleBehavior, "YieldCurveHorzScaleBehavior");
var YieldCurveHorzScaleBehavior = _YieldCurveHorzScaleBehavior;
...
__name(generateWhitespaceData, "generateWhitespaceData");
...
__name(buildWhitespaceState, "buildWhitespaceState");
var generateWhitespaceHash = /* @__PURE__ */ __name(({ _internal_start: start, _internal_end: end, _internal_resolution: resolution }) => `${start}~${end}~${resolution}`, "generateWhitespaceHash");
var defaultOptions = {
  ...
  localization: {
    priceFormatter: /* @__PURE__ */ __name((value) => {
...
var _YieldChartApi = class _YieldChartApi extends ChartApi {
  ...
  addSeries(definition, options = {}, paneIndex = 0) {
    ...
    const optionOverrides = __spreadValues(__spreadValues({}, lineStyleDefaultOptionOverrides), options);
  ...
  _initWhitespaceSeries() {
    ...
    __name(updateWhitespace, "updateWhitespace");
    updateWhitespace(0);
    horzBehaviour._internal_whitespaceInvalidated()._internal_subscribe(updateWhitespace);
  }
};
__name(_YieldChartApi, "YieldChartApi");
var YieldChartApi = _YieldChartApi;
function createYieldCurveChart(container, options) {
  const htmlElement = fetchHtmlElement(container);
  const chartApi = new YieldChartApi(htmlElement, options);
  return chartApi;
}
__name(createYieldCurveChart, "createYieldCurveChart");
function markWithGreaterWeight(a, b) {
  return a.weight > b.weight ? a : b;
}
__name(markWithGreaterWeight, "markWithGreaterWeight");
var _HorzScaleBehaviorPrice = class _HorzScaleBehaviorPrice {
  options() {
    return this._private__options;
  }
  setOptions(options) {
  ...
  fillWeightsForPoints(sortedTimePoints, startIndex) {
    const priceWeight = /* @__PURE__ */ __name((price) => {
...
__name(_HorzScaleBehaviorPrice, "HorzScaleBehaviorPrice");
var HorzScaleBehaviorPrice = _HorzScaleBehaviorPrice;
function createOptionsChart(container, options) {
  return createChartEx(container, new HorzScaleBehaviorPrice(), options);
}
__name(createOptionsChart, "createOptionsChart");
...
__name(finishStyledArea, "finishStyledArea");
var _PaneRendererAreaBase = class _PaneRendererAreaBase extends BitmapCoordinatesPaneRenderer {
  constructor() {
    super(...arguments);
    this._internal__data = null;
  }
...
__name(_PaneRendererAreaBase, "PaneRendererAreaBase");
var PaneRendererAreaBase = _PaneRendererAreaBase;
var _GradientStyleCache = class _GradientStyleCache {
  // eslint-disable-next-line complexity
...
__name(_GradientStyleCache, "GradientStyleCache");
var GradientStyleCache = _GradientStyleCache;
var _PaneRendererBaselineArea = class _PaneRendererBaselineArea extends PaneRendererAreaBase {
  constructor() {
    super(...arguments);
...
__name(_PaneRendererBaselineArea, "PaneRendererBaselineArea");
var PaneRendererBaselineArea = _PaneRendererBaselineArea;
var _PaneRendererBaselineLine = class _PaneRendererBaselineLine extends PaneRendererLineBase {
  constructor() {
    super(...arguments);
...
__name(_PaneRendererBaselineLine, "PaneRendererBaselineLine");
var PaneRendererBaselineLine = _PaneRendererBaselineLine;
var _SeriesBaselinePaneView = class _SeriesBaselinePaneView extends LinePaneViewBase {
  constructor(series, model) {
    super(series, model);
...
__name(_SeriesBaselinePaneView, "SeriesBaselinePaneView");
var SeriesBaselinePaneView = _SeriesBaselinePaneView;
...
var createPaneView$4 = /* @__PURE__ */ __name((series, model) => new SeriesBaselinePaneView(series, model), "createPaneView$4");
var createSeries$4 = /* @__PURE__ */ __name(() => {
  const definition = {
    type: "Baseline",
    isBuiltIn: true,
...
var _PaneRendererArea = class _PaneRendererArea extends PaneRendererAreaBase {
  constructor() {
    super(...arguments);
    this._private__fillCache = new GradientStyleCache();
  }
...
__name(_PaneRendererArea, "PaneRendererArea");
var PaneRendererArea = _PaneRendererArea;
var _SeriesAreaPaneView = class _SeriesAreaPaneView extends LinePaneViewBase {
  constructor(series, model) {
    super(series, model);
    this._internal__renderer = new CompositeRenderer();
...
__name(_SeriesAreaPaneView, "SeriesAreaPaneView");
var SeriesAreaPaneView = _SeriesAreaPaneView;
...
var createPaneView$3 = /* @__PURE__ */ __name((series, model) => new SeriesAreaPaneView(series, model), "createPaneView$3");
var createSeries$3 = /* @__PURE__ */ __name(() => {
  const definition = {
    type: "Area",
    isBuiltIn: true,
...
__name(optimalBarWidth, "optimalBarWidth");
...
__name(optimalCandlestickWidth, "optimalCandlestickWidth");
var _PaneRendererBars = class _PaneRendererBars extends BitmapCoordinatesPaneRenderer {
  constructor() {
    super(...arguments);
    this._private__data = null;
...
__name(_PaneRendererBars, "PaneRendererBars");
var PaneRendererBars = _PaneRendererBars;
var _BarsPaneViewBase = class _BarsPaneViewBase extends SeriesPaneViewBase {
  constructor(series, model) {
    super(series, model, false);
  }
  _internal__convertToCoordinates(priceScale, timeScale, firstValue) {
...
__name(_BarsPaneViewBase, "BarsPaneViewBase");
var BarsPaneViewBase = _BarsPaneViewBase;
var _SeriesBarsPaneView = class _SeriesBarsPaneView extends BarsPaneViewBase {
  constructor() {
    super(...arguments);
    this._internal__renderer = new PaneRendererBars();
  }
  _internal__createRawItem(time, bar, colorer) {
    return __spreadValues(__spreadValues({}, this._internal__createDefaultItem(time, bar, colorer)), colorer._internal_barStyle(time));
  }
  _internal__prepareRendererData() {
...
__name(_SeriesBarsPaneView, "SeriesBarsPaneView");
var SeriesBarsPaneView = _SeriesBarsPaneView;
...
var createPaneView$2 = /* @__PURE__ */ __name((series, model) => new SeriesBarsPaneView(series, model), "createPaneView$2");
var createSeries$2 = /* @__PURE__ */ __name(() => {
  const definition = {
    type: "Bar",
    isBuiltIn: true,
...
var _PaneRendererCandlesticks = class _PaneRendererCandlesticks extends BitmapCoordinatesPaneRenderer {
  constructor() {
    super(...arguments);
    this._private__data = null;
    this._private__barWidth = 0;
...
__name(_PaneRendererCandlesticks, "PaneRendererCandlesticks");
var PaneRendererCandlesticks = _PaneRendererCandlesticks;
var _SeriesCandlesticksPaneView = class _SeriesCandlesticksPaneView extends BarsPaneViewBase {
  constructor() {
    super(...arguments);
...
__name(_SeriesCandlesticksPaneView, "SeriesCandlesticksPaneView");
var SeriesCandlesticksPaneView = _SeriesCandlesticksPaneView;
...
var createPaneView$1 = /* @__PURE__ */ __name((series, model) => new SeriesCandlesticksPaneView(series, model), "createPaneView$1");
var createSeries$1 = /* @__PURE__ */ __name(() => {
  const definition = {
    type: "Candlestick",
    isBuiltIn: true,
...
var _PaneRendererHistogram = class _PaneRendererHistogram extends BitmapCoordinatesPaneRenderer {
  constructor() {
    super(...arguments);
    this._private__data = null;
...
__name(_PaneRendererHistogram, "PaneRendererHistogram");
var PaneRendererHistogram = _PaneRendererHistogram;
var _SeriesHistogramPaneView = class _SeriesHistogramPaneView extends LinePaneViewBase {
  constructor() {
    super(...arguments);
...
__name(_SeriesHistogramPaneView, "SeriesHistogramPaneView");
var SeriesHistogramPaneView = _SeriesHistogramPaneView;
var histogramStyleDefaults = {
  color: "#26a69a",
  base: 0
};
var createPaneView = /* @__PURE__ */ __name((series, model) => new SeriesHistogramPaneView(series, model), "createPaneView");
var createSeries = /* @__PURE__ */ __name(() => {
  const definition = {
    type: "Histogram",
    isBuiltIn: true,
...
var _PanePrimitiveWrapper = class _PanePrimitiveWrapper {
...
__name(_PanePrimitiveWrapper, "PanePrimitiveWrapper");
var PanePrimitiveWrapper = _PanePrimitiveWrapper;
...
var _TextWatermarkRenderer = class _TextWatermarkRenderer {
  constructor(options) {
...
__name(_TextWatermarkRenderer, "TextWatermarkRenderer");
var TextWatermarkRenderer = _TextWatermarkRenderer;
var _TextWatermarkPaneView = class _TextWatermarkPaneView {
  constructor(options) {
...
__name(_TextWatermarkPaneView, "TextWatermarkPaneView");
var TextWatermarkPaneView = _TextWatermarkPaneView;
function buildRendererLineOptions(lineOption) {
  return __spreadProps(__spreadValues({}, lineOption), {
...
__name(buildRendererLineOptions, "buildRendererLineOptions");
function buildRendererOptions$1(options) {
  return __spreadProps(__spreadValues({}, options), {
    lines: options.lines.map(buildRendererLineOptions)
  });
}
__name(buildRendererOptions$1, "buildRendererOptions$1");
function mergeLineOptionsWithDefaults(options) {
  return __spreadValues(__spreadValues({}, textWatermarkLineOptionsDefaults), options);
}
__name(mergeLineOptionsWithDefaults, "mergeLineOptionsWithDefaults");
function mergeOptionsWithDefaults$2(options) {
  return __spreadProps(__spreadValues(__spreadValues({}, textWatermarkOptionsDefaults), options), {
    lines: options.lines?.map(mergeLineOptionsWithDefaults) ?? []
  });
}
__name(mergeOptionsWithDefaults$2, "mergeOptionsWithDefaults$2");
var _TextWatermark = class _TextWatermark {
  constructor(options) {
  ...
  _internal_applyOptions(options) {
    this._private__options = mergeOptionsWithDefaults$2(__spreadValues(__spreadValues({}, this._private__options), options));
    if (this._internal_requestUpdate) {
      this._internal_requestUpdate();
    }
  }
};
__name(_TextWatermark, "TextWatermark");
var TextWatermark = _TextWatermark;
function createTextWatermark(pane, options) {
  return new PanePrimitiveWrapper(pane, new TextWatermark(options));
}
__name(createTextWatermark, "createTextWatermark");
var imageWatermarkOptionsDefaults = {
  alpha: 1,
  padding: 0
};
var _ImageWatermarkRenderer = class _ImageWatermarkRenderer {
  constructor(data) {
    this._private__data = data;
  }
  draw(target) {
...
__name(_ImageWatermarkRenderer, "ImageWatermarkRenderer");
var ImageWatermarkRenderer = _ImageWatermarkRenderer;
var _ImageWatermarkPaneView = class _ImageWatermarkPaneView {
  constructor(options) {
...
__name(_ImageWatermarkPaneView, "ImageWatermarkPaneView");
var ImageWatermarkPaneView = _ImageWatermarkPaneView;
...
__name(buildRendererOptions, "buildRendererOptions");
function mergeOptionsWithDefaults$1(options) {
  return __spreadValues(__spreadValues({}, imageWatermarkOptionsDefaults), options);
}
__name(mergeOptionsWithDefaults$1, "mergeOptionsWithDefaults$1");
var _ImageWatermark = class _ImageWatermark {
  ...
  _internal_applyOptions(options) {
    this._private__options = mergeOptionsWithDefaults$1(__spreadValues(__spreadValues({}, this._private__options), options));
...
__name(_ImageWatermark, "ImageWatermark");
var ImageWatermark = _ImageWatermark;
...
__name(createImageWatermark, "createImageWatermark");
var _SeriesPrimitiveAdapter = class _SeriesPrimitiveAdapter {
...
__name(_SeriesPrimitiveAdapter, "SeriesPrimitiveAdapter");
var SeriesPrimitiveAdapter = _SeriesPrimitiveAdapter;
...
__name(shapeMargin, "shapeMargin");
...
function hitTestArrow(up, centerX, centerY, size3, x, y) {
  ...
  const isInTriangleBounds = /* @__PURE__ */ __name(() => {
...
__name(hitTestArrow, "hitTestArrow");
...
__name(hitTestCircle, "hitTestCircle");
...
__name(hitTestSquare, "hitTestSquare");
...
__name(hitTestText, "hitTestText");
var _SeriesMarkersRenderer = class _SeriesMarkersRenderer {
  constructor() {
    this._private__data = null;
...
__name(_SeriesMarkersRenderer, "SeriesMarkersRenderer");
var SeriesMarkersRenderer = _SeriesMarkersRenderer;
...
__name(bitmapShapeItemCoordinates, "bitmapShapeItemCoordinates");
...
__name(hitTestItem, "hitTestItem");
...
__name(_SeriesMarkersPaneView, "SeriesMarkersPaneView");
var SeriesMarkersPaneView = _SeriesMarkersPaneView;
function mergeOptionsWithDefaults(options) {
  return __spreadValues(__spreadValues({}, seriesMarkerOptionsDefaults), options);
}
__name(mergeOptionsWithDefaults, "mergeOptionsWithDefaults");
var _SeriesMarkersPrimitive = class _SeriesMarkersPrimitive {
  constructor(options) {
  ...
  _internal_applyOptions(options) {
    this._private__options = mergeOptionsWithDefaults(__spreadValues(__spreadValues({}, this._private__options), options));
    if (this._internal_requestUpdate) {
      this._internal_requestUpdate();
    }
  }
  ...
  _private__recalculateMarkers() {
    ...
    this._private__indexedMarkers = this._private__markers.map((marker, index) => {
      ...
      if (marker.position === "atPriceTop" || marker.position === "atPriceBottom" || marker.position === "atPriceMiddle") {
        ...
        return __spreadProps(__spreadValues({}, baseMarker), {
          position: marker.position,
...
__name(_SeriesMarkersPrimitive, "SeriesMarkersPrimitive");
var SeriesMarkersPrimitive = _SeriesMarkersPrimitive;
var _SeriesMarkersPrimitiveWrapper = class _SeriesMarkersPrimitiveWrapper extends SeriesPrimitiveAdapter {
...
__name(_SeriesMarkersPrimitiveWrapper, "SeriesMarkersPrimitiveWrapper");
var SeriesMarkersPrimitiveWrapper = _SeriesMarkersPrimitiveWrapper;
...
__name(createSeriesMarkers, "createSeriesMarkers");
var _ExpiringMarkerManager = class _ExpiringMarkerManager {
  ...
  _internal_setMarker(marker, key, timeout) {
    ...
    if (timeout !== void 0) {
      ...
      const markerWithTimeout = __spreadProps(__spreadValues({}, marker), {
        _internal_timeoutId: timeoutId,
        _internal_expiresAt: Date.now() + timeout
      });
      this._private__markers.set(key, markerWithTimeout);
    } else {
      this._private__markers.set(key, __spreadProps(__spreadValues({}, marker), {
...
__name(_ExpiringMarkerManager, "ExpiringMarkerManager");
var ExpiringMarkerManager = _ExpiringMarkerManager;
var upDownMarkersPluginOptionDefaults = {
  positiveColor: "#22AB94",
  negativeColor: "#F7525F",
  updateVisibilityDuration: 5e3
};
var _MarkersPrimitiveRenderer = class _MarkersPrimitiveRenderer {
...
__name(_MarkersPrimitiveRenderer, "MarkersPrimitiveRenderer");
var MarkersPrimitiveRenderer = _MarkersPrimitiveRenderer;
function isAreaStyleOptions(opts, seriesType) {
  return seriesType === "Area";
}
__name(isAreaStyleOptions, "isAreaStyleOptions");
...
__name(getNeutralColor, "getNeutralColor");
var _MarkersPrimitivePaneView = class _MarkersPrimitivePaneView {
...
__name(_MarkersPrimitivePaneView, "MarkersPrimitivePaneView");
var MarkersPrimitivePaneView = _MarkersPrimitivePaneView;
function isLineData(item, type) {
  return type === "Line" || type === "Area";
}
__name(isLineData, "isLineData");
var _UpDownMarkersPrimitive = class _UpDownMarkersPrimitive {
  constructor(options) {
    ...
    this._private__options = __spreadValues(__spreadValues({}, upDownMarkersPluginOptionDefaults), options);
  }
  _internal_applyOptions(options) {
    this._private__options = __spreadValues(__spreadValues({}, this._private__options), options);
    this._internal_requestUpdate();
  }
  _internal_setMarkers(markers) {
...
__name(_UpDownMarkersPrimitive, "UpDownMarkersPrimitive");
var UpDownMarkersPrimitive = _UpDownMarkersPrimitive;
...
__name(getSign, "getSign");
var _SeriesUpDownMarkerPrimitiveWrapper = class _SeriesUpDownMarkerPrimitiveWrapper extends SeriesPrimitiveAdapter {
  setData(data) {
...
__name(_SeriesUpDownMarkerPrimitiveWrapper, "SeriesUpDownMarkerPrimitiveWrapper");
var SeriesUpDownMarkerPrimitiveWrapper = _SeriesUpDownMarkerPrimitiveWrapper;
...
__name(createUpDownMarkers, "createUpDownMarkers");
var customSeriesDefaultOptions = __spreadValues(__spreadValues({}, seriesOptionsDefaults), customStyleDefaults$1);
function version() {
  return "5.0.8";
}
