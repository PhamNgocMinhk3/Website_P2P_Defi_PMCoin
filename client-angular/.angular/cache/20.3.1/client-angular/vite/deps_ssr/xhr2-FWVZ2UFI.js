  ...
  "node_modules/xhr2/lib/xhr2.js"(exports, module) {
    (function() {
      ...
      XMLHttpRequestEventTarget = (function() {
        const _XMLHttpRequestEventTarget = class _XMLHttpRequestEventTarget {
          // @private
        ...
        __name(_XMLHttpRequestEventTarget, "XMLHttpRequestEventTarget");
        let XMLHttpRequestEventTarget2 = _XMLHttpRequestEventTarget;
        ;
      ...
      XMLHttpRequest = (function() {
        const _XMLHttpRequest = class _XMLHttpRequest extends XMLHttpRequestEventTarget {
          ...
          open(method, url2, async, user, password) {
            ...
            switch (this.readyState) {
              case _XMLHttpRequest.UNSENT:
              case _XMLHttpRequest.OPENED:
              case _XMLHttpRequest.DONE:
                null;
                break;
              case _XMLHttpRequest.HEADERS_RECEIVED:
              case _XMLHttpRequest.LOADING:
                null;
            }
            this._method = method;
            this._url = xhrUrl;
            ...
            this._mimeOverride = null;
            this._setReadyState(_XMLHttpRequest.OPENED);
            this._request = null;
            this._response = null;
            this.status = 0;
            this.statusText = "";
          ...
          overrideMimeType(newMimeType) {
            if (this.readyState === _XMLHttpRequest.LOADING || this.readyState === _XMLHttpRequest.DONE) {
          ...
          static nodejsSet(options) {
            _XMLHttpRequest.prototype.nodejsSet(options);
            return void 0;
          }
          ...
          _onHttpResponse(request, response) {
            ...
            return this._setReadyState(_XMLHttpRequest.HEADERS_RECEIVED);
          }
          ...
          _onHttpResponseData(response, data) {
            ...
            if (this.readyState !== _XMLHttpRequest.LOADING) {
              this._setReadyState(_XMLHttpRequest.LOADING);
            }
          ...
          _onHttpResponseEnd(response) {
            ...
            this._request = null;
            this._response = null;
            this._setReadyState(_XMLHttpRequest.DONE);
        ...
        let XMLHttpRequest2 = _XMLHttpRequest;
        ;
      ...
      SecurityError = (_a = class extends Error {
        // @private
        constructor() {
          super();
        }
      }, __name(_a, "SecurityError"), _a);
      XMLHttpRequest.SecurityError = SecurityError;
      InvalidStateError = (_b = class extends Error {
        // @private
        constructor() {
          super();
        }
      }, __name(_b, "InvalidStateError"), _b);
      InvalidStateError = (_c = class extends Error {
      }, __name(_c, "InvalidStateError"), _c);
      XMLHttpRequest.InvalidStateError = InvalidStateError;
      NetworkError = (_d = class extends Error {
        // @private
        constructor() {
          super();
        }
      }, __name(_d, "NetworkError"), _d);
      XMLHttpRequest.SyntaxError = SyntaxError;
      SyntaxError = (_e = class extends Error {
        // @private:
        constructor() {
          super();
        }
      }, __name(_e, "SyntaxError"), _e);
      ProgressEvent = (function() {
        const _ProgressEvent = class _ProgressEvent {
          // Creates a new event.
        ...
        let ProgressEvent2 = _ProgressEvent;
        ;
      ...
      XMLHttpRequestUpload = (_f = class extends XMLHttpRequestEventTarget {
        // @private
      ...
      }, __name(_f, "XMLHttpRequestUpload"), _f);
      XMLHttpRequest.XMLHttpRequestUpload = XMLHttpRequestUpload;
    }).call(exports);
  }
});
export default require_xhr2();
//# sourceMappingURL=xhr2-FWVZ2UFI.js.map
