...
import {
  ...
  getDOM,
  setRootDomAdapter
} from "./chunk-Q2MTCLXJ.js";
import {
  XhrFactory
} from "./chunk-RNVTKZ2O.js";
import {
  APP_ID,
  ApplicationRef,
  CSP_NONCE,
...
function requireEvent() {
  ...
  Event.prototype = Object.create(Object.prototype, {
    ...
    stopPropagation: {
      value: /* @__PURE__ */ __name(function stopPropagation() {
        this._propagationStopped = true;
      }, "stopPropagation")
    },
    stopImmediatePropagation: {
      value: /* @__PURE__ */ __name(function stopImmediatePropagation() {
        this._propagationStopped = true;
        this._immediatePropagationStopped = true;
      }, "stopImmediatePropagation")
    },
    preventDefault: {
      value: /* @__PURE__ */ __name(function preventDefault() {
        if (this.cancelable) this.defaultPrevented = true;
      }, "preventDefault")
    },
    initEvent: {
      value: /* @__PURE__ */ __name(function initEvent(type, bubbles, cancelable) {
        this._initialized = true;
...
__name(requireEvent, "requireEvent");
var UIEvent_1;
...
function requireUIEvent() {
  ...
  __name(UIEvent, "UIEvent");
  UIEvent.prototype = Object.create(Event.prototype, {
    constructor: {
      value: UIEvent
    },
    initUIEvent: {
      value: /* @__PURE__ */ __name(function(type, bubbles, cancelable, view, detail) {
...
__name(requireUIEvent, "requireUIEvent");
var MouseEvent_1;
...
function requireMouseEvent() {
  ...
  MouseEvent.prototype = Object.create(UIEvent.prototype, {
    ...
    initMouseEvent: {
      value: /* @__PURE__ */ __name(function(type, bubbles, cancelable, view, detail, screenX, screenY, clientX, clientY, ctrlKey, altKey, shiftKey, metaKey, button, relatedTarget) {
...
__name(requireMouseEvent, "requireMouseEvent");
var utils = {};
var config = {};
...
function requireEventTarget() {
  ...
  EventTarget.prototype = {
    ...
    addEventListener: /* @__PURE__ */ __name(function addEventListener(type, listener, capture) {
      if (!listener) return;
    ...
    removeEventListener: /* @__PURE__ */ __name(function removeEventListener(type, listener, capture) {
      if (capture === void 0) capture = false;
      if (this._listeners) {
        var list = this._listeners[type];
        if (list) {
    ...
    dispatchEvent: /* @__PURE__ */ __name(function dispatchEvent(event) {
    ...
    //
    _dispatchEvent: /* @__PURE__ */ __name(function _dispatchEvent(event, trusted) {
    ...
    _isClick: /* @__PURE__ */ __name(function(event) {
    ...
    _doClick: /* @__PURE__ */ __name(function(event) {
    ...
    // of event dispatch.
    //
    _setEventHandler: /* @__PURE__ */ __name(function _setEventHandler(type, handler) {
      if (!this._handlers) this._handlers = /* @__PURE__ */ Object.create(null);
      this._handlers[type] = handler;
    }, "_setEventHandler"),
    _getEventHandler: /* @__PURE__ */ __name(function _getEventHandler(type) {
      return this._handlers && this._handlers[type] || null;
    }, "_getEventHandler")
  };
  return EventTarget_1;
}
__name(requireEventTarget, "requireEventTarget");
var LinkedList = {
  exports: {}
};
...
function requireLinkedList() {
  ...
  var LinkedList$1 = LinkedList.exports = {
    ...
    valid: /* @__PURE__ */ __name(function(a) {
    ...
    // insert a before b
    insertBefore: /* @__PURE__ */ __name(function(a, b) {
    ...
    replace: /* @__PURE__ */ __name(function(a, b) {
    ...
    remove: /* @__PURE__ */ __name(function(a) {
...
__name(requireLinkedList, "requireLinkedList");
var NodeUtils;
...
function requireNodeUtils() {
  ...
  __name(escapeMatchingClosingTag, "escapeMatchingClosingTag");
  ...
  __name(escapeClosingCommentTag, "escapeClosingCommentTag");
  function escapeProcessingInstructionContent(rawContent) {
    return rawContent.includes(">") ? rawContent.replaceAll(">", "&gt;") : rawContent;
  }
  __name(escapeProcessingInstructionContent, "escapeProcessingInstructionContent");
  ...
  __name(serializeOne, "serializeOne");
  return NodeUtils;
}
__name(requireNodeUtils, "requireNodeUtils");
var Node_1;
var hasRequiredNode;
function requireNode() {
  ...
  Node2.prototype = Object.create(EventTarget.prototype, {
    ...
    _countChildrenOfType: {
      value: /* @__PURE__ */ __name(function(type) {
        var sum = 0;
    ...
    _ensureInsertValid: {
      value: /* @__PURE__ */ __name(function _ensureInsertValid(node2, child, isPreinsert) {
    ...
    insertBefore: {
      value: /* @__PURE__ */ __name(function insertBefore(node2, child) {
        var parent = this;
    ...
    appendChild: {
      value: /* @__PURE__ */ __name(function(child) {
    ...
    removeChild: {
      value: /* @__PURE__ */ __name(function removeChild(child) {
        var parent = this;
    ...
    replaceChild: {
      value: /* @__PURE__ */ __name(function replaceChild(node2, child) {
        var parent = this;
    ...
    contains: {
      value: /* @__PURE__ */ __name(function contains(node2) {
        if (node2 === null) {
          return false;
        }
        if (this === node2) {
    ...
    compareDocumentPosition: {
      value: /* @__PURE__ */ __name(function compareDocumentPosition2(that) {
    ...
    isSameNode: {
      value: /* @__PURE__ */ __name(function isSameNode(node2) {
        return this === node2;
      }, "isSameNode")
    },
    ...
    isEqualNode: {
      value: /* @__PURE__ */ __name(function isEqualNode(node2) {
    ...
    cloneNode: {
      value: /* @__PURE__ */ __name(function(deep) {
    ...
    lookupPrefix: {
      value: /* @__PURE__ */ __name(function lookupPrefix(ns) {
        var e;
    ...
    lookupNamespaceURI: {
      value: /* @__PURE__ */ __name(function lookupNamespaceURI(prefix) {
    ...
    isDefaultNamespace: {
      value: /* @__PURE__ */ __name(function isDefaultNamespace(ns) {
        if (ns === "" || ns === void 0) {
          ns = null;
        }
    ...
    isAncestor: {
      value: /* @__PURE__ */ __name(function(that) {
    ...
    // necessary
    _insertOrReplace: {
      value: /* @__PURE__ */ __name(function _insertOrReplace(parent, before, isReplace) {
...
function requireNodeList_es6() {
  ...
  NodeList_es6 = (_a2 = class extends Array {
    constructor(a) {
      super(a && a.length || 0);
      if (a) {
        for (var idx in a) {
  ...
  }, __name(_a2, "NodeList"), _a2);
  return NodeList_es6;
}
__name(requireNodeList_es6, "requireNodeList_es6");
var NodeList_es5;
...
__name(requireNodeList_es5, "requireNodeList_es5");
var NodeList_1;
...
__name(requireNodeList, "requireNodeList");
var ContainerNode_1;
...
function requireContainerNode() {
  ...
  __name(ContainerNode, "ContainerNode");
  ContainerNode.prototype = Object.create(Node2.prototype, {
    ...
    removeChildren: {
      value: /* @__PURE__ */ __name(function removeChildren() {
...
__name(requireContainerNode, "requireContainerNode");
var xmlnames = {};
...
function requireXmlnames() {
  ...
  __name(isValidQName, "isValidQName");
  return xmlnames;
}
__name(requireXmlnames, "requireXmlnames");
var attributes = {};
...
function requireAttributes() {
  ...
  __name(numberPropDesc, "numberPropDesc");
...
__name(requireAttributes, "requireAttributes");
...
function requireFilteredElementList() {
  ...
  __name(FilteredElementList, "FilteredElementList");
  FilteredElementList.prototype = Object.create(Object.prototype, {
    ...
    item: {
      value: /* @__PURE__ */ __name(function(n) {
        this.checkcache();
...
__name(requireFilteredElementList, "requireFilteredElementList");
var DOMTokenList_1;
...
function requireDOMTokenList() {
  ...
  Object.defineProperties(DOMTokenList.prototype, {
    ...
    item: {
      value: /* @__PURE__ */ __name(function(index2) {
    ...
    contains: {
      value: /* @__PURE__ */ __name(function(token) {
        token = String(token);
        var list = getList(this);
    ...
    toggle: {
      value: /* @__PURE__ */ __name(function toggle(token, force) {
    ...
    replace: {
      value: /* @__PURE__ */ __name(function replace(token, newToken) {
        if (String(newToken) === "") {
          utils2.SyntaxError();
        }
        token = handleErrors(token);
...
__name(requireDOMTokenList, "requireDOMTokenList");
var select = {
  exports: {}
};
...
function requireSelect() {
  ...
  (function(module, exports) {
    ...
    var compareDocumentPosition2 = /* @__PURE__ */ __name(function(a, b) {
      return a.compareDocumentPosition(b);
    }, "compareDocumentPosition");
    var order = /* @__PURE__ */ __name(function(a, b) {
      return compareDocumentPosition2(a, b) & 2 ? 1 : -1;
    }, "order");
    var next = /* @__PURE__ */ __name(function(el) {
      while ((el = el.nextSibling) && el.nodeType !== 1) ;
      return el;
    }, "next");
    var prev = /* @__PURE__ */ __name(function(el) {
      while ((el = el.previousSibling) && el.nodeType !== 1) ;
      return el;
    }, "prev");
    var child = /* @__PURE__ */ __name(function(el) {
      if (el = el.firstChild) {
        while (el.nodeType !== 1 && (el = el.nextSibling)) ;
      }
      return el;
    }, "child");
    var lastChild = /* @__PURE__ */ __name(function(el) {
      if (el = el.lastChild) {
        while (el.nodeType !== 1 && (el = el.previousSibling)) ;
      }
      return el;
    }, "lastChild");
    var parentIsElement = /* @__PURE__ */ __name(function(n) {
      if (!n.parentNode) {
        return false;
      }
    ...
    var unquote = /* @__PURE__ */ __name(function(str) {
      if (!str) return str;
      var ch = str[0];
      if (ch === '"' || ch === "'") {
    ...
    var decodeid = /* @__PURE__ */ __name(function(str) {
    ...
    var makeInside = /* @__PURE__ */ __name(function(start, end) {
      var regex = rules.inside.source.replace(/</g, start).replace(/>/g, end);
      return new RegExp(regex);
    }, "makeInside");
    var replace = /* @__PURE__ */ __name(function(regex, name, val) {
      regex = regex.source;
      regex = regex.replace(name, val.source || val);
      return new RegExp(regex);
    }, "replace");
    var truncateUrl = /* @__PURE__ */ __name(function(url, num) {
      return url.replace(/^(?:\w+:\/\/|\/+)/, "").replace(/(?:\/+|\/*#.*?)$/, "").split("/", num).join("/");
    }, "truncateUrl");
    var parseNth = /* @__PURE__ */ __name(function(param_, test) {
    ...
    var nth = /* @__PURE__ */ __name(function(param_, test, last) {
    ...
    var selectors = {
      ...
      "type": /* @__PURE__ */ __name(function(type) {
        type = type.toLowerCase();
        return function(el) {
          return el.nodeName.toLowerCase() === type;
        };
      }, "type"),
      "attr": /* @__PURE__ */ __name(function(key, op, val, i) {
        op = operators[op];
        return function(el) {
          var attr;
          switch (key) {
      ...
      ":first-child": /* @__PURE__ */ __name(function(el) {
        return !prev(el) && parentIsElement(el);
      }, ":first-child"),
      ":last-child": /* @__PURE__ */ __name(function(el) {
        return !next(el) && parentIsElement(el);
      }, ":last-child"),
      ":only-child": /* @__PURE__ */ __name(function(el) {
        return !prev(el) && !next(el) && parentIsElement(el);
      }, ":only-child"),
      ":nth-child": /* @__PURE__ */ __name(function(param, last) {
        return nth(param, function() {
          return true;
        }, last);
      }, ":nth-child"),
      ":nth-last-child": /* @__PURE__ */ __name(function(param) {
        return selectors[":nth-child"](param, true);
      }, ":nth-last-child"),
      ":root": /* @__PURE__ */ __name(function(el) {
        return el.ownerDocument.documentElement === el;
      }, ":root"),
      ":empty": /* @__PURE__ */ __name(function(el) {
        return !el.firstChild;
      }, ":empty"),
      ":not": /* @__PURE__ */ __name(function(sel) {
        var test = compileGroup(sel);
        return function(el) {
          return !test(el);
        };
      }, ":not"),
      ":first-of-type": /* @__PURE__ */ __name(function(el) {
        if (!parentIsElement(el)) return;
      ...
      ":last-of-type": /* @__PURE__ */ __name(function(el) {
        if (!parentIsElement(el)) return;
        var type = el.nodeName;
        while (el = next(el)) {
          if (el.nodeName === type) return;
      ...
      ":only-of-type": /* @__PURE__ */ __name(function(el) {
        return selectors[":first-of-type"](el) && selectors[":last-of-type"](el);
      }, ":only-of-type"),
      ":nth-of-type": /* @__PURE__ */ __name(function(param, last) {
        return nth(param, function(rel, el) {
          return rel.nodeName === el.nodeName;
        }, last);
      }, ":nth-of-type"),
      ":nth-last-of-type": /* @__PURE__ */ __name(function(param) {
        return selectors[":nth-of-type"](param, true);
      }, ":nth-last-of-type"),
      ":checked": /* @__PURE__ */ __name(function(el) {
        return !!(el.checked || el.selected);
      }, ":checked"),
      ":indeterminate": /* @__PURE__ */ __name(function(el) {
        return !selectors[":checked"](el);
      }, ":indeterminate"),
      ":enabled": /* @__PURE__ */ __name(function(el) {
        return !el.disabled && el.type !== "hidden";
      }, ":enabled"),
      ":disabled": /* @__PURE__ */ __name(function(el) {
        return !!el.disabled;
      }, ":disabled"),
      ":target": /* @__PURE__ */ __name(function(el) {
        return el.id === window2.location.hash.substring(1);
      }, ":target"),
      ":focus": /* @__PURE__ */ __name(function(el) {
        return el === el.ownerDocument.activeElement;
      }, ":focus"),
      ":is": /* @__PURE__ */ __name(function(sel) {
        return compileGroup(sel);
      }, ":is"),
      // :matches is an older name for :is; see
      // https://github.com/w3c/csswg-drafts/issues/3258
      ":matches": /* @__PURE__ */ __name(function(sel) {
        return selectors[":is"](sel);
      }, ":matches"),
      ":nth-match": /* @__PURE__ */ __name(function(param, last) {
        var args = param.split(/\s*,\s*/), arg = args.shift(), test = compileGroup(args.join(","));
        return nth(arg, test, last);
      }, ":nth-match"),
      ":nth-last-match": /* @__PURE__ */ __name(function(param) {
        return selectors[":nth-match"](param, true);
      }, ":nth-last-match"),
      ":links-here": /* @__PURE__ */ __name(function(el) {
        return el + "" === window2.location + "";
      }, ":links-here"),
      ":lang": /* @__PURE__ */ __name(function(param) {
        return function(el) {
          while (el) {
      ...
      ":dir": /* @__PURE__ */ __name(function(param) {
        return function(el) {
          while (el) {
      ...
      ":scope": /* @__PURE__ */ __name(function(el, con) {
      ...
      ":any-link": /* @__PURE__ */ __name(function(el) {
        return typeof el.href === "string";
      }, ":any-link"),
      ":local-link": /* @__PURE__ */ __name(function(el) {
        if (el.nodeName) {
      ...
      ":default": /* @__PURE__ */ __name(function(el) {
        return !!el.defaultSelected;
      }, ":default"),
      ":valid": /* @__PURE__ */ __name(function(el) {
        return el.willValidate || el.validity && el.validity.valid;
      }, ":valid"),
      ":invalid": /* @__PURE__ */ __name(function(el) {
        return !selectors[":valid"](el);
      }, ":invalid"),
      ":in-range": /* @__PURE__ */ __name(function(el) {
        return el.value > el.min && el.value <= el.max;
      }, ":in-range"),
      ":out-of-range": /* @__PURE__ */ __name(function(el) {
        return !selectors[":in-range"](el);
      }, ":out-of-range"),
      ":required": /* @__PURE__ */ __name(function(el) {
        return !!el.required;
      }, ":required"),
      ":optional": /* @__PURE__ */ __name(function(el) {
        return !el.required;
      }, ":optional"),
      ":read-only": /* @__PURE__ */ __name(function(el) {
        if (el.readOnly) return true;
        var attr = el.getAttribute("contenteditable"), prop = el.contentEditable, name = el.nodeName.toLowerCase();
        name = name !== "input" && name !== "textarea";
        return (name || el.disabled) && attr == null && prop !== "true";
      }, ":read-only"),
      ":read-write": /* @__PURE__ */ __name(function(el) {
        return !selectors[":read-only"](el);
      }, ":read-write"),
      ":hover": /* @__PURE__ */ __name(function() {
        throw new Error(":hover is not supported.");
      }, ":hover"),
      ":active": /* @__PURE__ */ __name(function() {
        throw new Error(":active is not supported.");
      }, ":active"),
      ":link": /* @__PURE__ */ __name(function() {
        throw new Error(":link is not supported.");
      }, ":link"),
      ":visited": /* @__PURE__ */ __name(function() {
        throw new Error(":visited is not supported.");
      }, ":visited"),
      ":column": /* @__PURE__ */ __name(function() {
        throw new Error(":column is not supported.");
      }, ":column"),
      ":nth-column": /* @__PURE__ */ __name(function() {
        throw new Error(":nth-column is not supported.");
      }, ":nth-column"),
      ":nth-last-column": /* @__PURE__ */ __name(function() {
        throw new Error(":nth-last-column is not supported.");
      }, ":nth-last-column"),
      ":current": /* @__PURE__ */ __name(function() {
        throw new Error(":current is not supported.");
      }, ":current"),
      ":past": /* @__PURE__ */ __name(function() {
        throw new Error(":past is not supported.");
      }, ":past"),
      ":future": /* @__PURE__ */ __name(function() {
        throw new Error(":future is not supported.");
      }, ":future"),
      // Non-standard, for compatibility purposes.
      ":contains": /* @__PURE__ */ __name(function(param) {
        return function(el) {
          var text = el.innerText || el.textContent || el.value || "";
          return text.indexOf(param) !== -1;
        };
      }, ":contains"),
      ":has": /* @__PURE__ */ __name(function(param) {
        return function(el) {
    ...
    var operators = {
      ...
      "=": /* @__PURE__ */ __name(function(attr, val) {
        return attr === val;
      }, "="),
      "*=": /* @__PURE__ */ __name(function(attr, val) {
    ...
    var combinators = {
      ...
      "noop": /* @__PURE__ */ __name(function(test) {
        return function(el) {
          return test(el) && el;
        };
      }, "noop"),
      "ref": /* @__PURE__ */ __name(function(test, name) {
        var node2;
        function ref(el) {
    ...
    var compile2 = /* @__PURE__ */ __name(function(sel_) {
    ...
    var tok = /* @__PURE__ */ __name(function(cap, qname) {
      if (qname) {
    ...
    var makeSimple = /* @__PURE__ */ __name(function(func) {
      var l = func.length, i;
    ...
    var makeTest = /* @__PURE__ */ __name(function(func) {
      if (func.length < 2) {
        return function(el) {
          return !!func[0](el);
        };
    ...
    var makeSubject = /* @__PURE__ */ __name(function() {
      var target;
      function subject(el) {
    ...
    var compileGroup = /* @__PURE__ */ __name(function(sel) {
    ...
    var find2 = /* @__PURE__ */ __name(function(sel, node2) {
    ...
    module.exports = exports = /* @__PURE__ */ __name(function(sel, context) {
      var id, r;
...
__name(requireSelect, "requireSelect");
var ChildNode_1;
...
function requireChildNode() {
  ...
  var Node2 = requireNode();
  var LinkedList2 = requireLinkedList();
  var createDocumentFragmentFromArguments = /* @__PURE__ */ __name(function(document2, args) {
  ...
  var ChildNode = {
    ...
    after: {
      value: /* @__PURE__ */ __name(function after() {
    ...
    // inserted as the equivalent Text nodes.
    before: {
      value: /* @__PURE__ */ __name(function before() {
        var argArr = Array.prototype.slice.call(arguments);
    ...
    _remove: {
      value: /* @__PURE__ */ __name(function _remove() {
        var parent = this.parentNode;
    ...
    replaceWith: {
      value: /* @__PURE__ */ __name(function replaceWith() {
        var argArr = Array.prototype.slice.call(arguments);
        var parentNode = this.parentNode, nextSibling = this.nextSibling;
        if (parentNode === null) {
          return;
...
__name(requireChildNode, "requireChildNode");
...
__name(requireNonDocumentTypeChildNode, "requireNonDocumentTypeChildNode");
var NamedNodeMap_1;
...
function requireNamedNodeMap() {
  ...
  Object.defineProperties(NamedNodeMap.prototype, {
    ...
    getNamedItem: {
      value: /* @__PURE__ */ __name(function getNamedItem(qualifiedName) {
        return this.element.getAttributeNode(qualifiedName);
      }, "getNamedItem")
    },
    getNamedItemNS: {
      value: /* @__PURE__ */ __name(function getNamedItemNS(namespace, localName) {
    ...
    removeNamedItem: {
      value: /* @__PURE__ */ __name(function removeNamedItem(qualifiedName) {
    ...
    removeNamedItemNS: {
      value: /* @__PURE__ */ __name(function removeNamedItemNS(ns, lname) {
...
__name(requireNamedNodeMap, "requireNamedNodeMap");
var Element_1;
...
function requireElement() {
  ...
  __name(recursiveGetText, "recursiveGetText");
  Element2.prototype = Object.create(ContainerNode.prototype, {
    isHTML: {
      get: /* @__PURE__ */ __name(function isHTML() {
        return this.namespaceURI === NAMESPACE.HTML && this.ownerDocument.isHTML;
      }, "isHTML")
    },
    tagName: {
      get: /* @__PURE__ */ __name(function tagName() {
    ...
    textContent: {
      ...
      set: /* @__PURE__ */ __name(function(newtext) {
        this.removeChildren();
    ...
    _insertAdjacent: {
      value: /* @__PURE__ */ __name(function _insertAdjacent(position, node2) {
        var first = false;
        switch (position) {
          case "beforebegin":
            first = true;
    ...
    insertAdjacentElement: {
      value: /* @__PURE__ */ __name(function insertAdjacentElement(position, element) {
    ...
    insertAdjacentText: {
      value: /* @__PURE__ */ __name(function insertAdjacentText(position, data) {
    ...
    insertAdjacentHTML: {
      value: /* @__PURE__ */ __name(function insertAdjacentHTML(position, text) {
        position = utils2.toASCIILowerCase(String(position));
        text = String(text);
        var context;
        switch (position) {
    ...
    nextElement: {
      value: /* @__PURE__ */ __name(function(root2) {
    ...
    getElementsByTagName: {
      value: /* @__PURE__ */ __name(function getElementsByTagName2(lname) {
        var filter2;
        if (!lname) return new NodeList();
        if (lname === "*") filter2 = /* @__PURE__ */ __name(function() {
          return true;
        }, "filter");
    ...
    getElementsByTagNameNS: {
      value: /* @__PURE__ */ __name(function getElementsByTagNameNS(ns, lname) {
        var filter2;
        if (ns === "*" && lname === "*") filter2 = /* @__PURE__ */ __name(function() {
          return true;
        }, "filter");
    ...
    getElementsByClassName: {
      value: /* @__PURE__ */ __name(function getElementsByClassName2(names) {
    ...
    getElementsByName: {
      value: /* @__PURE__ */ __name(function getElementsByName(name) {
    ...
    isEqual: {
      value: /* @__PURE__ */ __name(function isEqual(that) {
    ...
    _lookupNamespacePrefix: {
      value: /* @__PURE__ */ __name(function _lookupNamespacePrefix(ns, originalElement) {
     ...
     */
    getAttribute: {
      value: /* @__PURE__ */ __name(function getAttribute(qname) {
        var attr = this.getAttributeNode(qname);
        return attr ? attr.value : null;
      }, "getAttribute")
    },
    getAttributeNS: {
      value: /* @__PURE__ */ __name(function getAttributeNS(ns, lname) {
        var attr = this.getAttributeNodeNS(ns, lname);
        return attr ? attr.value : null;
      }, "getAttributeNS")
    },
    getAttributeNode: {
      value: /* @__PURE__ */ __name(function getAttributeNode(qname) {
        qname = String(qname);
    ...
    getAttributeNodeNS: {
      value: /* @__PURE__ */ __name(function getAttributeNodeNS(ns, lname) {
    ...
    hasAttribute: {
      value: /* @__PURE__ */ __name(function hasAttribute(qname) {
        qname = String(qname);
        if (/[A-Z]/.test(qname) && this.isHTML) qname = utils2.toASCIILowerCase(qname);
    ...
    hasAttributeNS: {
      value: /* @__PURE__ */ __name(function hasAttributeNS(ns, lname) {
        ns = ns === void 0 || ns === null ? "" : String(ns);
        lname = String(lname);
        var key = ns + "|" + lname;
    ...
    hasAttributes: {
      value: /* @__PURE__ */ __name(function hasAttributes() {
        return this._numattrs > 0;
      }, "hasAttributes")
    },
    toggleAttribute: {
      value: /* @__PURE__ */ __name(function toggleAttribute(qname, force) {
        qname = String(qname);
    ...
    _setAttribute: {
      value: /* @__PURE__ */ __name(function _setAttribute(qname, value) {
        var attr = this._attrsByQName[qname];
        var isnew;
        if (!attr) {
    ...
    setAttribute: {
      value: /* @__PURE__ */ __name(function setAttribute(qname, value) {
        qname = String(qname);
        if (!xml.isValidName(qname)) utils2.InvalidCharacterError();
        if (/[A-Z]/.test(qname) && this.isHTML) qname = utils2.toASCIILowerCase(qname);
    ...
    _setAttributeNS: {
      value: /* @__PURE__ */ __name(function _setAttributeNS(ns, qname, value) {
    ...
    setAttributeNS: {
      value: /* @__PURE__ */ __name(function setAttributeNS(ns, qname, value) {
    ...
    setAttributeNode: {
      value: /* @__PURE__ */ __name(function setAttributeNode(attr) {
    ...
    setAttributeNodeNS: {
      value: /* @__PURE__ */ __name(function setAttributeNodeNS(attr) {
    ...
    removeAttribute: {
      value: /* @__PURE__ */ __name(function removeAttribute(qname) {
        qname = String(qname);
        if (/[A-Z]/.test(qname) && this.isHTML) qname = utils2.toASCIILowerCase(qname);
        var attr = this._attrsByQName[qname];
        if (!attr) return;
    ...
    removeAttributeNS: {
      value: /* @__PURE__ */ __name(function removeAttributeNS(ns, lname) {
        ns = ns === void 0 || ns === null ? "" : String(ns);
        lname = String(lname);
        var key = ns + "|" + lname;
        var attr = this._attrsByLName[key];
    ...
    removeAttributeNode: {
      value: /* @__PURE__ */ __name(function removeAttributeNode(attr) {
        var ns = attr.namespaceURI;
        var key = (ns === null ? "" : ns) + "|" + attr.localName;
    ...
    getAttributeNames: {
      value: /* @__PURE__ */ __name(function getAttributeNames() {
        var elt = this;
    ...
    // namespace steps
    _getattr: {
      value: /* @__PURE__ */ __name(function _getattr(qname) {
        var attr = this._attrsByQName[qname];
        return attr ? attr.value : null;
      }, "_getattr")
    },
    ...
    _setattr: {
      value: /* @__PURE__ */ __name(function _setattr(qname, value) {
        var attr = this._attrsByQName[qname];
        var isnew;
        if (!attr) {
          attr = this._newattr(qname);
    ...
    _newattr: {
      value: /* @__PURE__ */ __name(function _newattr(qname) {
    ...
    // same qname
    _addQName: {
      value: /* @__PURE__ */ __name(function(attr) {
        var qname = attr.name;
    ...
    matches: {
      value: /* @__PURE__ */ __name(function(selector) {
  ...
  Attr.prototype = Object.create(Object.prototype, {
    ...
    _setOwnerElement: {
      value: /* @__PURE__ */ __name(function _setOwnerElement(elt) {
    ...
    cloneNode: {
      value: /* @__PURE__ */ __name(function cloneNode2(deep) {
  ...
  __name(AttributesArray, "AttributesArray");
  ...
  __name(ChildrenCollection, "ChildrenCollection");
  ChildrenCollection.prototype = Object.create(Object.prototype, {
    ...
    item: {
      value: /* @__PURE__ */ __name(function item(n) {
        this.updateCache();
        return this.childrenByNumber[n] || null;
      }, "item")
    },
    namedItem: {
      value: /* @__PURE__ */ __name(function namedItem(name) {
        this.updateCache();
    ...
    updateCache: {
      value: /* @__PURE__ */ __name(function updateCache() {
  ...
  __name(localNameElementFilter, "localNameElementFilter");
  ...
  __name(htmlLocalNameElementFilter, "htmlLocalNameElementFilter");
  function namespaceElementFilter(ns) {
    return function(e) {
      return e.namespaceURI === ns;
    };
  }
  __name(namespaceElementFilter, "namespaceElementFilter");
  function namespaceLocalNameElementFilter(ns, lname) {
    return function(e) {
      return e.namespaceURI === ns && e.localName === lname;
    };
  }
  __name(namespaceLocalNameElementFilter, "namespaceLocalNameElementFilter");
  ...
  __name(classNamesElementFilter, "classNamesElementFilter");
  ...
  __name(elementNameFilter, "elementNameFilter");
  return Element_1;
}
__name(requireElement, "requireElement");
var Leaf_1;
var hasRequiredLeaf;
function requireLeaf() {
  ...
  Leaf.prototype = Object.create(Node2.prototype, {
    ...
    insertBefore: {
      value: /* @__PURE__ */ __name(function(node2, child) {
        if (!node2.nodeType) throw new TypeError("not a node");
    ...
    removeChild: {
      value: /* @__PURE__ */ __name(function(node2) {
        if (!node2.nodeType) throw new TypeError("not a node");
        NotFoundError();
      }, "value")
    },
...
__name(requireLeaf, "requireLeaf");
var CharacterData_1;
...
function requireCharacterData() {
  ...
  CharacterData.prototype = Object.create(Leaf.prototype, {
    ...
    substringData: {
      value: /* @__PURE__ */ __name(function substringData(offset, count) {
    ...
    // object's data.
    appendData: {
      value: /* @__PURE__ */ __name(function appendData(data) {
    ...
    //
    insertData: {
      value: /* @__PURE__ */ __name(function insertData(offset, data) {
    ...
    deleteData: {
      value: /* @__PURE__ */ __name(function deleteData(offset, count) {
    ...
    replaceData: {
      value: /* @__PURE__ */ __name(function replaceData(offset, count, data) {
    ...
    isEqual: {
      value: /* @__PURE__ */ __name(function isEqual(n) {
...
__name(requireCharacterData, "requireCharacterData");
var Text_1;
var hasRequiredText;
function requireText() {
  ...
  Text2.prototype = Object.create(CharacterData.prototype, {
    ...
    splitText: {
      value: /* @__PURE__ */ __name(function splitText(offset) {
    ...
    wholeText: {
      get: /* @__PURE__ */ __name(function wholeText() {
...
__name(requireComment, "requireComment");
...
__name(requireDocumentFragment, "requireDocumentFragment");
...
__name(requireProcessingInstruction, "requireProcessingInstruction");
var NodeFilter_1;
...
__name(requireNodeFilter, "requireNodeFilter");
var NodeTraversal = {
  exports: {}
};
...
function requireNodeTraversal() {
  ...
  __name(nextSkippingChildren, "nextSkippingChildren");
  ...
  __name(nextAncestorSibling, "nextAncestorSibling");
  ...
  __name(deepLastChild, "deepLastChild");
...
__name(requireNodeTraversal, "requireNodeTraversal");
var TreeWalker_1;
...
function requireTreeWalker() {
  ...
  Object.defineProperties(TreeWalker.prototype, {
    ...
    currentNode: {
      get: /* @__PURE__ */ __name(function currentNode() {
        return this._currentNode;
      }, "currentNode"),
      set: /* @__PURE__ */ __name(function setCurrentNode(v) {
     ...
     */
    _internalFilter: {
      value: /* @__PURE__ */ __name(function _internalFilter(node2) {
        var result2, filter2;
        if (this._active) {
          utils2.InvalidStateError();
        }
     ...
     */
    parentNode: {
      value: /* @__PURE__ */ __name(function parentNode() {
     ...
     */
    firstChild: {
      value: /* @__PURE__ */ __name(function firstChild() {
     ...
     */
    lastChild: {
      value: /* @__PURE__ */ __name(function lastChild() {
     ...
     */
    previousSibling: {
      value: /* @__PURE__ */ __name(function previousSibling() {
     ...
     */
    nextSibling: {
      value: /* @__PURE__ */ __name(function nextSibling() {
     ...
     */
    previousNode: {
      value: /* @__PURE__ */ __name(function previousNode() {
     ...
     */
    nextNode: {
      value: /* @__PURE__ */ __name(function nextNode() {
...
__name(requireTreeWalker, "requireTreeWalker");
var NodeIterator_1;
...
function requireNodeIterator() {
  ...
  __name(NodeIterator, "NodeIterator");
  Object.defineProperties(NodeIterator.prototype, {
    root: {
      get: /* @__PURE__ */ __name(function root2() {
        return this._root;
      }, "root")
    },
    referenceNode: {
      get: /* @__PURE__ */ __name(function referenceNode() {
        return this._referenceNode;
      }, "referenceNode")
    },
    pointerBeforeReferenceNode: {
      get: /* @__PURE__ */ __name(function pointerBeforeReferenceNode() {
        return this._pointerBeforeReferenceNode;
      }, "pointerBeforeReferenceNode")
    },
    whatToShow: {
      get: /* @__PURE__ */ __name(function whatToShow() {
        return this._whatToShow;
      }, "whatToShow")
    },
    filter: {
      get: /* @__PURE__ */ __name(function filter2() {
        return this._filter;
      }, "filter")
    },
    /**
     ...
     */
    _preremove: {
      value: /* @__PURE__ */ __name(function _preremove(toBeRemovedNode) {
     ...
     */
    detach: {
      value: /* @__PURE__ */ __name(function detach() {
      }, "detach")
    },
    /** For compatibility with web-platform-tests. */
    toString: {
...
__name(requireNodeIterator, "requireNodeIterator");
var URL_1;
var hasRequiredURL;
function requireURL() {
  ...
  URL2.prototype = {
    ...
    isAbsolute: /* @__PURE__ */ __name(function() {
      return !!this.scheme;
    }, "isAbsolute"),
    isAuthorityBased: /* @__PURE__ */ __name(function() {
      return URL2.authorityPattern.test(this.url);
    }, "isAuthorityBased"),
    isHierarchical: /* @__PURE__ */ __name(function() {
    ...
    resolve: /* @__PURE__ */ __name(function(relative2) {
      var base = this;
...
__name(requireCustomEvent, "requireCustomEvent");
var events;
...
__name(requireStyle_parser, "requireStyle_parser");
...
function requireCSSStyleDeclaration() {
  ...
  CSSStyleDeclaration_1 = /* @__PURE__ */ __name(function(elt) {
    const style = new CSSStyleDeclaration(elt);
    const handler = {
      get: /* @__PURE__ */ __name(function(target, property) {
        return property in target ? target[property] : target.getPropertyValue(dasherizeProperty(property));
      }, "get"),
      has: /* @__PURE__ */ __name(function(target, key) {
        return true;
      }, "has"),
      set: /* @__PURE__ */ __name(function(target, property, value) {
  ...
  __name(dasherizeProperty, "dasherizeProperty");
  ...
  CSSStyleDeclaration.prototype = Object.create(Object.prototype, {
    ...
    getPropertyValue: {
      value: /* @__PURE__ */ __name(function(property) {
    ...
    setProperty: {
      value: /* @__PURE__ */ __name(function(property, value, priority) {
        property = property.toLowerCase();
    ...
    setPropertyValue: {
      value: /* @__PURE__ */ __name(function(property, value) {
        return this.setProperty(property, value, NO_CHANGE);
      }, "value")
    },
    setPropertyPriority: {
      value: /* @__PURE__ */ __name(function(property, priority) {
...
__name(requireCSSStyleDeclaration, "requireCSSStyleDeclaration");
var URLUtils_1;
  ...
  URLUtils.prototype = Object.create(Object.prototype, {
    ...
    origin: {
      get: /* @__PURE__ */ __name(function() {
        ...
        var originForPort = /* @__PURE__ */ __name(function(defaultPort) {
...
__name(requireURLUtils, "requireURLUtils");
var defineElement;
...
function requireDefineElement() {
  ...
  var attributes2 = requireAttributes();
  var isApiWritable = requireConfig().isApiWritable;
  defineElement = /* @__PURE__ */ __name(function(spec, defaultConstructor, tagList, tagNameToImpl) {
    var c = spec.ctor;
    if (c) {
  ...
  __name(EventHandlerBuilder, "EventHandlerBuilder");
  ...
  __name(EventHandlerChangeHandler, "EventHandlerChangeHandler");
  ...
  __name(addEventHandlers, "addEventHandlers");
  return defineElement;
}
__name(requireDefineElement, "requireDefineElement");
...
function requireHtmlelts() {
  ...
  var HTMLFormElement = /* @__PURE__ */ __name(function(doc, localName, prefix) {
  ...
  var HTMLElement = htmlelts.HTMLElement = define({
    superclass: Element2,
    name: "HTMLElement",
    ctor: /* @__PURE__ */ __name(function HTMLElement2(doc, localName, prefix) {
  ...
  var HTMLUnknownElement = define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLUnknownElement2(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLUnknownElement")
  });
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLAnchorElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLAnchorElement"),
    props: {
      _post_click_activation_steps: {
        value: /* @__PURE__ */ __name(function(e) {
          if (this.href) {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLAreaElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLAreaElement"),
    attributes: {
      alt: String,
  ...
  define({
    tag: "br",
    name: "HTMLBRElement",
    ctor: /* @__PURE__ */ __name(function HTMLBRElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLBRElement"),
    attributes: {
      // Obsolete
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLBaseElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLBaseElement"),
    attributes: {
      "target": String
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLBodyElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLBodyElement"),
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLButtonElement(doc, localName, prefix) {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLDListElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLDListElement"),
    attributes: {
      // Obsolete
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLDataElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLDataElement"),
    attributes: {
      value: String
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLDataListElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLDataListElement")
  });
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLDetailsElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLDetailsElement"),
    attributes: {
      "open": Boolean
  ...
  define({
    tag: "div",
    name: "HTMLDivElement",
    ctor: /* @__PURE__ */ __name(function HTMLDivElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLDivElement"),
    attributes: {
      // Obsolete
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLEmbedElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLEmbedElement"),
    attributes: {
      src: URL2,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLFieldSetElement(doc, localName, prefix) {
      HTMLFormElement.call(this, doc, localName, prefix);
    }, "HTMLFieldSetElement"),
    props: formAssociatedProps,
    attributes: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLFormElement2(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLFormElement"),
    attributes: {
      action: String,
  ...
  define({
    tag: "hr",
    name: "HTMLHRElement",
    ctor: /* @__PURE__ */ __name(function HTMLHRElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLHRElement"),
    attributes: {
      // Obsolete
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLHeadElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLHeadElement")
  });
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLHeadingElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLHeadingElement"),
    attributes: {
      // Obsolete
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLHtmlElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLHtmlElement"),
    attributes: {
      xmlns: URL2,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLIFrameElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLIFrameElement"),
    attributes: {
      src: URL2,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLImageElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLImageElement"),
    attributes: {
      alt: String,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLInputElement(doc, localName, prefix) {
      HTMLFormElement.call(this, doc, localName, prefix);
    }, "HTMLInputElement"),
    props: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLKeygenElement(doc, localName, prefix) {
      HTMLFormElement.call(this, doc, localName, prefix);
    }, "HTMLKeygenElement"),
    props: formAssociatedProps,
    attributes: {
  ...
  define({
    tag: "li",
    name: "HTMLLIElement",
    ctor: /* @__PURE__ */ __name(function HTMLLIElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLLIElement"),
    attributes: {
      value: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLLabelElement(doc, localName, prefix) {
      HTMLFormElement.call(this, doc, localName, prefix);
    }, "HTMLLabelElement"),
    props: formAssociatedProps,
    attributes: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLLegendElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLLegendElement"),
    attributes: {
      // Obsolete
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLLinkElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLLinkElement"),
    attributes: {
  ...
  define({
    tag: "map",
    name: "HTMLMapElement",
    ctor: /* @__PURE__ */ __name(function HTMLMapElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLMapElement"),
    attributes: {
      name: String
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLMenuElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLMenuElement"),
    attributes: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLMetaElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLMetaElement"),
    attributes: {
      name: String,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLMeterElement(doc, localName, prefix) {
      HTMLFormElement.call(this, doc, localName, prefix);
    }, "HTMLMeterElement"),
    props: formAssociatedProps
  });
  define({
    tags: ["ins", "del"],
    name: "HTMLModElement",
    ctor: /* @__PURE__ */ __name(function HTMLModElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLModElement"),
    attributes: {
      cite: URL2,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLOListElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLOListElement"),
    props: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLObjectElement(doc, localName, prefix) {
      HTMLFormElement.call(this, doc, localName, prefix);
    }, "HTMLObjectElement"),
    props: formAssociatedProps,
    attributes: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLOptGroupElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLOptGroupElement"),
    attributes: {
      disabled: Boolean,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLOptionElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLOptionElement"),
    props: {
      form: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLOutputElement(doc, localName, prefix) {
      HTMLFormElement.call(this, doc, localName, prefix);
    }, "HTMLOutputElement"),
    props: formAssociatedProps,
    attributes: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLParagraphElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLParamElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLParamElement"),
    attributes: {
      name: String,
  ...
  define({
    ...
    name: "HTMLPreElement",
    ctor: /* @__PURE__ */ __name(function HTMLPreElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLPreElement"),
    attributes: {
      // Obsolete
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLProgressElement(doc, localName, prefix) {
      HTMLFormElement.call(this, doc, localName, prefix);
    }, "HTMLProgressElement"),
    props: formAssociatedProps,
    attributes: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLQuoteElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLQuoteElement"),
    attributes: {
      cite: URL2
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLScriptElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLScriptElement"),
    props: {
      text: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLSelectElement(doc, localName, prefix) {
      HTMLFormElement.call(this, doc, localName, prefix);
    }, "HTMLSelectElement"),
    props: {
      form: formAssociatedProps.form,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLSpanElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLSpanElement")
  });
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLStyleElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLStyleElement"),
    attributes: {
      media: String,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLTableCaptionElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLTableCellElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLTableColElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLTableColElement"),
    attributes: {
      span: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLTableElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLTableElement"),
    props: {
      rows: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLTemplateElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLTableRowElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLTableRowElement"),
    props: {
      cells: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLTableSectionElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLTextAreaElement(doc, localName, prefix) {
      HTMLFormElement.call(this, doc, localName, prefix);
    }, "HTMLTextAreaElement"),
    props: {
      form: formAssociatedProps.form,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLTimeElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLTimeElement"),
    attributes: {
      dateTime: String,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLTitleElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLTitleElement"),
    props: {
      text: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLUListElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLUListElement"),
    attributes: {
      type: String,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLMediaElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLMediaElement"),
    attributes: {
      src: URL2,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLAudioElement(doc, localName, prefix) {
  ...
  define({
    ...
    tag: "video",
    superclass: htmlElements.HTMLMediaElement,
    ctor: /* @__PURE__ */ __name(function HTMLVideoElement(doc, localName, prefix) {
      htmlElements.HTMLMediaElement.call(this, doc, localName, prefix);
    }, "HTMLVideoElement"),
    attributes: {
      poster: URL2,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLTableDataCellElement(doc, localName, prefix) {
  ...
  define({
    ...
    superclass: htmlElements.HTMLTableCellElement,
    ctor: /* @__PURE__ */ __name(function HTMLTableHeaderCellElement(doc, localName, prefix) {
      htmlElements.HTMLTableCellElement.call(this, doc, localName, prefix);
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLFrameSetElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLFrameSetElement")
  });
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLFrameElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLFrameElement")
  });
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLCanvasElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLCanvasElement"),
    props: {
      getContext: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLDialogElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLDialogElement"),
    props: {
      show: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLMenuItemElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLMenuItemElement"),
    props: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLSourceElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLSourceElement"),
    attributes: {
      srcset: String,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLTrackElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLTrackElement"),
    attributes: {
      src: URL2,
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLFontElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
    }, "HTMLFontElement"),
    attributes: {
      color: {
  ...
  define({
    ...
    ctor: /* @__PURE__ */ __name(function HTMLDirectoryElement(doc, localName, prefix) {
      HTMLElement.call(this, doc, localName, prefix);
...
__name(requireHtmlelts, "requireHtmlelts");
var svg = {};
var hasRequiredSvg;
function requireSvg() {
  ...
  (function(exports) {
    ...
    var SVGElement = define({
      superclass: Element2,
      name: "SVGElement",
      ctor: /* @__PURE__ */ __name(function SVGElement2(doc, localName, prefix) {
    ...
    define({
      name: "SVGSVGElement",
      ctor: /* @__PURE__ */ __name(function SVGSVGElement(doc, localName, prefix) {
...
__name(requireMutationConstants, "requireMutationConstants");
var Document_1;
...
function requireDocument() {
  ...
  var mirrorAttr = /* @__PURE__ */ __name(function(f, name, defaultValue) {
    return {
      get: /* @__PURE__ */ __name(function() {
        var o = f.call(this);
        if (o) {
  ...
  Document2.prototype = Object.create(ContainerNode.prototype, {
    ...
    _setMutationHandler: {
      value: /* @__PURE__ */ __name(function(handler) {
    ...
    _dispatchRendererEvent: {
      value: /* @__PURE__ */ __name(function(targetNid, type, details) {
    ...
    createAttributeNS: {
      value: /* @__PURE__ */ __name(function(namespace, qualifiedName) {
    ...
    _createElementNS: {
      value: /* @__PURE__ */ __name(function(localName, namespace, prefix) {
    ...
    createEvent: {
      value: /* @__PURE__ */ __name(function createEvent(interfaceName) {
    ...
    createTreeWalker: {
      value: /* @__PURE__ */ __name(function(root3, whatToShow, filter2) {
        if (!root3) {
    ...
    _attachNodeIterator: {
      value: /* @__PURE__ */ __name(function(ni) {
    ...
    _preremoveNodeIterators: {
      value: /* @__PURE__ */ __name(function(toBeRemoved) {
        if (this._nodeIterators) {
    ...
    _updateDocTypeElement: {
      value: /* @__PURE__ */ __name(function _updateDocTypeElement() {
    ...
    insertBefore: {
      value: /* @__PURE__ */ __name(function insertBefore(child, refChild) {
    ...
    adoptNode: {
      value: /* @__PURE__ */ __name(function adoptNode(node2) {
    ...
    importNode: {
      value: /* @__PURE__ */ __name(function importNode(node2, deep) {
    ...
    origin: {
      get: /* @__PURE__ */ __name(function origin() {
        return null;
      }, "origin")
    },
    characterSet: {
      get: /* @__PURE__ */ __name(function characterSet() {
        return "UTF-8";
      }, "characterSet")
    },
    contentType: {
      get: /* @__PURE__ */ __name(function contentType() {
        return this._contentType;
      }, "contentType")
    },
    URL: {
      get: /* @__PURE__ */ __name(function URL3() {
        return this._address;
      }, "URL")
    },
    domain: {
    ...
    writeln: {
      value: /* @__PURE__ */ __name(function writeln(args) {
    ...
    mutateAttr: {
      value: /* @__PURE__ */ __name(function(attr, oldval) {
        if (this.mutationHandler) {
          this.mutationHandler({
            type: MUTATE.ATTR,
    ...
    addId: {
      value: /* @__PURE__ */ __name(function addId(id, n) {
    ...
    delId: {
      value: /* @__PURE__ */ __name(function delId(id, n) {
        var val = this.byId[id];
        utils2.assert(val);
        if (val instanceof MultiId) {
          val.del(n);
    ...
    _resolve: {
      value: /* @__PURE__ */ __name(function(href) {
  ...
  __name(namedHTMLChild, "namedHTMLChild");
  function root2(n) {
  ...
  __name(recursivelySetOwner, "recursivelySetOwner");
...
__name(requireDocument, "requireDocument");
var DocumentType_1;
...
__name(requireDocumentType, "requireDocumentType");
var HTMLParser_1;
...
function requireHTMLParser() {
  ...
  __name(adjustSVGTagName, "adjustSVGTagName");
  ...
  __name(adjustSVGAttributes, "adjustSVGAttributes");
  ...
  __name(adjustMathMLAttributes, "adjustMathMLAttributes");
  ...
  __name(adjustForeignAttributes, "adjustForeignAttributes");
  ...
  __name(transferAttributes, "transferAttributes");
  HTMLParser.ElementStack = /* @__PURE__ */ __name(function ElementStack() {
    this.elements = [];
    this.top = null;
  }, "ElementStack");
  ...
  HTMLParser.ActiveFormattingElements = /* @__PURE__ */ __name(function AFE() {
    this.list = [];
    this.attrs = [];
  }, "AFE");
  ...
  function HTMLParser(address, fragmentContext, options) {
    ...
    var htmlparser = {
      ...
      // from document.write()
      parse: /* @__PURE__ */ __name(function(s, end, shouldPauseFunc) {
        var moreToDo;
        if (paused > 0) {
          leftovers += s;
          return true;
    ...
    __name(handleSimpleAttribute, "handleSimpleAttribute");
    function beginTagName() {
      is_end_tag = false;
      tagnamebuf = "";
      attributes2.length = 0;
    }
    __name(beginTagName, "beginTagName");
    function beginEndTagName() {
      is_end_tag = true;
      tagnamebuf = "";
      attributes2.length = 0;
    }
    __name(beginEndTagName, "beginEndTagName");
    function beginTempBuf() {
      tempbuf.length = 0;
    }
    __name(beginTempBuf, "beginTempBuf");
    function beginAttrName() {
      attrnamebuf = "";
    }
    __name(beginAttrName, "beginAttrName");
    function beginAttrValue() {
      attrvaluebuf = "";
    }
    __name(beginAttrValue, "beginAttrValue");
    function beginComment() {
      commentbuf.length = 0;
    }
    __name(beginComment, "beginComment");
    function beginDoctype() {
      doctypenamebuf.length = 0;
      doctypepublicbuf = null;
      doctypesystembuf = null;
    }
    __name(beginDoctype, "beginDoctype");
    function beginDoctypePublicId() {
      doctypepublicbuf = [];
    }
    __name(beginDoctypePublicId, "beginDoctypePublicId");
    function beginDoctypeSystemId() {
      doctypesystembuf = [];
    }
    __name(beginDoctypeSystemId, "beginDoctypeSystemId");
    function forcequirks() {
      force_quirks = true;
    }
    __name(forcequirks, "forcequirks");
    function cdataAllowed() {
      return stack.top && stack.top.namespaceURI !== "http://www.w3.org/1999/xhtml";
    }
    __name(cdataAllowed, "cdataAllowed");
    function appropriateEndTag(buf) {
      return lasttagname === buf;
    }
    __name(appropriateEndTag, "appropriateEndTag");
    function flushText() {
      if (textrun.length > 0) {
    ...
    __name(getMatchingChars, "getMatchingChars");
    ...
    __name(emitCharsWhile, "emitCharsWhile");
    ...
    __name(emitCharString, "emitCharString");
    function emitTag() {
    ...
    __name(emitSimpleTag, "emitSimpleTag");
    ...
    __name(emitSelfClosingTag, "emitSelfClosingTag");
    ...
    __name(emitDoctype, "emitDoctype");
    function emitEOF() {
      flushText();
      parser2(EOF);
      doc.modclock = 1;
    }
    __name(emitEOF, "emitEOF");
    var insertToken = htmlparser.insertToken = /* @__PURE__ */ __name(function insertToken2(t, value, arg3, arg4) {
      flushText();
    ...
    __name(createHTMLElt, "createHTMLElt");
    ...
    __name(insertHTMLElement, "insertHTMLElement");
    ...
    __name(insertElement, "insertElement");
    ...
    __name(insertForeignElement, "insertForeignElement");
    ...
    __name(lastElementOfType, "lastElementOfType");
    ...
    __name(fosterParent, "fosterParent");
    ...
    __name(resetInsertionMode, "resetInsertionMode");
    ...
    __name(parseRCDATA, "parseRCDATA");
    ...
    __name(afereconstruct, "afereconstruct");
    var BOOKMARK = {
      localName: "BM"
    };
    ...
    __name(adoptionAgency, "adoptionAgency");
    function handleScriptEnd() {
      stack.pop();
      parser2 = originalInsertionMode;
      return;
    }
    __name(handleScriptEnd, "handleScriptEnd");
    ...
    __name(rcdata_state, "rcdata_state");
    ...
    __name(rawtext_state, "rawtext_state");
    ...
    __name(script_data_state, "script_data_state");
    ...
    __name(plaintext_state, "plaintext_state");
    ...
    __name(tag_open_state, "tag_open_state");
    ...
    __name(end_tag_open_state, "end_tag_open_state");
    ...
    __name(tag_name_state, "tag_name_state");
    ...
    __name(rcdata_less_than_sign_state, "rcdata_less_than_sign_state");
    ...
    __name(rcdata_end_tag_open_state, "rcdata_end_tag_open_state");
    ...
    __name(rcdata_end_tag_name_state, "rcdata_end_tag_name_state");
    ...
    __name(rawtext_less_than_sign_state, "rawtext_less_than_sign_state");
    ...
    __name(rawtext_end_tag_open_state, "rawtext_end_tag_open_state");
    ...
    __name(rawtext_end_tag_name_state, "rawtext_end_tag_name_state");
    ...
    __name(script_data_less_than_sign_state, "script_data_less_than_sign_state");
    ...
    __name(script_data_end_tag_open_state, "script_data_end_tag_open_state");
    ...
    __name(script_data_end_tag_name_state, "script_data_end_tag_name_state");
    ...
    __name(script_data_escape_start_state, "script_data_escape_start_state");
    ...
    __name(script_data_escape_start_dash_state, "script_data_escape_start_dash_state");
    ...
    __name(script_data_escaped_state, "script_data_escaped_state");
    ...
    __name(script_data_escaped_dash_state, "script_data_escaped_dash_state");
    ...
    __name(script_data_escaped_dash_dash_state, "script_data_escaped_dash_dash_state");
    ...
    __name(script_data_escaped_less_than_sign_state, "script_data_escaped_less_than_sign_state");
    ...
    __name(script_data_escaped_end_tag_open_state, "script_data_escaped_end_tag_open_state");
    ...
    __name(script_data_escaped_end_tag_name_state, "script_data_escaped_end_tag_name_state");
    ...
    __name(script_data_double_escape_start_state, "script_data_double_escape_start_state");
    ...
    __name(script_data_double_escaped_state, "script_data_double_escaped_state");
    ...
    __name(script_data_double_escaped_dash_state, "script_data_double_escaped_dash_state");
    ...
    __name(script_data_double_escaped_dash_dash_state, "script_data_double_escaped_dash_dash_state");
    ...
    __name(script_data_double_escaped_less_than_sign_state, "script_data_double_escaped_less_than_sign_state");
    ...
    __name(script_data_double_escape_end_state, "script_data_double_escape_end_state");
    ...
    __name(before_attribute_name_state, "before_attribute_name_state");
    ...
    __name(attribute_name_state, "attribute_name_state");
    ...
    __name(after_attribute_name_state, "after_attribute_name_state");
    ...
    __name(before_attribute_value_state, "before_attribute_value_state");
    ...
    __name(attribute_value_double_quoted_state, "attribute_value_double_quoted_state");
    ...
    __name(attribute_value_single_quoted_state, "attribute_value_single_quoted_state");
    ...
    __name(attribute_value_unquoted_state, "attribute_value_unquoted_state");
    ...
    __name(after_attribute_value_quoted_state, "after_attribute_value_quoted_state");
    ...
    __name(self_closing_start_tag_state, "self_closing_start_tag_state");
    ...
    __name(bogus_comment_state, "bogus_comment_state");
    ...
    __name(markup_declaration_open_state, "markup_declaration_open_state");
    ...
    __name(comment_start_state, "comment_start_state");
    ...
    __name(comment_start_dash_state, "comment_start_dash_state");
    ...
    __name(comment_state, "comment_state");
    ...
    __name(comment_less_than_sign_state, "comment_less_than_sign_state");
    ...
    __name(comment_less_than_sign_bang_state, "comment_less_than_sign_bang_state");
    ...
    __name(comment_less_than_sign_bang_dash_state, "comment_less_than_sign_bang_dash_state");
    ...
    __name(comment_less_than_sign_bang_dash_dash_state, "comment_less_than_sign_bang_dash_dash_state");
    ...
    __name(comment_end_dash_state, "comment_end_dash_state");
    ...
    __name(comment_end_state, "comment_end_state");
    ...
    __name(comment_end_bang_state, "comment_end_bang_state");
    ...
    __name(doctype_state, "doctype_state");
    ...
    __name(before_doctype_name_state, "before_doctype_name_state");
    ...
    __name(doctype_name_state, "doctype_name_state");
    ...
    __name(after_doctype_name_state, "after_doctype_name_state");
    ...
    __name(after_doctype_public_keyword_state, "after_doctype_public_keyword_state");
    ...
    __name(before_doctype_public_identifier_state, "before_doctype_public_identifier_state");
    ...
    __name(doctype_public_identifier_double_quoted_state, "doctype_public_identifier_double_quoted_state");
    ...
    __name(doctype_public_identifier_single_quoted_state, "doctype_public_identifier_single_quoted_state");
    ...
    __name(after_doctype_public_identifier_state, "after_doctype_public_identifier_state");
    ...
    __name(between_doctype_public_and_system_identifiers_state, "between_doctype_public_and_system_identifiers_state");
    ...
    __name(after_doctype_system_keyword_state, "after_doctype_system_keyword_state");
    ...
    __name(before_doctype_system_identifier_state, "before_doctype_system_identifier_state");
    ...
    __name(doctype_system_identifier_double_quoted_state, "doctype_system_identifier_double_quoted_state");
    ...
    __name(doctype_system_identifier_single_quoted_state, "doctype_system_identifier_single_quoted_state");
    ...
    __name(after_doctype_system_identifier_state, "after_doctype_system_identifier_state");
    ...
    __name(bogus_doctype_state, "bogus_doctype_state");
    ...
    __name(cdata_section_state, "cdata_section_state");
    ...
    __name(cdata_section_bracket_state, "cdata_section_bracket_state");
    ...
    __name(cdata_section_end_state, "cdata_section_end_state");
    ...
    __name(character_reference_state, "character_reference_state");
    ...
    __name(named_character_reference_state, "named_character_reference_state");
    ...
    __name(numeric_character_reference_state, "numeric_character_reference_state");
    ...
    __name(hexadecimal_character_reference_start_state, "hexadecimal_character_reference_start_state");
    ...
    __name(decimal_character_reference_start_state, "decimal_character_reference_start_state");
    ...
    __name(hexadecimal_character_reference_state, "hexadecimal_character_reference_state");
    ...
    __name(decimal_character_reference_state, "decimal_character_reference_state");
    ...
    __name(numeric_character_reference_end_state, "numeric_character_reference_end_state");
    ...
    __name(character_reference_end_state, "character_reference_end_state");
    ...
    __name(initial_mode, "initial_mode");
    ...
    __name(before_html_mode, "before_html_mode");
    ...
    __name(before_head_mode, "before_head_mode");
    ...
    __name(in_head_mode, "in_head_mode");
    ...
    __name(in_head_noscript_mode, "in_head_noscript_mode");
    ...
    __name(after_head_mode, "after_head_mode");
    ...
    __name(in_body_mode, "in_body_mode");
    ...
    function in_table_mode(t, value, arg3, arg4) {
      ...
      __name(getTypeAttr, "getTypeAttr");
      switch (t) {
        case 1:
    ...
    __name(in_table_mode, "in_table_mode");
    ...
    __name(in_table_text_mode, "in_table_text_mode");
    function in_caption_mode(t, value, arg3, arg4) {
      ...
      __name(end_caption, "end_caption");
      switch (t) {
        case 2:
          switch (value) {
            case "caption":
    ...
    __name(in_caption_mode, "in_caption_mode");
    ...
    __name(in_column_group_mode, "in_column_group_mode");
    ...
    __name(in_table_body_mode, "in_table_body_mode");
    ...
    __name(in_row_mode, "in_row_mode");
    ...
    __name(in_cell_mode, "in_cell_mode");
    ...
    __name(in_select_mode, "in_select_mode");
    ...
    __name(in_select_in_table_mode, "in_select_in_table_mode");
    function in_template_mode(t, value, arg3, arg4) {
      ...
      __name(switchModeAndReprocess, "switchModeAndReprocess");
      switch (t) {
        case 1:
        // TEXT
        case 4:
    ...
    __name(in_template_mode, "in_template_mode");
    ...
    __name(after_body_mode, "after_body_mode");
    ...
    __name(in_frameset_mode, "in_frameset_mode");
    ...
    __name(after_frameset_mode, "after_frameset_mode");
    ...
    __name(after_after_body_mode, "after_after_body_mode");
    ...
    __name(after_after_frameset_mode, "after_after_frameset_mode");
    ...
    __name(insertForeignToken, "insertForeignToken");
    htmlparser.testTokenizer = function(input2, initialState, lastStartTag, charbychar) {
      ...
      insertToken = /* @__PURE__ */ __name(function(t, value, arg3, arg4) {
        flushText();
        switch (t) {
          case 1:
...
__name(requireHTMLParser, "requireHTMLParser");
...
function requireDOMImplementation() {
  ...
  DOMImplementation.prototype = {
    hasFeature: /* @__PURE__ */ __name(function hasFeature(feature, version) {
      var f = supportedFeatures[(feature || "").toLowerCase()];
      return f && f[version || ""] || false;
    }, "hasFeature"),
    createDocumentType: /* @__PURE__ */ __name(function createDocumentType(qualifiedName, publicId, systemId) {
      if (!xml.isValidQName(qualifiedName)) utils2.InvalidCharacterError();
      return new DocumentType(this.contextObject, qualifiedName, publicId, systemId);
    }, "createDocumentType"),
    createDocument: /* @__PURE__ */ __name(function createDocument2(namespace, qualifiedName, doctype) {
    ...
    createHTMLDocument: /* @__PURE__ */ __name(function createHTMLDocument(titleText) {
    ...
    mozSetOutputMutationHandler: /* @__PURE__ */ __name(function(doc, handler) {
      doc.mutationHandler = handler;
    }, "mozSetOutputMutationHandler"),
    mozGetInputMutationHandler: /* @__PURE__ */ __name(function(doc) {
      utils2.nyi();
    }, "mozGetInputMutationHandler"),
    mozHTMLParser: HTMLParser
  };
  return DOMImplementation_1;
}
__name(requireDOMImplementation, "requireDOMImplementation");
var Location_1;
...
function requireLocation() {
  ...
  Location.prototype = Object.create(URLUtils.prototype, {
    ...
    assign: {
      value: /* @__PURE__ */ __name(function(url) {
...
__name(requireNavigatorID, "requireNavigatorID");
var WindowTimers_1;
...
__name(requireWindowTimers, "requireWindowTimers");
var impl = {
  exports: {}
};
var hasRequiredImpl;
...
__name(requireImpl, "requireImpl");
var Window_1;
...
function requireWindow() {
  ...
  Window.prototype = Object.create(EventTarget.prototype, {
    ...
    getComputedStyle: {
      value: /* @__PURE__ */ __name(function getComputedStyle(elt) {
        return elt.style;
      }, "getComputedStyle")
    }
  });
...
__name(requireWindow, "requireWindow");
var hasRequiredLib;
function requireLib() {
  ...
  (function(exports) {
    ...
    exports.createIncrementalHTMLParser = function() {
      ...
      return {
        ...
        write: /* @__PURE__ */ __name(function(s) {
          if (s.length > 0) {
         ...
         */
        end: /* @__PURE__ */ __name(function(s) {
         ...
         * ```
         */
        process: /* @__PURE__ */ __name(function(shouldPauseFunc) {
...
__name(setDomTypes, "setDomTypes");
...
var _DominoAdapter = class _DominoAdapter extends BrowserDomAdapter {
  static makeCurrent() {
    setDomTypes();
...
__name(_DominoAdapter, "DominoAdapter");
__publicField(_DominoAdapter, "defaultDoc");
var DominoAdapter = _DominoAdapter;
...
__name(_PlatformState, "PlatformState");
__publicField(_PlatformState, "ɵfac", /* @__PURE__ */ __name(function PlatformState_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _PlatformState)(ɵɵinject(DOCUMENT));
}, "PlatformState_Factory"));
__publicField(_PlatformState, "ɵprov", ɵɵdefineInjectable({
...
__name(enableDomEmulation, "enableDomEmulation");
...
__name(_ServerXhr, "ServerXhr");
__publicField(_ServerXhr, "ɵfac", /* @__PURE__ */ __name(function ServerXhr_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ServerXhr)();
}, "ServerXhr_Factory"));
__publicField(_ServerXhr, "ɵprov", ɵɵdefineInjectable({
  token: _ServerXhr,
...
__name(relativeUrlsTransformerInterceptorFn, "relativeUrlsTransformerInterceptorFn");
...
__name(_ServerPlatformLocation, "ServerPlatformLocation");
__publicField(_ServerPlatformLocation, "ɵfac", /* @__PURE__ */ __name(function ServerPlatformLocation_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ServerPlatformLocation)(ɵɵinject(DOCUMENT), ɵɵinject(INITIAL_CONFIG, 8));
}, "ServerPlatformLocation_Factory"));
__publicField(_ServerPlatformLocation, "ɵprov", ɵɵdefineInjectable({
...
__name(_ServerEventManagerPlugin, "ServerEventManagerPlugin");
__publicField(_ServerEventManagerPlugin, "ɵfac", /* @__PURE__ */ __name(function ServerEventManagerPlugin_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ServerEventManagerPlugin)(ɵɵinject(DOCUMENT));
}, "ServerEventManagerPlugin_Factory"));
__publicField(_ServerEventManagerPlugin, "ɵprov", ɵɵdefineInjectable({
...
__name(warnIfStateTransferHappened, "warnIfStateTransferHappened");
...
__name(serializeTransferStateFactory, "serializeTransferStateFactory");
...
__name(initDominoAdapter, "initDominoAdapter");
...
__name(_ServerModule, "ServerModule");
__publicField(_ServerModule, "ɵfac", /* @__PURE__ */ __name(function ServerModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ServerModule)();
}, "ServerModule_Factory"));
__publicField(_ServerModule, "ɵmod", ɵɵdefineNgModule({
  type: _ServerModule,
  exports: [BrowserModule]
}));
__publicField(_ServerModule, "ɵinj", ɵɵdefineInjector({
...
__name(platformServer, "platformServer");
...
__name(provideServerRendering, "provideServerRendering");
...
__name(createServerPlatform, "createServerPlatform");
function findEventDispatchScript(doc) {
  return doc.getElementById(EVENT_DISPATCH_SCRIPT_ID);
}
__name(findEventDispatchScript, "findEventDispatchScript");
function removeEventDispatchScript(doc) {
  findEventDispatchScript(doc)?.remove();
}
__name(removeEventDispatchScript, "removeEventDispatchScript");
...
__name(prepareForHydration, "prepareForHydration");
...
__name(appendSsrContentIntegrityMarker, "appendSsrContentIntegrityMarker");
...
__name(appendServerContextInfo, "appendServerContextInfo");
...
__name(insertEventRecordScript, "insertEventRecordScript");
...
__name(asyncDestroyPlatform, "asyncDestroyPlatform");
...
__name(sanitizeServerContext, "sanitizeServerContext");
...
__name(renderModule, "renderModule");
...
var parse$3 = /* @__PURE__ */ __name(function(p) {
...
__name(requirePicocolors_browser, "requirePicocolors_browser");
...
function requireCssSyntaxError() {
  ...
  const _CssSyntaxError = class _CssSyntaxError extends Error {
...
__name(requireCssSyntaxError, "requireCssSyntaxError");
var stringifier;
...
function requireStringifier() {
  ...
  const _Stringifier = class _Stringifier {
    constructor(builder) {
  ...
  let Stringifier = _Stringifier;
  stringifier = Stringifier;
  Stringifier.default = Stringifier;
  return stringifier;
}
__name(requireStringifier, "requireStringifier");
var stringify_1;
...
__name(requireStringify, "requireStringify");
var symbols = {};
...
__name(requireSymbols, "requireSymbols");
var node;
...
__name(requireNode$1, "requireNode$1");
var comment;
...
function requireComment2() {
  ...
  const _Comment2 = class _Comment2 extends Node2 {
    constructor(defaults) {
      super(defaults);
      this.type = "comment";
    }
  };
  __name(_Comment2, "Comment");
  let Comment2 = _Comment2;
  comment = Comment2;
  Comment2.default = Comment2;
  return comment;
}
__name(requireComment2, "requireComment");
var declaration;
...
function requireDeclaration() {
  ...
  let Node2 = requireNode$1();
  const _Declaration = class _Declaration extends Node2 {
    get variable() {
...
__name(requireDeclaration, "requireDeclaration");
var container;
...
function requireContainer$1() {
  ...
  const _Container = class _Container extends Node2 {
    get first() {
...
__name(requireContainer$1, "requireContainer$1");
var atRule;
...
function requireAtRule() {
  ...
  const _AtRule = class _AtRule extends Container2 {
    constructor(defaults) {
      super(defaults);
      this.type = "atrule";
    }
...
__name(requireAtRule, "requireAtRule");
var document;
...
function requireDocument2() {
  ...
  const _Document2 = class _Document2 extends Container2 {
    constructor(defaults) {
  ...
  __name(_Document2, "Document");
  let Document2 = _Document2;
...
__name(requireDocument2, "requireDocument");
var nonSecure;
...
__name(requireNonSecure, "requireNonSecure");
var previousMap;
...
function requirePreviousMap() {
  ...
  const _PreviousMap = class _PreviousMap {
...
__name(requirePreviousMap, "requirePreviousMap");
var input;
...
__name(requireInput, "requireInput");
var root;
var hasRequiredRoot;
function requireRoot() {
  ...
  let Container2 = requireContainer$1();
  let LazyResult, Processor;
  const _Root = class _Root extends Container2 {
    constructor(defaults) {
      super(defaults);
      this.type = "root";
...
__name(requireRoot, "requireRoot");
var list_1;
var hasRequiredList;
...
__name(requireList, "requireList");
var rule;
var hasRequiredRule;
function requireRule() {
  ...
  const _Rule = class _Rule extends Container2 {
    get selectors() {
...
__name(requireRule, "requireRule");
var fromJSON_1;
...
__name(requireFromJSON, "requireFromJSON");
var mapGenerator;
...
function requireMapGenerator() {
  ...
  const _MapGenerator = class _MapGenerator {
  ...
  let MapGenerator = _MapGenerator;
  mapGenerator = MapGenerator;
  return mapGenerator;
}
__name(requireMapGenerator, "requireMapGenerator");
var tokenize;
...
function requireTokenize() {
  ...
  tokenize = /* @__PURE__ */ __name(function tokenizer(input2, options = {}) {
...
__name(requireTokenize, "requireTokenize");
var parser;
...
__name(requireWarning, "requireWarning");
var result;
...
__name(requireResult, "requireResult");
var warnOnce;
...
function requireWarnOnce() {
  ...
  let printed = {};
  warnOnce = /* @__PURE__ */ __name(function warnOnce2(message) {
...
__name(requireWarnOnce, "requireWarnOnce");
var lazyResult;
...
function requireLazyResult() {
  ...
  let postcss2 = {};
  const _LazyResult = class _LazyResult {
    get content() {
...
__name(requireLazyResult, "requireLazyResult");
var noWorkResult;
...
function requireNoWorkResult() {
  ...
  let stringify2 = requireStringify();
  let warnOnce2 = requireWarnOnce();
  const _NoWorkResult = class _NoWorkResult {
    get content() {
  ...
  let NoWorkResult = _NoWorkResult;
  noWorkResult = NoWorkResult;
  NoWorkResult.default = NoWorkResult;
  return noWorkResult;
}
__name(requireNoWorkResult, "requireNoWorkResult");
var processor;
...
function requireProcessor() {
  ...
  let Root2 = requireRoot();
  const _Processor = class _Processor {
    constructor(plugins = []) {
      this.version = "8.5.6";
...
__name(requireProcessor, "requireProcessor");
var postcss_1;
...
__name(requirePostcss, "requirePostcss");
...
function requireContainer() {
  ...
  var _Node2 = requireNode2();
  var _Node22 = _interopRequireDefault(_Node2);
  ...
  __name(Container$1, "Container$1");
  Container$1.prototype = Object.create(_Node22.default.prototype);
  Container$1.constructor = _Node22.default;
  Container$1.prototype.walk = /* @__PURE__ */ __name(function walk(filter2, cb) {
  ...
  Container$1.prototype.each = /* @__PURE__ */ __name(function each() {
...
__name(requireContainer, "requireContainer");
var parsers = {};
...
function requireParsers() {
  ...
  __name(parseMediaFeature, "parseMediaFeature");
  function parseMediaQuery(string) {
    ...
    for (var i = 0; i < string.length; i++) {
      ...
      if (insideSomeValue && localLevel === 0 && (character === ")" || i === string.length - 1 || string[i + 1].search(/\s/) !== -1)) {
        ...
        result2.push(Array.isArray(node2.nodes) ? new _Container2.default(node2) : new _Node22.default(node2));
        node2 = resetNode();
  ...
  __name(parseMediaQuery, "parseMediaQuery");
  function parseMediaList(string) {
    ...
    if (doesHaveUrl !== null) {
      ...
      result2.unshift(new _Node22.default({
        type: "url",
  ...
  __name(parseMediaList, "parseMediaList");
  return parsers;
}
__name(requireParsers, "requireParsers");
var hasRequiredDist;
...
__name(requireBoolbase, "requireBoolbase");
...
__name(_Node, "Node");
var Node = _Node;
var _DataNode = class _DataNode extends Node {
  /**
...
var _Text = class _Text extends DataNode {
  constructor() {
    super(...arguments);
...
__name(_Text, "Text");
var Text = _Text;
var _Comment = class _Comment extends DataNode {
  constructor() {
    super(...arguments);
...
var _ProcessingInstruction = class _ProcessingInstruction extends DataNode {
...
var ProcessingInstruction = _ProcessingInstruction;
var _NodeWithChildren = class _NodeWithChildren extends Node {
  /**
...
var NodeWithChildren = _NodeWithChildren;
var _CDATA = class _CDATA extends NodeWithChildren {
  constructor() {
    super(...arguments);
...
__name(_CDATA, "CDATA");
var CDATA = _CDATA;
var _Document = class _Document extends NodeWithChildren {
  constructor() {
    super(...arguments);
...
var _Element = class _Element extends NodeWithChildren {
  /**
...
function cacheParentResults(next, { adapter, cacheResults }, matches) {
  ...
  return /* @__PURE__ */ __name(function cachedMatcher(elem) {
    if (!next(elem)) {
      return false;
    }
...
var subselects = {
  ...
  has(next, subselect, options, _context, compileToken2) {
    ...
    const hasOne = /* @__PURE__ */ __name((elem) => findOne(compiled, adapter.getChildren(elem), options) !== null, "hasOne");
...
__name(_compileToken, "_compileToken");
...
var _EntityDecoder = class _EntityDecoder {
...
var EntityDecoder = _EntityDecoder;
...
__name(parseStylesheet, "parseStylesheet");
...
__name(serializeStylesheet, "serializeStylesheet");
...
__name(applyMarkedSelectors, "applyMarkedSelectors");
...
__name(walkStyleRules, "walkStyleRules");
...
__name(walkStyleRulesWithReverseMirror, "walkStyleRulesWithReverseMirror");
...
__name(hasNestedRules, "hasNestedRules");
...
__name(splitFilter, "splitFilter");
...
__name(filterSelectors, "filterSelectors");
...
__name(validateMediaQuery, "validateMediaQuery");
var classCache = null;
var idCache = null;
...
__name(serializeDocument2, "serializeDocument");
var extended = false;
...
__name(extendElement, "extendElement");
...
__name(extendDocument, "extendDocument");
...
__name(cachedQuerySelector, "cachedQuerySelector");
...
__name(parseRelevantSelectors, "parseRelevantSelectors");
...
var _Beasties = class _Beasties {
  ...
  readFile(filename) {
    ...
    return new Promise((resolve2, reject) => {
      const callback = /* @__PURE__ */ __name((err, data) => {
        if (err)
          reject(err);
...
__name(_Beasties, "Beasties");
var Beasties = _Beasties;
...
var _ServerAssets = class _ServerAssets {
  manifest;
  /**
...
__name(_ServerAssets, "ServerAssets");
var ServerAssets = _ServerAssets;
var IGNORED_LOGS = /* @__PURE__ */ new Set(["Angular is running in development mode."]);
var _Console = class _Console extends Console {
  /**
...
var Console2 = _Console;
var angularAppManifest;
function setAngularAppManifest(manifest) {
  angularAppManifest = manifest;
}
__name(setAngularAppManifest, "setAngularAppManifest");
...
__name(getAngularAppManifest, "getAngularAppManifest");
var angularAppEngineManifest;
function setAngularAppEngineManifest(manifest) {
  angularAppEngineManifest = manifest;
}
__name(setAngularAppEngineManifest, "setAngularAppEngineManifest");
...
__name(getAngularAppEngineManifest, "getAngularAppEngineManifest");
...
__name(joinUrlParts, "joinUrlParts");
...
__name(stripIndexHtmlFromURL, "stripIndexHtmlFromURL");
...
__name(buildPathWithParams, "buildPathWithParams");
  ...
  return __async(this, null, function* () {
    ...
    const platformRef = platformServer([
      ...
      },
      {
        ...
        useFactory: /* @__PURE__ */ __name(() => new Console2(), "useFactory")
      },
      ...platformProviders
    ]);
    let redirectTo;
    ...
    try {
      ...
      return {
        hasNavigationError,
        redirectTo,
        content: /* @__PURE__ */ __name(() => new Promise((resolve2, reject) => {
          setTimeout(() => {
...
__name(renderAngular, "renderAngular");
...
__name(asyncDestroyPlatform2, "asyncDestroyPlatform");
...
__name(promiseWithAbort, "promiseWithAbort");
...
__name(withAppShell, "withAppShell");
...
__name(provideServerRendering2, "provideServerRendering");
var _RouteTree = class _RouteTree {
  /**
...
__name(_RouteTree, "RouteTree");
var RouteTree = _RouteTree;
...
__name(traverseRoutesConfig, "traverseRoutesConfig");
...
__name(appendPreloadToMetadata, "appendPreloadToMetadata");
...
__name(handleSSGRoute, "handleSSGRoute");
...
__name(handlePrerenderParamsReplacement, "handlePrerenderParamsReplacement");
...
__name(resolveRedirectTo, "resolveRedirectTo");
...
__name(buildServerConfigRouteTree, "buildServerConfigRouteTree");
...
__name(getRoutesFromAngularRouterConfig, "getRoutesFromAngularRouterConfig");
...
__name(extractRoutesAndCreateRouteTree, "extractRoutesAndCreateRouteTree");
...
__name(_Hooks, "Hooks");
var Hooks = _Hooks;
var _extractionPromise;
var _ServerRouter = class _ServerRouter {
  routeTree;
  /**
  ...
  static from(manifest, url) {
    ...
    __privateGet(_ServerRouter, _extractionPromise) ?? __privateSet(_ServerRouter, _extractionPromise, extractRoutesAndCreateRouteTree({ url, manifest }).then(({ routeTree, errors }) => {
      if (errors.length > 0) {
        throw new Error("Error(s) occurred while extracting routes:\n" + errors.map((error) => `- ${error}`).join("\n"));
      }
      return new _ServerRouter(routeTree);
    }).finally(() => {
      __privateSet(_ServerRouter, _extractionPromise, void 0);
    }));
    return __privateGet(_ServerRouter, _extractionPromise);
  }
  /**
...
_extractionPromise = new WeakMap();
__name(_ServerRouter, "ServerRouter");
/**
 * Static property to track the ongoing build promise.
 */
__privateAdd(_ServerRouter, _extractionPromise);
var ServerRouter = _ServerRouter;
...
var _BeastiesBase = class _BeastiesBase extends Beasties {
};
__name(_BeastiesBase, "BeastiesBase");
var BeastiesBase = _BeastiesBase;
var _InlineCriticalCssProcessor = class _InlineCriticalCssProcessor extends BeastiesBase {
  readFile;
  outputPath;
  ...
  constructor(readFile2, outputPath) {
    super({
      logger: {
        ...
        warn: /* @__PURE__ */ __name((s) => console.warn(s), "warn"),
        // eslint-disable-next-line no-console
        error: /* @__PURE__ */ __name((s) => console.error(s), "error"),
...
__name(_InlineCriticalCssProcessor, "InlineCriticalCssProcessor");
var InlineCriticalCssProcessor = _InlineCriticalCssProcessor;
...
var _AngularServerApp = class _AngularServerApp {
  options;
  /**
...
__name(_AngularServerApp, "AngularServerApp");
var AngularServerApp = _AngularServerApp;
var angularServerApp;
function getOrCreateAngularServerApp(options) {
  return angularServerApp ??= new AngularServerApp(options);
}
__name(getOrCreateAngularServerApp, "getOrCreateAngularServerApp");
...
__name(destroyAngularServerApp, "destroyAngularServerApp");
...
__name(appendPreloadHintsToHtml, "appendPreloadHintsToHtml");
...
__name(getPotentialLocaleIdFromUrl, "getPotentialLocaleIdFromUrl");
...
__name(parseLanguageHeader, "parseLanguageHeader");
...
__name(getPreferredLocale, "getPreferredLocale");
function normalizeLocale(locale) {
  return locale.toLowerCase();
}
__name(normalizeLocale, "normalizeLocale");
var _AngularAppEngine = class _AngularAppEngine {
  /**
...
__name(_AngularAppEngine, "AngularAppEngine");
/**
 ...
 * @private
 */
__publicField(_AngularAppEngine, "ɵallowStaticRouteRender", false);
/**
 ...
 * @private
 */
__publicField(_AngularAppEngine, "ɵhooks", new Hooks());
var AngularAppEngine = _AngularAppEngine;
...
@angular/platform-server/fesm2022/platform-server.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-EXHXK4FV.js.map
