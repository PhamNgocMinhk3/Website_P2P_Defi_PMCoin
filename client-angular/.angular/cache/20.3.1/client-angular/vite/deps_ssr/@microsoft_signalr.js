...
var _FetchHttpClient = class _FetchHttpClient extends HttpClient {
  constructor(logger) {
    super();
    this._logger = logger;
...
var _XhrHttpClient = class _XhrHttpClient extends HttpClient {
  constructor(logger) {
    super();
    this._logger = logger;
  }
...
var _DefaultHttpClient = class _DefaultHttpClient extends HttpClient {
...
var _AccessTokenHttpClient = class _AccessTokenHttpClient extends HttpClient {
