...
export class ManagerGameHubComponent implements OnInit, OnDestroy {
  ...
  openFiatManagement(): void {
    // This will navigate to the new VND Treasury Management page, which also contains the transaction logs.
    this.router.navigate(['/game/admin/vnd-management']);
  }

  openVndTreasuryManagement(): void {
    // This also navigates to the same page.
    this.router.navigate(['/game/admin/vnd-management']);
  }

  openQuickSellManagement(): void {
    this.router.navigate(['/game/admin/quicksell-management']);
  }
