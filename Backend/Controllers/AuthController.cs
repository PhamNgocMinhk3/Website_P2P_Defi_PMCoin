...
namespace TradeFinanceBackend.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private void SetSessionCookie(string sessionId)
        {
            ...
            {
                HttpOnly = true,
                // In production (HTTPS), use SameSite=None and Secure=true to allow cross-domain cookies.
                // In development (HTTP), use SameSite=Lax, which is the default and works for localhost without requiring Secure=true.
                // This resolves the "SameSite=None must be Secure" warning during local development.
        ...
        private void ClearSessionCookie()
        {
            ...
            {
                HttpOnly = true,
                // Match the settings in SetSessionCookie for consistency
                Secure = HttpContext.Request.IsHttps,
                SameSite = HttpContext.Request.IsHttps ? SameSiteMode.None : SameSiteMode.Lax,
                Path = "/",
