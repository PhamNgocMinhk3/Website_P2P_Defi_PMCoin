...
{
    /// <inheritdoc />
    public partial class CompleteSystemWithChatAndCleanAuth : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnlyAdminsCanSend = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FileInfo = table.Column<string>(type: "text", nullable: true),
                    PollData = table.Column<string>(type: "text", nullable: true),
                    AppointmentData = table.Column<string>(type: "text", nullable: true),
                    Reaction = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
