...
namespace TradeFinanceBackend.Migrations
{
    ...
    [Migration("20250827123716_AddUserBalanceAndTransactions")]
    partial class AddUserBalanceAndTransactions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TradeFinanceBackend.Models.UserGameStats", b =>
                {
                    ...
                    b.Property<int>("ConsecutiveLoses")
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("TotalLoseAmount")
                        .HasColumnType("decimal(18,8)");
                    ...
                    b.HasIndex("IsWhitelisted", "ConsecutiveLoses");
